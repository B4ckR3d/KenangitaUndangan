...
@import url("https://fonts.googleapis.com/css2?family=Italiana&family=Parisienne&family=Quicksand:wght@300..700&display=swap");

:root { --inv-bg: #d68c90; --inv-base: #ffffff; --inv-accent: #ea8e8d; --inv-border: #FEE0E2; --menu-bg: #f4b4b0; --menu-inactive: #ffffff; --menu-active: #ea8e8d; --btn-color: #ffffff; --font-base: "Quicksand", sans-serif; --font-accent: "Italiana", sans-serif; --font-latin: "Parisienne", cursive; }
...
.noty_theme__nest.noty_type__success { background-color: rgb(6, 214, 160); color: rgb(255, 255, 255); }
    ...
    <meta name="title" content="Party &amp; Dinner - Pink Party">
    <meta name="description" content="tema undngan ulang tahun dewasa warna pink sweet seventeen 17 tahun - Undangan online murah dan praktis untuk acara sweet seventeen, birthday party, dan event lainnya. Coba gratis, bayar nanti!">
    <meta itemprop="image" content="http://app.kitaberdua.com/themes/pink-party/pink-party.webp">
        <link rel="icon" type="image/x-icon" href="https://assets.satumomen.com/images/media/6108-media-1682180901.png">
        <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="http://app.kitaberdua.com/preview/pink-party">
    <meta property="og:title" content="Party &amp; Dinner - Pink Party">
    <meta property="og:description" content="tema undngan ulang tahun dewasa warna pink sweet seventeen 17 tahun - Undangan online murah dan praktis untuk acara sweet seventeen, birthday party, dan event lainnya. Coba gratis, bayar nanti!">
    <meta property="og:image" content="http://app.kitaberdua.com/themes/pink-party/pink-party.webp">
...
<body style="overflow-y: hidden;">
      ...
      <source src="<?= !empty($musiknya) ? $musiknya : 'https://assets.satumomen.com/musics/akon-be-with-you.mp3' ?>">
    </audio> <div id="satuMomen" data-guest="<?= \esc($invite); ?>" data-group="VIP" class="not-open" style="display: block;"><div class="satumomen_track"><ul class="satumomen_list"><li class="container-mobile satumomen_slide satumomen_cover" style="background-image: url(&quot;https://assets.satumomen.com/images/invitation/bg-section-89239491774253733.webp&quot;); background-size: cover; position: fixed;"><div class="workspace cover"><div class="content h-100 w-100 mx-auto"><div style="position: absolute; height: 70%; left: 0px; right: 0px; bottom: 0px; background: linear-gradient(rgba(0, 0, 0, 0) 17%, rgb(0, 0, 0) 100%);"></div> <div class="position-relative h-100 d-flex flex-column justify-content-end align-items-center"><div class="text-center pb-5"><div class="editable animate__animated" data-animation="animate__fadeInUp animate__slower" style="font-size: 14.4px; color: rgb(255, 255, 255);">Dear</div> 
   ...
   <div id="groupNameSlot" class="editable h5 mb-4 animate__animated" data-animation="animate__fadeInUp animate__slower" style="font-size: 16px; color: rgb(255, 255, 255);">VIP</div><button class="btn-open-invitation btn rounded-0 mb-4 animate__animated" data-animation="animate__fadeInUp animate__slow" style="color: var(--inv-base); border: 1px solid var(--inv-base);">Open Invitation</button></div></div></div></div></li> <li class="blank-canvas" style="height: 100vh;"></li> <li class="container-mobile satumomen_slide" style="background-image: url(&quot;https://assets.satumomen.com/images/invitation/bg-section-89240131774254086.webp&quot;); background-size: cover;"><div class="workspace"><div class="content h-100 w-100 mx-auto"><div style="position: absolute; height: 70%; left: 0px; right: 0px; bottom: 0px; background: linear-gradient(rgba(0, 0, 0, 0) 17%, rgba(0, 0, 0, 0.8) 100%);"></div> <div class="position-relative h-100 d-flex flex-column justify-content-between align-items-center"><div class="w-100"><div class="text-left d-flex w-100 align-items-center animate__animated" data-animation="animate__fadeInRight animate__slower"><div class="editable pr-2" style="font-size: 14.4px;">Sweet 17áµÊ° Birthday of</div> <div class="col" style="height: 1px; background-color: var(--inv-base);"></div></div> <div class="editable animate__animated font-accent" data-animation="animate__fadeInLeft animate__slower" style="font-size: 32px; line-height: 1.2;">Michelle Emily<br>Christabel Setiawan</div><div class="editable animate__animated" data-animation="animate__fadeInUp animate__slower" style="font-size: 14.4px; line-height: 1.2;">18 . 04 . 26</div></div><div class="w-100"><div class="text-right editable animate__animated" data-animation="animate__fadeInLeft animate__slower" style="font-size: 14.4px; line-height: 1.2;">"This is the day that the Lord has made;<br>let us rejoice and be glad in it.â</div><div class="text-right d-flex w-100 align-items-center animate__animated" data-animation="animate__fadeInRight animate__slower"><div class="col" style="height: 1px; background-color: var(--inv-base);"></div><div class="editable pl-2" style="font-size: 14.4px;">psalm 118: 24</div></div></div></div></div></div></li> <li class="container-mobile satumomen_slide" style="background-image: url(&quot;https://assets.satumomen.com/images/invitation/bg-section-89240801774254506.webp&quot;); background-size: cover;"><div class="workspace"><div class="content h-100 w-100 mx-auto"><div style="position: absolute; height: 70%; left: 0px; right: 0px; bottom: 0px; background: linear-gradient(rgba(0, 0, 0, 0) 17%, rgba(0, 0, 0, 0.8) 100%);"></div> <div class="py-4 position-relative h-100 d-flex flex-column justify-content-between align-items-center"><div class="w-100"><div class="editable text-center animate__animated" data-animation="animate__fadeInUp animate__slower" style="font-size: 14.4px;">Dear friends and family,<br>You're invited to :</div> <div class="editable text-center animate__animated font-latin" data-animation="animate__fadeInUp animate__slower" style="font-size: 32px; line-height: 1.2;">Michelle's Sweet Seventeen</div></div><div class="w-100" style="max-width: 300px;"><div class="text-center editable animate__animated" data-animation="animate__fadeInDown animate__slower" style="font-size: 14.4px; line-height: 1.2;">Step into a little world of magic as I celebrate my Sweet Seventeen, where fairytales softly come alive and every moment feels like a dream. Let's create sweet memories together and turn this night into a magical chapter of my story ð</div></div></div></div></div></li> <li class="container-mobile satumomen_slide" style="background-image: url(&quot;https://assets.satumomen.com/images/invitation/bg-section-89240941774254805.webp&quot;); background-size: cover;"><div class="workspace"><div class="content h-100 w-100 mx-auto"><div style="position: absolute; height: 70%; left: 0px; right: 0px; bottom: 0px; background: linear-gradient(rgba(217, 145, 131, 0) 17%, rgb(217, 145, 131) 100%);"></div> <div class="position-relative h-100 d-flex flex-column justify-content-end align-items-center py-4"><div class="w-100"><div class="text-left w-100 animate__animated" data-animation="animate__fadeInRight animate__slower"><div class="editable pr-2" style="font-size: 18px;">BIRTHDAY GIRL</div> <div class="col" style="height: 2px; background-color: var(--inv-base); max-width: 80%;"></div></div> <div class="editable animate__animated font-accent" data-animation="animate__fadeInLeft animate__slower" style="font-size: 42px; line-height: 1.2;">MICHELLE<br>EMILY</div><a href="https://instagram.com/" target="_BLANK" rel="noreferrer noopener" class="d-block my-2 link animate__animated" data-animation="animate__fadeInUp animate__slower" style="color: var(--inv-base); font-size: 14.4px; line-height: 1.2; background-image: url(&quot;https://assets.satumomen.com/images/galleries/803309-gallery-N7PvTpAHiI.webp&quot;); background-repeat: no-repeat; background-position: left center; background-size: contain; padding-left: 20px;">michellecrstbel</a><div class="editable animate__animated" data-animation="animate__fadeInUp animate__slower" style="font-size: 14.4px; line-height: 1.2;">Daughter of<br>Mr. Tonny Setiawan<br>&amp; Mrs. Lia Widya</div></div></div></div></div></li> <li class="container-mobile satumomen_slide" style="background-image: url(&quot;https://assets.satumomen.com/images/invitation/bg-section-89241271774255619.webp&quot;); background-size: cover;"><div class="workspace"><div class="content h-100 w-100 mx-auto"><div style="position: absolute; height: 70%; left: 0px; right: 0px; bottom: 0px; background: linear-gradient(rgba(217, 145, 131, 0) 17%, rgb(217, 145, 131) 100%);"></div> <div class="position-relative h-100 d-flex flex-column justify-content-end align-items-center py-4"><div class="w-100"><div class="text-center editable animate__animated font-accent" data-animation="animate__fadeInDown animate__slower" style="font-size: 42px; line-height: 1.2;">SWEET SEVENTEEN<br>PARTY IN</div><div data-datetime="2027-08-11T19:00" class="mx-auto mb-3 countdown-wrapper d-flex flex-column animate__animated" style="width: 300px; max-width: 100%;" data-animation="animate__fadeInUp animate__slower"><div class="countdown text-center"><div class="countdown-item day" style="color: var(--inv-base); background-color: transparent;"><div class="number">359</div> <div class="text editable">Hari</div></div> <div class="countdown-item hour" style="color: var(--inv-base); background-color: transparent;"><div class="number">16</div> <div class="text editable">Jam</div></div> <div class="countdown-item minute" style="color: var(--inv-base); background-color: transparent;"><div class="number">36</div> <div class="text editable">Menit</div></div> <div class="countdown-item second" style="color: var(--inv-base); background-color: transparent;"><div class="number">40</div> <div class="text editable">Detik</div></div></div> <button class="btn-countdown btn btn-sm btn-pilled btn-accent mt-2">Atur Tanggal</button></div><div class="text-center"><a href="https://calendar.google.com/calendar/u/0/r/eventedit?text=&amp;dates=%2F&amp;details=&amp;location=" target="_blank" rel="noreferrer noopener" class="btn-reminder btn my-3 rounded-0 animate__animated" data-animation="animate__fadeInUp animate__slow" style="color: var(--inv-base); border: 1px solid var(--inv-base);">Mark Your Calendar</a></div></div></div></div></div></li> <li class="container-mobile satumomen_slide" style="background-image: url(&quot;https://assets.satumomen.com/images/invitation/secondary_image-8033091774253279.webp&quot;); background-size: cover;"><div class="workspace"><div class="content h-100 w-100 mx-auto"><div class="position-relative h-100 d-flex flex-column justify-content-center align-items-center"><div class="w-100"><div class="w-100" style="overflow: hidden; height: 300px; border-radius: 0px;"><img src="https://assets.satumomen.com/images/galleries/803309-gallery-DyfSUwRHT1.webp" alt="14989-gallery-1657822638.jpg" class="lightbox" style="width: 100%; height: 100%; object-fit: cover;"></div> <div class="bg-white position-relative"><div style="color: var(--dark); background-color: var(--inv-border); position: absolute; width: 0px; height: 0px; text-align: center; font-size: 32px; bottom: 0px;"><div class="editable font-weight-bold" style="color: var(--dark); background-color: var(--inv-border); transform: rotate(-90deg); transform-origin: left top; width: 300px; text-align: center; font-size: 32px;">Sweet 17áµÊ°</div></div><div class="py-3 pr-3 animate__animated" data-animation="animate__fadeInUp animate__slower" style="color: var(--dark); height: 300px; padding-left: 66px;"><div class="d-flex mb-2"><img src="https://assets.satumomen.com/images/galleries/803309-gallery-68euzXZ380.webp" height="20" width="20" alt="803309-gallery-68euzXZ380.webp" style="object-fit: contain;"> <div class="pl-2 editable" style="font-size: 14.4px; line-height: 1.2;">Saturday, April 18áµÊ°, 2026</div></div> <div class="d-flex mb-4"><img src="https://assets.satumomen.com/images/galleries/803309-gallery-rXlGViGsQn.webp" height="20" width="20" alt="803309-gallery-rXlGViGsQn.webp" style="object-fit: contain;"> <div class="pl-2 editable" style="font-size: 14.4px; line-height: 1.2;">Saturday, April 18áµÊ°, 2026</div></div><div class="mb-4"><div class="editable font-weight-bold" style="font-size: 18px; line-height: 1.2;">THE VEE</div> <div class="editable" style="font-size: 14.4px; line-height: 1.2;">Jl. Gajahmada No. 146, Brumbungan, Kec. Semarang Tengah, Kota Semarang, Jawa Tengah 50134</div></div><div class="mb-4"><div class="editable font-weight-bold" style="font-size: 18px; line-height: 1.2;">Dresscode: White</div></div><a href="https://calendar.google.com/calendar/u/0/r/eventedit?text=&amp;dates=%2F&amp;details=&amp;location=" target="_blank" rel="noreferrer noopener" class="px-5 btn link rounded-0 animate__animated" data-animation="animate__fadeInUp animate__slow" style="color: var(--dark); border: 1px solid var(--dark);">Maps</a></div></div></div></div></div></div></li> <li class="container-mobile satumomen_slide" style="background-image: url(&quot;https://assets.satumomen.com/images/invitation/bg-section-89239541774257759.webp&quot;); background-size: cover;"><div class="workspace"><div class="content h-100 w-100 mx-auto"><div class="d-flex justify-content-center align-items-center" style="height: 100%;"><div style="width: 100%;"><div class="text-center mb-4 animate__animated" data-animation="animate__fadeInDown animate__slower"><div class="editable font-accent" style="font-size: 28.8px; line-height: 2;">RSVP</div> <div class="editable" style="font-size: 14.4px; line-height: 2;">Please fill the RSVP before April 10áµÊ°, 2026</div></div><div class="rsvp-placeholder animate__animated" data-animation="animate__fadeIn animate__slower"><div class="rsvp-form show"><!----> <div class="mb-4"><div class="font-accent h4 text-center">RSVP</div></div> <form class="pt-2"><div><div class="form-group mb-2"><label for="inputname" class="small mb-1">Nama</label> <input aria-hidden="false" id="inputname" type="text" placeholder="Nama" required="required" class="form-control"> <!----></div> <!----> <!----> <!----> <!----></div><div><!----> <div class="form-group mb-2"><label for="inputgroup_name" class="small mb-1">Grup</label> <input aria-hidden="false" id="inputgroup_name" type="text" placeholder="Grup" class="form-control"> <!----></div> <!----> <!----> <!----></div><div><!----> <!----> <div class="form-group mb-2"><label for="inputphone" class="small mb-1">No WhatsApp</label> <div class="input-group"><div class="input-group-prepend"><button type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="btn bg-white border dropdown-toggle">+62</button> <div class="dropdown-menu shadow"><span class="dropdown-item"><input type="search" placeholder="Search Country..." class="form-control form-control-sm"></span> <button type="button" class="dropdown-item active">
                            Indonesia +62
