...
@import url("https://fonts.googleapis.com/css2?family=Staatliches&family=Tangerine:wght@400;700&family=Tenor+Sans&display=swap");

:root { --inv-bg: #F1F1F1; --inv-base: #57201B; --inv-accent: #D7BC3B; --inv-border: #D7BC3B; --font-base: 'Tenor Sans', sans-serif; --font-accent: 'Staatliches', cursive; --font-latin: 'Tangerine', cursive; --menu-bg: #ffffff; --menu-inactive: #57201B; --menu-active: #D7BC3B; --btn-color: #57201B; }

.menu-item.is-active { color: rgb(87, 32, 27) !important; background-color: rgb(215, 188, 59) !important; }
...
.noty_theme__nest.noty_type__success { background-color: rgb(6, 214, 160); color: rgb(255, 255, 255); }
    ...
    <meta name="title" content="Umum &amp; Seminar - Nusantara Gas">
    <meta name="description" content="">
    <meta itemprop="image" content="http://app.kitaberdua.com/themes/nusantara-gas/nusantara-gas.webp">
        <link rel="icon" type="image/x-icon" href="https://assets.satumomen.com/images/media/6108-media-1682180901.png">
        <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="http://app.kitaberdua.com/preview/nusantara-gas">
    <meta property="og:title" content="Umum &amp; Seminar - Nusantara Gas">
    <meta property="og:description" content="">
    <meta property="og:image" content="http://app.kitaberdua.com/themes/nusantara-gas/nusantara-gas.webp">
...
<body>
      ...
      <source src="<?= !empty($musiknya) ? $musiknya : 'https://assets.satumomen.com/musics/millionaire-mindset.mp3' ?>">
    </audio> <div id="workspace-container" class="position-fixed h-100 w-100" style="overflow: hidden;"><div id="panZoom" class="position-fixed h-100 w-100" style="inset: 0px; transform-origin: 50% 50%; transform: scale(1.07473) translate(0px, 0px);"><div class="h-100 w-100 d-flex align-items-center justify-content-center"><div class="canvas not-open" style="height: 736px;"><div id="satuMomen" data-guest="<?= \esc($invite); ?>" data-group="VIP" style="height: 736px; display: block;"><div class="satumomen_track"><ul class="satumomen_list"><li class="satumomen_slide satumomen_cover" style=""><div class="container-mobile cover" style="background-image: url(&quot;http://app.kitaberdua.com/themes/nusantara-gas/bg.webp&quot;);"><div class="frame"></div> <div class="h-100 d-flex flex-column justify-content-center align-items-center"><div class="text-center mb-4"><div class="mb-4 animate__animated animate__fadeInDown animate__slower image-editable" style="height: 80px;"><img src="https://assets.satumomen.com/images/galleries/782165-gallery-vZgvChUkdz.webp" alt="108925-gallery-1689521614.png" style="width: 100%; height: 100%; object-fit: contain;"></div><div class="mx-auto mb-3 animate__animated animate__fadeInDown animate__slower image-editable" style="width: 60%;"><img src="https://assets.satumomen.com/images/galleries/782165-gallery-GggJ415BHv.webp" alt="108925-gallery-1689521614.png" style="width: 100%; height: 100%; object-fit: contain;"></div><div class="color-accent editable animate__animated animate__fadeInDown animate__slower" style="font-size: 14px; text-decoration: underline;">Site Plant PT.Likuid Nusantara Gas</div></div><div class="w-100 mb-4 animate__animated animate__zoomIn animate__slower image-editable"><img src="https://assets.satumomen.com/images/galleries/782165-gallery-6HiUtORLWY.webp" alt="108925-gallery-1689521614.png" style="width: 100%; height: 100%; object-fit: contain;"></div><div class="text-center mb-3"><div class="editable animate__animated animate__fadeInDown animate__slower" style="font-size: 14px;">Kepada Yth.</div>
  ...
  </div><button class="btn-open-invitation btn btn-primary rounded-pill animate__animated animate__fadeInUp animate__slow" style="font-size: 14.4px;">Open Invitation</button></div></div></li> <li class="satumomen_slide" style="display: none;"><div class="container-mobile" style="background-image: url(&quot;http://app.kitaberdua.com/themes/nusantara-gas/bg.webp&quot;);"><div class="frame"></div> <div class="h-100 d-flex flex-column justify-content-center align-items-center"><div class="text-center mb-4"><div class="mb-4 animate__animated animate__fadeInDown animate__slower image-editable" style="height: 80px;"><img src="https://assets.satumomen.com/images/galleries/782165-gallery-vZgvChUkdz.webp" alt="108925-gallery-1689521614.png" style="width: 100%; height: 100%; object-fit: contain;"></div><div class="color-accent editable animate__animated animate__fadeInDown animate__slower" style="font-size: 14px; text-decoration: underline;">Site Plant PT.Likuid Nusantara Gas</div></div><div class="w-100 animate__animated animate__zoomIn animate__slower image-editable" style="max-width: 240px;"><img src="https://assets.satumomen.com/images/galleries/782165-gallery-ZigptaLTIE.webp" alt="108925-gallery-1689521614.png" style="width: 100%; height: 100%; object-fit: contain;"></div></div></div></li> <li class="satumomen_slide" style="display: none;"><div class="container-mobile" style="background-image: url(&quot;http://app.kitaberdua.com/themes/nusantara-gas/bg.webp&quot;);"><div class="frame"></div> <div class="h-100 d-flex flex-column justify-content-center align-items-center"><div class="mb-4 animate__animated animate__fadeInDown animate__slower image-editable" style="height: 80px;"><img src="https://assets.satumomen.com/images/galleries/782165-gallery-vZgvChUkdz.webp" alt="108925-gallery-1689521614.png" style="width: 100%; height: 100%; object-fit: contain;"></div> <div><div class="editable text-center animate__animated animate__fadeInUp animate__slow" style="font-weight: 900; font-size: 40px; line-height: 1;">Detail Acara</div><div class="mb-2 mx-auto animate__animated animate__fadeInDown animate__slower image-editable" style="width: 50%;"><img src="https://app.kitaberdua.com/themes/grand-launching/devider.png" alt="devider.png" style="width: 100%; height: 100%; object-fit: contain;"></div></div><div class="mb-4" style="display: flex; flex-direction: column; border: 1px solid var(--inv-border); border-radius: 1rem; padding: 16px; background-color: rgba(255, 255, 255, 0.1); backdrop-filter: blur(4px); max-width: 280px;"><div class="d-inline-flex mb-2 animate__animated animate__fadeInRight animate__fast" style="gap: 8px;"><span class="color-accent" style="color: var(--inv-border);"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" height="24"><path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5m-9-6h.008v.008H12v-.008zM12 15h.008v.008H12V15zm0 2.25h.008v.008H12v-.008zM9.75 15h.008v.008H9.75V15zm0 2.25h.008v.008H9.75v-.008zM7.5 15h.008v.008H7.5V15zm0 2.25h.008v.008H7.5v-.008zm6.75-4.5h.008v.008h-.008v-.008zm0 2.25h.008v.008h-.008V15zm0 2.25h.008v.008h-.008v-.008zm2.25-4.5h.008v.008H16.5v-.008zm0 2.25h.008v.008H16.5V15z"></path></svg></span> <div class="editable" style="font-size: 14.4px;">Rabu 11 februari 2026</div></div><div class="d-inline-flex mb-2 animate__animated animate__fadeInRight animate__slow" style="gap: 8px;"><span class="color-accent" style="color: var(--inv-border);"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" height="24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg></span> <div class="editable" style="font-size: 14.4px;">09:00 - 13:00 WIB</div></div><div class="d-inline-flex animate__animated animate__fadeInRight animate__slower" style="gap: 8px;"><span class="color-accent" style="color: var(--inv-border);"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" height="24"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z"></path> <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z"></path></svg></span> <div><div class="editable" style="font-size: 14.4px;">PIER, PASURUAN</div> <div class="editable" style="font-size: 12px;">Jl Kraton Industri I No. 5, Curahdukuh, Kec. Kraton, Pasuruan, Jawa Timur 67151</div></div></div></div> <div class="text-center"><a href="https://goo.gl/maps/uu7oNHoJTTRVnZHJ7" target="_blank" rel="noreferrer noopener" class="link btn btn-primary rounded-pill mb-4 animate__animated animate__fadeInUp animate__slow" style="font-size: 14px;">Petunjuk Jalan</a></div> <div data-datetime="2026-08-11T18:30" class="countdown-wrapper d-flex flex-column animate__animated animate__fadeInUp animate__slower" style="min-width: 267px;"><div class="countdown text-center"><div class="countdown-item day" style="min-width: 55px;"><div class="number" style="color: rgb(255, 255, 255);">00</div> <div class="text editable" style="font-size: 12px; color: rgb(255, 255, 255);">Days</div></div> <div class="countdown-item hour" style="min-width: 55px;"><div class="number" style="color: rgb(255, 255, 255);">00</div> <div class="text editable" style="color: rgb(255, 255, 255); font-size: 12px;">Hours</div></div> <div class="countdown-item minute" style="min-width: 55px;"><div class="number" style="color: rgb(255, 255, 255);">00</div> <div class="text editable" style="color: rgb(255, 255, 255); font-size: 12px;">Minutes</div></div> <div class="countdown-item second" style="min-width: 55px;"><div class="number" style="color: rgb(255, 255, 255);">00</div> <div class="text editable" style="color: rgb(255, 255, 255); font-size: 12px;">Seconds</div></div></div> <button class="btn-countdown btn btn-sm btn-pilled btn-accent mt-2">Atur Countdown</button></div></div></div></li> <li class="satumomen_slide" style="display: none;"><div class="container-mobile" style="background-image: url(&quot;http://app.kitaberdua.com/themes/nusantara-gas/bg.webp&quot;);"><div class="frame"></div> <div class="h-100 d-flex flex-column justify-content-center align-items-center"><div class="text-center mb-4"><div class="mb-4 animate__animated animate__fadeInDown animate__slower image-editable" style="height: 80px;"><img src="https://assets.satumomen.com/images/galleries/782165-gallery-vZgvChUkdz.webp" alt="108925-gallery-1689521614.png" style="width: 100%; height: 100%; object-fit: contain;"></div><div class="w-100 mx-auto mb-3 animate__animated animate__fadeInDown animate__slower image-editable" style="max-width: 200px;"><img src="https://assets.satumomen.com/images/galleries/782165-gallery-GggJ415BHv.webp" alt="108925-gallery-1689521614.png" style="width: 100%; height: 100%; object-fit: contain;"></div><div class="color-accent editable animate__animated animate__fadeInDown animate__slower" style="font-size: 14px; text-decoration: underline;">Site Plant PT.Likuid Nusantara Gas</div></div> <div class="text-center editable mb-4 animate__animated animate__fadeInUp animate__slower" style="border: 1px solid var(--inv-border); border-radius: 1rem; padding: 16px; background-color: rgba(255, 255, 255, 0.1); backdrop-filter: blur(4px); max-width: 280px; font-size: 14.4px;">Tekan tombol dibawah ini untuk mengirim ucapan dan konfirmasi kehadiran</div><button class="btn-rsvp btn btn-primary rounded-pill mb-4 animate__animated animate__fadeInUp animate__slow" style="font-size: 14px;">Konfirmasi Kehadiran</button></div></div></li> <li class="satumomen_slide" style="display: none;"><div class="container-mobile" style="background-image: url(&quot;http://app.kitaberdua.com/themes/nusantara-gas/bg.webp&quot;);"><div class="frame"></div> <div class="h-100 watermark d-flex flex-column justify-content-center align-items-center"><div class="text-center mb-4"><div class="mb-4 animate__animated animate__fadeInDown animate__slower image-editable" style="height: 80px;"><img src="https://assets.satumomen.com/images/galleries/782165-gallery-vZgvChUkdz.webp" alt="108925-gallery-1689521614.png" style="width: 100%; height: 100%; object-fit: contain;"></div><div class="w-100 mx-auto mb-3 animate__animated animate__fadeInDown animate__slower image-editable" style="max-width: 200px;"><img src="https://assets.satumomen.com/images/galleries/782165-gallery-GggJ415BHv.webp" alt="108925-gallery-1689521614.png" style="width: 100%; height: 100%; object-fit: contain;"></div><div class="color-accent editable animate__animated animate__fadeInDown animate__slower" style="font-size: 14px; text-decoration: underline;">Site Plant PT.Likuid Nusantara Gas</div></div> <div class="text-center"><div class="text-center editable animate__animated animate__fadeInUp animate__slower" style="border: 1px solid var(--inv-border); border-radius: 1rem; padding: 16px; background-color: rgba(255, 255, 255, 0.1); backdrop-filter: blur(4px); max-width: 280px; font-size: 14.4px;">Demikian Undangan ini Kami Sampaikan. Semoga Bapak/Ibu Berkenan Hadir Dalam Momen Istimewa Ini.</div> <div class="watermark-placeholder"><div id="waterMark" class="mt-5" style="display: inherit;"><div class="wm-music mt-3 text-center animate__animated animate__fadeInUp animate__slower animate__delay-1s" style="font-size: 60%;"><div style="opacity: 0.5;"><strong>Music:</strong></div> <div style="opacity: 0.5;">Millionaire Mindset</div></div></div></div></div></div></div></li></ul></div></div> <div id="smMenu" class="satumomen_menu"><ul class="satumomen_menu_list"><li class="satumomen_menu_item active" style="max-width: 82.8px;"><i class="icon ph-fill ph-house" style="color: currentcolor;"></i> <span>Opening</span></li> <li class="satumomen_menu_item" style="max-width: 82.8px;"><i class="icon ph-fill ph-buildings" style="color: currentcolor;"></i> <span>Plant</span></li> <li class="satumomen_menu_item" style="max-width: 82.8px;"><i class="icon ph-fill ph-calendar-check" style="color: currentcolor;"></i> <span>Event</span></li> <li class="satumomen_menu_item" style="max-width: 82.8px;"><i class="icon ph-fill ph-envelope" style="color: currentcolor;"></i> <span>RSVP</span></li> <li class="satumomen_menu_item" style="max-width: 82.8px;"><i class="icon ph-fill ph-flag-banner" style="color: currentcolor;"></i> <span>Thanks</span></li></ul></div> <div class="floating-action d-flex align-items-end flex-column"><button id="btnQrModal" class="btn btn-float"><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 256 256"><rect x="40" y="40" width="80" height="80" rx="16"></rect><rect x="40" y="136" width="80" height="80" rx="16"></rect><rect x="136" y="40" width="80" height="80" rx="16"></rect><path d="M144,184a8,8,0,0,0,8-8V144a8,8,0,0,0-16,0v32A8,8,0,0,0,144,184Z"></path><path d="M208,152H184v-8a8,8,0,0,0-16,0v56H144a8,8,0,0,0,0,16h32a8,8,0,0,0,8-8V168h24a8,8,0,0,0,0-16Z"></path><path d="M208,184a8,8,0,0,0-8,8v16a8,8,0,0,0,16,0V192A8,8,0,0,0,208,184Z"></path></svg></button> <button id="btnMusic" class="btn btn-float playing"><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 256 256" class="play"><path d="M184,152V104a8,8,0,0,1,16,0v48a8,8,0,0,1-16,0Zm40-72a8,8,0,0,0-8,8v80a8,8,0,0,0,16,0V88A8,8,0,0,0,224,80ZM53.92,34.62A8,8,0,1,0,42.08,45.38L73.55,80H32A16,16,0,0,0,16,96v64a16,16,0,0,0,16,16H77.25l69.84,54.31A8,8,0,0,0,160,224V175.09l42.08,46.29a8,8,0,1,0,11.84-10.76Zm92.16,77.59A8,8,0,0,0,160,106.83V32a8,8,0,0,0-12.91-6.31l-39.85,31a8,8,0,0,0-1,11.7Z"></path></svg> <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 256 256" class="pause"><path d="M160,32V224a8,8,0,0,1-12.91,6.31L77.25,176H32a16,16,0,0,1-16-16V96A16,16,0,0,1,32,80H77.25l69.84-54.31A8,8,0,0,1,160,32Zm32,64a8,8,0,0,0-8,8v48a8,8,0,0,0,16,0V104A8,8,0,0,0,192,96Zm32-16a8,8,0,0,0-8,8v80a8,8,0,0,0,16,0V88A8,8,0,0,0,224,80Z"></path></svg></button> <button id="btnAutoplay" class="btn btn-float"><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 256 256" class="play"><path d="M128,24A104,104,0,1,0,232,128,104.13,104.13,0,0,0,128,24Zm36.44,110.66-48,32A8.05,8.05,0,0,1,112,168a8,8,0,0,1-8-8V96a8,8,0,0,1,12.44-6.66l48,32a8,8,0,0,1,0,13.32Z"></path></svg> <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 256 256" class="pause"><path d="M128,24A104,104,0,1,0,232,128,104.13,104.13,0,0,0,128,24ZM112,160a8,8,0,0,1-16,0V96a8,8,0,0,1,16,0Zm48,0a8,8,0,0,1-16,0V96a8,8,0,0,1,16,0Z"></path></svg></button></div></div></div></div></div> <div id="lightboxWrapper" class="lightbox-wrapper"><div class="lightbox-list"></div> <a href="https://app.kitaberdua.com/preview/nusantara-gas#" id="lightboxCloseBtn" class="btn-lightbox"><svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 0 1 1.414 0L10 8.586l4.293-4.293a1 1 0 1 1 1.414 1.414L11.414 10l4.293 4.293a1 1 0 0 1-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 0 1-1.414-1.414L8.586 10 4.293 5.707a1 1 0 0 1 0-1.414z" clip-rule="evenodd"></path></svg></a> <div class="lightbox-navigation"><a href="https://app.kitaberdua.com/preview/nusantara-gas#" id="lightboxPrevBtn" data-index="0" class="lightbox-arrow"><svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m15 19-7-7 7-7"></path></svg></a> <a href="https://app.kitaberdua.com/preview/nusantara-gas#" id="lightboxNextBtn" data-index="0" class="lightbox-arrow"><svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m9 5 7 7-7 7"></path></svg></a></div></div> <div id="qrModal" tabindex="-1" role="dialog" aria-labelledby="qrModal" aria-hidden="true" class="modal fade"><div class="modal-dialog modal-dialog-centered"><div class="modal-content" style="height: 100%;"><div style="width: 100%; aspect-ratio: 16 / 9; background-size: cover; background-position: center center; background-image: url(&quot;/images/no-image.jpg&quot;);"></div> <div class="text-center py-4 px-4"><div><div class="mx-auto"><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="180" height="180" viewBox="0 0 180 180"><rect x="0" y="0" width="180" height="180" fill="#ffffff"></rect><g transform="scale(7.2)"><g transform="translate(0,0)"><path fill-rule="evenodd" d="M8 0L8 4L9 4L9 5L8 5L8 7L9 7L9 6L10 6L10 9L11 9L11 8L12 8L12 9L13 9L13 10L15 10L15 11L14 11L14 12L13 12L13 11L12 11L12 12L11 12L11 13L9 13L9 12L10 12L10 11L11 11L11 10L9 10L9 9L7 9L7 8L4 8L4 11L3 11L3 10L2 10L2 11L1 11L1 9L2 9L2 8L0 8L0 14L3 14L3 15L2 15L2 16L0 16L0 17L2 17L2 16L5 16L5 17L8 17L8 18L9 18L9 19L8 19L8 21L10 21L10 22L11 22L11 24L12 24L12 25L14 25L14 23L15 23L15 22L16 22L16 23L20 23L20 21L21 21L21 16L19 16L19 15L20 15L20 14L21 14L21 15L22 15L22 18L23 18L23 15L22 15L22 14L24 14L24 13L25 13L25 12L24 12L24 11L23 11L23 10L24 10L24 9L25 9L25 8L21 8L21 9L20 9L20 8L19 8L19 9L20 9L20 11L21 11L21 12L22 12L22 13L20 13L20 12L17 12L17 15L16 15L16 12L15 12L15 11L17 11L17 9L14 9L14 7L15 7L15 6L14 6L14 7L13 7L13 6L12 6L12 7L11 7L11 3L10 3L10 2L9 2L9 0ZM14 0L14 1L11 1L11 2L12 2L12 5L13 5L13 2L14 2L14 3L15 3L15 2L14 2L14 1L16 1L16 2L17 2L17 0ZM16 3L16 4L14 4L14 5L16 5L16 8L17 8L17 3ZM12 7L12 8L13 8L13 7ZM6 9L6 10L7 10L7 11L6 11L6 12L7 12L7 13L3 13L3 11L2 11L2 13L3 13L3 14L4 14L4 15L5 15L5 16L7 16L7 15L8 15L8 17L9 17L9 18L11 18L11 20L12 20L12 21L11 21L11 22L12 22L12 21L13 21L13 22L15 22L15 21L16 21L16 22L17 22L17 21L16 21L16 16L15 16L15 15L14 15L14 17L15 17L15 18L13 18L13 17L12 17L12 16L13 16L13 15L12 15L12 16L10 16L10 17L9 17L9 14L8 14L8 10L7 10L7 9ZM21 9L21 10L23 10L23 9ZM12 12L12 13L11 13L11 14L10 14L10 15L11 15L11 14L12 14L12 13L13 13L13 14L15 14L15 13L13 13L13 12ZM23 12L23 13L24 13L24 12ZM18 13L18 15L19 15L19 14L20 14L20 13ZM6 14L6 15L7 15L7 14ZM24 16L24 17L25 17L25 16ZM17 17L17 20L20 20L20 17ZM18 18L18 19L19 19L19 18ZM9 19L9 20L10 20L10 19ZM12 19L12 20L13 20L13 21L15 21L15 19L14 19L14 20L13 20L13 19ZM22 19L22 24L20 24L20 25L25 25L25 24L24 24L24 22L25 22L25 19ZM23 20L23 21L24 21L24 20ZM8 23L8 25L10 25L10 23ZM12 23L12 24L13 24L13 23ZM15 24L15 25L16 25L16 24ZM18 24L18 25L19 25L19 24ZM0 0L0 7L7 7L7 0ZM1 1L1 6L6 6L6 1ZM2 2L2 5L5 5L5 2ZM18 0L18 7L25 7L25 0ZM19 1L19 6L24 6L24 1ZM20 2L20 5L23 5L23 2ZM0 18L0 25L7 25L7 18ZM1 19L1 24L6 24L6 19ZM2 20L2 23L5 23L5 20Z" fill="#000000"></path></g></g></svg> <div style="margin-top: 10px; text-align: center;"></div></div></div> <hr style="margin-top: 1rem; margin-bottom: 1rem; border-width: 2px 0px 0px; border-style: dashed none none; border-color: rgba(0, 0, 0, 0.1) currentcolor currentcolor; border-image: none;"> <div style="text-align: center;"><strong>30 Jan 2026</strong><br> <p class="mb-0">18:48 </p> <p></p></div> <hr style="margin-top: 1rem; margin-bottom: 1rem; border-width: 2px 0px 0px; border-style: dashed none none; border-color: rgba(0, 0, 0, 0.1) currentcolor currentcolor; border-image: none;"> <div style="margin-bottom: 10px;"><div style="color: rgb(178, 178, 178);">Nama</div> <div>Nama Tamu</div></div> <div style="margin-bottom: 10px;"><div style="color: rgb(178, 178, 178);">Grup</div> <div>VIP</div></div></div> <button type="button" class="btn btn-close"><svg xmlns="http://www.w3.org/2000/svg" height="42px" width="42px" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18 18 6M6 6l12 12"></path></svg></button></div></div></div> <div id="rsvpModal" tabindex="-1" role="dialog" aria-labelledby="rsvpModal" class="modal fade"><div class="modal-dialog modal-dialog-centered"><div class="modal-content p-4" style="height: 100%;"><div class="rsvp-form show"><!----> <div class="mb-4"><div class="font-accent h4 text-center">RSVP</div></div> <form class="pt-2"><div><div class="form-group mb-2"><label for="inputname" class="small mb-1">Nama</label> <input aria-hidden="false" id="inputname" type="text" placeholder="Nama" required="required" class="form-control"> <!----></div> <!----> <!----> <!----> <!----></div><div><!----> <div class="form-group mb-2"><label for="inputgroup_name" class="small mb-1">Grup</label> <input aria-hidden="false" id="inputgroup_name" type="text" placeholder="Grup" class="form-control"> <!----></div> <!----> <!----> <!----></div><div><!----> <!----> <div class="form-group mb-2"><label for="inputphone" class="small mb-1">No WhatsApp</label> <div class="input-group"><div class="input-group-prepend"><button type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="btn bg-white border dropdown-toggle">+62</button> <div class="dropdown-menu shadow"><span class="dropdown-item"><input type="search" placeholder="Search Country..." class="form-control form-control-sm"></span> <button type="button" class="dropdown-item active">
                            Indonesia +62
