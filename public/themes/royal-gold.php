...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/royal-gold/css/style.css">
...
<div class="thebegining">
    <div class="cover-card">
        <img src="<?= base_url() ?>/assets/themes/royal-gold/img/top_flower.png" style="width: 100%; max-width: 280px; margin: 0 auto 15px;" />
        <p style="font-family: 'Cinzel', serif; font-size: 11px; letter-spacing: 0.25em; color: #dfb76c; text-transform: uppercase;">
            The Royal Wedding of
        </p>
        <h1 style="font-family: 'Playfair Display', serif; font-size: 32px; color: #fff; margin: 10px 0 20px;">
        ...
        <div style="padding: 15px; background: rgba(0,0,0,0.4); border-radius: 16px; border: 1px solid rgba(223,183,108,0.2); margin-bottom: 15px;">
            <p style="font-size: 11px; color: #aaa; margin-bottom: 4px;">Kepada Yth. Bapak/Ibu/Saudara(i):</p>
            <h3 style="font-family: 'Cinzel', serif; font-size: 18px; color: #f5d77f; font-weight: 700; margin: 0;">
                <?php if(!empty(esc($invite))) echo ucwords(esc($invite)); else echo "Tamu Undangan"; ?>
            </h3>
        </div>

        <button id="buka-undangan" type="button">
            <i class="mdi mdi-email-open-outline" style="font-size: 16px;"></i> Buka Undangan
        </button>
    </div>
</div>
...
<div id="konten" style="display: none;">
    ...
    <div id="sampul-konten" class="konten">
        <div class="card-gold text-center">
            <img src="<?= base_url() ?>/assets/themes/royal-gold/img/top_flower.png" style="width: 100%; max-width: 240px; margin: 0 auto 10px;" />
            <p style="font-family: 'Cinzel', serif; font-size: 12px; letter-spacing: 0.2em; color: #dfb76c;">WALIMATUL 'URSY</p>
            <h1 style="font-family: 'Playfair Display', serif; font-size: 36px; color: #fff; margin: 10px 0;">
                <?php if($posisi_mempelai == 0) echo $nama_panggilan_pria." & ".$nama_panggilan_wanita; else echo $nama_panggilan_wanita." & ".$nama_panggilan_pria;?>
            </h1>
            <p style="font-size: 13px; color: #bbb; max-width: 480px; margin: 15px auto; font-style: italic;">
                "Dan di antara tanda-tanda (kebesaran)-Nya ialah Dia menciptakan pasangan-pasangan untukmu dari jenismu sendiri, agar kamu cenderung dan merasa tenteram kepadanya."
            </p>
            <span style="font-size: 11px; color: #dfb76c; font-weight: 700;">(QS. Ar-Rum: 21)</span>
        </div>
    </div>
    ...
    <div id="mempelai-konten" class="konten" style="display: none;">
        <div class="card-gold text-center">
            ...
            <p style="font-size: 12px; color: #aaa; margin-bottom: 25px;"><?= $salam_pembuka ?></p>
            ...
            <table class="tb-acara">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <th class="tb-anu-acara">:</th>
                        <th class="tb-isi-acara"><?= $data->tempat_acara ?><br><small style="color:#999;"><?= $data->alamat_acara ?></small></th>
                    </tr>
                </tbody>
            </table>
            <?php } ?>
        ...
        <div class="card-gold text-center">
            ...
            <ul class="list-group list-group-flush" style="text-align: left;">
                ...
                <li class="list-group-item">
                    <b style="color: #f5d77f; font-family: 'Cinzel', serif; font-size: 14px;"><?= $row->nama_bank ?></b><br>
                    <span id="norek<?= $i ?>" style="font-size: 16px; font-weight: bold; color: #dfb76c;"><?= $row->no_rekening ?></span>
                    <button class="clipboard btn btn-xs btn-default" data-clipboard-text="<?= $row->no_rekening ?>" style="margin-left: 8px; padding: 2px 8px; background: #222; color: #dfb76c; border: 1px solid #dfb76c;">
                        <i class="fa fa-clipboard"></i> Salin
                    </button><br>
                    <small style="color: #aaa;">a.n. <?= $row->nama_pemilik ?></small>
    ...
    <div id="ucapan-konten" class="konten" style="display: none;">
        <div class="card-gold">
            ...
            <div class="form-group">
                <input id="nama" type="text" class="form-control" placeholder="Nama Anda" value="<?= esc($invite) ?>" style="background:#111; color:#fff; border:1px solid rgba(223,183,108,0.3); border-radius:12px; padding:12px;" required>
            </div>
            <div class="form-group">
                <textarea id="komentar" class="form-control" placeholder="Tuliskan ucapan dan doa Anda..." rows="3" style="background:#111; color:#fff; border:1px solid rgba(223,183,108,0.3); border-radius:12px; padding:12px;" required></textarea>
            </div>
            <button id="submitKomen" class="btn btn-block" style="background: linear-gradient(135deg, #f5d77f, #dfb76c); color:#000; font-family:'Cinzel',serif; font-weight:700; border-radius:12px; padding:12px;">
                Kirimkan Ucapan
            </button>
            <div id="loading_" style="display:none; text-align:center; margin-top:10px; color:#dfb76c;">Mengirim...</div>
            ...
            <div class="layout-komen" style="margin-top: 25px;">
                ...
                <div class="komen" style="padding: 12px; border-bottom: 1px solid rgba(223,183,108,0.2); margin-bottom: 8px;">
                    ...
                    <div style="font-size: 12px; color: #ccc; margin-top: 4px;"><?= \esc($data['isi_komentar']); ?></div>
                </div>
                <?php } ?>
            </div>
        </div>
...
<nav class="mobile-bottom-nav2" id="nav" style="display: none;">
    <div style="display: flex; justify-content: space-around; align-items: center;">
        ...
        <div class="mobile-bottom-nav__item" id="cerita">
            <i class="navbar-icon mdi mdi-book-open-page-variant"></i> Cerita
        </div>
