...
@import url("https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Knewave&family=Montserrat:ital,wght@0,100..900;1,100..900&display=swap");

:root { --inv-bg: #389e00; --inv-base: #ffffff; --inv-accent: #effe02; --inv-border: #ffffff; --menu-bg: #368300; --menu-inactive: #ffffff; --menu-active: #effe02; --btn-color: #318300; --font-base: "Montserrat", sans-serif; --font-accent: "Bebas Neue", sans-serif; --font-latin: "Knewave", system-ui; }

.frame::after { content: ""; position: absolute; inset: 24px 24px 0px; background-color: rgba(53, 130, 0, 0.65); border-radius: 1rem 1rem 0px 0px; }
...
.noty_theme__nest.noty_type__success { background-color: rgb(6, 214, 160); color: rgb(255, 255, 255); }
    ...
    <meta name="title" content="Kids &amp; Birthday - Turtles">
    <meta name="description" content="Tema undangan ulang tahun anak tema kura kura ninja, turtles hijau kartun lucu - Buat undangan digital ulang tahun dan acara lainnya.">
    <meta itemprop="image" content="http://app.kitaberdua.com/themes/turtles/turtles.webp">
        <link rel="icon" type="image/x-icon" href="https://assets.satumomen.com/images/media/6108-media-1682180901.png">
        <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="http://app.kitaberdua.com/preview/turtles">
    <meta property="og:title" content="Kids &amp; Birthday - Turtles">
    <meta property="og:description" content="Tema undangan ulang tahun anak tema kura kura ninja, turtles hijau kartun lucu - Buat undangan digital ulang tahun dan acara lainnya.">
    <meta property="og:image" content="http://app.kitaberdua.com/themes/turtles/turtles.webp">
...
<body>
    ...
    </audio> <div id="workspace-container" class="position-fixed h-100 w-100" style="overflow: hidden;"><div id="panZoom" class="position-fixed h-100 w-100" style="inset: 0px; transform-origin: 50% 50%; transform: scale(1.07473) translate(0px, 0px);"><div class="h-100 w-100 d-flex align-items-center justify-content-center"><div class="canvas not-open" style="height: 736px;"><div id="satuMomen" data-guest="<?= \esc($invite); ?>" data-group="VIP" style="height: 736px; display: block;"><div class="satumomen_track"><ul class="satumomen_list"><li class="satumomen_slide satumomen_cover" style=""><div class="container-mobile cover" style="background-image: url(&quot;http://app.kitaberdua.com/themes/turtles/bg.webp&quot;);"><div class="frame animate__animated animate__fadeIn animate__slow"></div> <div class="position-relative h-100 d-flex flex-column justify-content-center align-items-center"><div class="d-flex flex-column justify-content-center align-items-center"><div class="animate__animated" style="position: absolute; left: 0px; right: 0px; bottom: 0px; animation-delay: 500ms;"><img src="https://app.kitaberdua.com/themes/turtles/turtle.webp" alt="frame" class="h-100 w-100"></div></div><div class="position-relative h-100 d-flex flex-column justify-content-center align-items-center"><div class="w-100 bm-3 animate__animated animate__zoomInDown animate__slower image-editable"><img src="https://assets.satumomen.com/images/galleries/765800-gallery-HDhWJYpm6j.webp" alt="devider" class="w-100"></div> <div class="mb-5 mt-auto"><div class="text-center mb-3"><div class="editable animate__animated" style="font-size: 14px; color: rgb(255, 255, 255);">Dear</div>
