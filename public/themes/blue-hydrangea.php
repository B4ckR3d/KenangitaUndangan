...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/blue-hydrangea/css/style.css">
...
<div class="thebegining">
    <div class="cover-card">
        <!-- Bismillah Header -->
        <p style="font-family: 'Amiri', serif; font-size: 22px; color: #1e3a8a; margin-bottom: 5px;">بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ</p>
        <p style="font-family: 'Playfair Display', serif; font-size: 11px; letter-spacing: 0.25em; color: #1e40af; text-transform: uppercase; font-weight: 700; margin-bottom: 20px;">
            UNDANGAN PERNIKAHAN
        </p>
        ...
        <div style="position: relative; width: 170px; height: 170px; margin: 0 auto 20px; display: flex; align-items: center; justify-content: center;">
            <img src="<?= base_url() ?>/assets/themes/blue-hydrangea/img/wreath.png" style="position: absolute; inset: 0; width: 100%; height: 100%; object-fit: contain;" />
            <div style="position: relative; z-index: 2; text-align: center;">
                <h2 style="font-family: 'Dancing Script', cursive; font-size: 32px; color: #1e3a8a; line-height: 1.1; margin: 0;">
                    <?php if($posisi_mempelai == 0) echo $nama_panggilan_pria."<br><span style='font-size:20px; color:#3b82f6;'>&</span><br>".$nama_panggilan_wanita; else echo $nama_panggilan_wanita."<br><span style='font-size:20px; color:#3b82f6;'>&</span><br>".$nama_panggilan_pria;?>
                </h2>
            </div>
        </div>

        <div style="padding: 14px 18px; background: #eff6ff; border-radius: 18px; border: 1px solid #bfdbfe; margin-bottom: 15px;">
            <p style="font-size: 11px; color: #64748b; margin-bottom: 4px;">Kepada Yth. Bapak/Ibu/Saudara(i):</p>
            <h3 style="font-family: 'Playfair Display', serif; font-size: 17px; color: #1e3a8a; font-weight: 700; margin: 0;">
...
<div id="konten" style="display: none;">
    ...
    <div id="sampul-konten" class="konten">
        <div class="card-hydrangea text-center">
            <p style="font-family: 'Amiri', serif; font-size: 24px; color: #1e3a8a; margin-bottom: 5px;">بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ</p>
            <p style="font-family: 'Playfair Display', serif; font-size: 12px; letter-spacing: 0.2em; color: #2563eb; font-weight: 700;">THE WEDDING OF</p>
            <h1 style="font-family: 'Playfair Display', serif; font-size: 34px; color: #1e3a8a; margin: 10px 0;">
            ...
            <span style="font-size: 11px; color: #2563eb; font-weight: 700;">(QS. Ar-Rum: 21)</span>
        </div>
    </div>
        ...
        <div class="card-hydrangea text-center">
            ...
            <div style="margin-bottom: 25px;">
                ...
                <div style="margin-top: 8px;">
                    <span style="display:inline-flex; align-items:center; gap:6px; background:#eff6ff; color:#2563eb; padding:4px 14px; border-radius:50px; font-size:11px; font-weight:600; border:1px solid #bfdbfe;">
    ...
    <div id="cerita-konten" class="konten" style="display: none;">
        <div class="card-hydrangea">
            <div class="section-title">
                <h2>Kisah Cinta Kami</h2>
                <p>Bagaimana cerita perjalanan kami dimulai</p>
            </div>
    ...
    <div id="hadiah-konten" class="konten" style="display: none;">
        <div class="card-hydrangea text-center">
            <div class="section-title">
                <h2>Tanda Kasih Digital</h2>
                <p>Bagi keluarga dan sahabat yang ingin memberikan tanda kasih secara cashless:</p>
            </div>
            <ul class="list-group list-group-flush" style="text-align: left;">
                <?php $i=1; foreach ($rekening->getResult() as $row) { $i++; ?>
                <li class="list-group-item">
                    <b style="color: #1e3a8a; font-family: 'Playfair Display', serif; font-size: 15px;"><?= $row->nama_bank ?></b><br>
                    <span id="norek<?= $i ?>" style="font-size: 16px; font-weight: bold; color: #2563eb;"><?= $row->no_rekening ?></span>
                    <button class="clipboard btn btn-xs btn-default" data-clipboard-text="<?= $row->no_rekening ?>" style="margin-left: 8px; padding: 3px 10px; background: #eff6ff; color: #2563eb; border: 1px solid #bfdbfe; border-radius: 50px;">
                    ...
                    <div style="display:flex;align-items:center;justify-content:center;margin-top:12px;">
                        <img src="<?= base_url() ?>/assets/users/<?= $kunci; ?>/rekening/<?= $row->qrcode_bank ?>" alt="Qris" style="max-height:160px; border-radius: 12px; border: 1px solid #bfdbfe;">
                    </div>
                    <?php } ?>
                </li>
                <?php } ?>
    ...
    <div id="ucapan-konten" class="konten" style="display: none;">
        <div class="card-hydrangea">
            ...
            <button id="submitKomen" class="btn btn-block" style="background: linear-gradient(135deg, #3b82f6, #1d4ed8); color:#fff; font-family:'Plus Jakarta Sans',sans-serif; font-weight:700; border-radius:50px; padding:14px; box-shadow: 0 8px 20px rgba(37,99,235,0.3);">
                Kirim Ucapan RSVP
            </button>
            <div id="loading_" style="display:none; text-align:center; margin-top:10px; color:#2563eb;">Mengirim ucapan...</div>
            ...
            <div class="layout-komen" style="margin-top: 25px;">
                ...
                <div class="komen" style="padding: 12px; border-bottom: 1px solid #e2e8f0; margin-bottom: 8px;">
                    <div style="font-weight: 700; color: #1e3a8a; font-size: 13px;"><?= \esc($data['nama_komentar']); ?></div>
...
<nav class="mobile-bottom-nav2" id="nav" style="display: none;">
    <div style="display: flex; justify-content: space-around; align-items: center;">
        ...
        <div class="mobile-bottom-nav__item" id="cerita">
            <i class="navbar-icon mdi mdi-book-open-page-variant"></i> Story
        </div>
