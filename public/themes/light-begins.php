...
@import url("https://fonts.googleapis.com/css2?family=Sora:wght@100..800&family=Young+Serif&display=swap");

@import url("/fonts/garlich-grow/style.css");

:root { --inv-bg: #1857bb; --inv-base: #ffffff; --inv-accent: #ffffff; --inv-border: #ffffff; --menu-bg: #dce7f1; --menu-inactive: #0b0b62; --menu-active: #ffffff; --btn-color: #0b0b62; --font-base: "Sora", sans-serif; --font-accent: "Young Serif", serif; --font-latin: "GarlichGrow", cursive; }

.rsvp-form .btn-primary { background-color: var(--inv-bg); border-color: var(--inv-bg); color: var(--inv-accent); }

.rsvp-form .btn-primary:hover { background-color: var(--btn-color) !important; border-color: var(--btn-color) !important; color: var(--inv-accent) !important; }
...
.noty_theme__nest.noty_type__success { background-color: rgb(6, 214, 160); color: rgb(255, 255, 255); }
    ...
    <meta name="title" content="Christmas &amp; New Year - Light Begins">
    <meta name="description" content="Tema undangan digital ibadah dan perayaan natal light btn biru putih">
    <meta itemprop="image" content="http://app.kitaberdua.com/themes/light-begins/light-begins.webp">
        <link rel="icon" type="image/x-icon" href="https://assets.satumomen.com/images/media/6108-media-1682180901.png">
        <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="http://app.kitaberdua.com/preview/light-begins">
    <meta property="og:title" content="Christmas &amp; New Year - Light Begins">
    <meta property="og:description" content="Tema undangan digital ibadah dan perayaan natal light btn biru putih">
    <meta property="og:image" content="http://app.kitaberdua.com/themes/light-begins/light-begins.webp">
...
<body>
      ...
      <source src="<?= !empty($musiknya) ? $musiknya : 'https://assets.satumomen.com/musics/jingle-bells-christmas.mp3' ?>">
    </audio> <div id="workspace-container" class="position-fixed h-100 w-100" style="overflow: hidden;"><div id="panZoom" class="position-fixed h-100 w-100" style="inset: 0px; transform-origin: 50% 50%; transform: scale(1.07473) translate(0px, 0px);"><div class="h-100 w-100 d-flex align-items-center justify-content-center"><div class="canvas not-open" style="height: 736px;"><div id="satuMomen" data-guest="<?= \esc($invite); ?>" data-group="VIP" style="height: 736px; display: block;"><div class="satumomen_track"><ul class="satumomen_list"><li class="satumomen_slide satumomen_cover" style=""><div class="container-mobile cover" style="background-image: url(&quot;http://app.kitaberdua.com/themes/light-begins/bg.webp&quot;);"><div class="frame"><img src="https://app.kitaberdua.com/themes/light-begins/bm-2.webp" alt="frame" class="frame-br w-100 animate__animated animate__fadeInUp animate__slower" style="animation-delay: 800ms;"> <img src="https://app.kitaberdua.com/themes/light-begins/bm-1.webp" alt="frame" class="frame-br w-100 animate__animated animate__fadeInUp animate__slower" style="bottom: -1px;"> <img src="https://app.kitaberdua.com/themes/light-begins/snow.webp" alt="frame" class="frame-tl w-100 animate__animated animate__flash animate__infinite" style="animation-duration: 7s;"></div> <div class="h-100 w-100 d-flex flex-column justify-content-center align-items-center"><div class="w-100 mt-5"><div><div class="text-center mb-5"><div class="mb-4 mx-auto image-editable animate__animated animate__fadeInDown animate__slower" style="height: auto; width: 75%; animation-delay: 500ms;"><img src="https://assets.satumomen.com/images/galleries/748472-gallery-bgqnaVnP3f.webp" alt="25725-gallery-1670256481.jpg" style="width: 100%; height: 100%; object-fit: cover;"></div> <div class="mx-auto image-editable animate__animated animate__zoomIn animate__slower" style="height: auto; width: 75%; animation-delay: 400ms;"><img src="https://assets.satumomen.com/images/galleries/748472-gallery-iRNXmzrH74.webp" alt="25725-gallery-1670256481.jpg" style="width: 100%; height: 100%; object-fit: cover;"></div></div></div></div><div class="text-center mt-auto"><div class="mb-2 editable animate__animated animate__fadeInUp animate__slower font-weight-bold" style="font-size: 12px;">Shalom</div>
    <div id="guestNameSlot" class="editable h5 mb-4 font-weight-bold animate__animated animate__fadeInUp animate__slower" style="font-size: 18px; color: inherit;">
      <?= \esc($invite); ?>
  ...
  </div><div class="mb-5 text-center animate__animated animate__pulse animate__infinite animate__slow"><button class="btn-open-invitation btn btn-primary rounded-pill animate__animated animate__fadeInUp animate__slow" style="font-size: 14px;">OPEN INVITATION</button></div></div></div></li> <li class="satumomen_slide" style="display: none;"><div class="container-mobile" style="background-image: url(&quot;http://app.kitaberdua.com/themes/light-begins/bg.webp&quot;);"><div class="frame"><img src="https://app.kitaberdua.com/themes/light-begins/bm-2.webp" alt="frame" class="frame-br w-100 animate__animated animate__fadeInUp animate__slower" style="animation-delay: 800ms;"> <img src="https://app.kitaberdua.com/themes/light-begins/bm-1.webp" alt="frame" class="frame-br w-100 animate__animated animate__fadeInUp animate__slower" style="bottom: -1px;"> <img src="https://app.kitaberdua.com/themes/light-begins/snow.webp" alt="frame" class="frame-tl w-100 animate__animated animate__flash animate__infinite" style="animation-duration: 7s;"></div> <div class="h-100 d-flex justify-content-center align-items-center"><div class="w-100"><div class="text-center mb-5"><div class="mb-4 mx-auto image-editable animate__animated animate__fadeInDown animate__slower" style="height: auto; width: 75%; animation-delay: 500ms;"><img src="https://assets.satumomen.com/images/galleries/748472-gallery-bgqnaVnP3f.webp" alt="25725-gallery-1670256481.jpg" style="width: 100%; height: 100%; object-fit: cover;"></div> <div class="mx-auto image-editable animate__animated animate__zoomIn animate__slower" style="height: auto; width: 75%; animation-delay: 400ms;"><img src="https://assets.satumomen.com/images/galleries/748472-gallery-iRNXmzrH74.webp" alt="25725-gallery-1670256481.jpg" style="width: 100%; height: 100%; object-fit: cover;"></div></div> <div class="text-center"><div class="d-flex flex-column mx-auto p-3 mb-4 animate__animated animate__fadeIn animate__slower" style="gap: 8px; background-color: var(--inv-bg); border: 4px solid var(--inv-border); border-radius: 1rem;"><div class="d-inline-flex animate__animated animate__fadeInRight animate__slow" style="gap: 8px; animation-delay: 1000ms;"><img src="https://assets.satumomen.com/images/galleries/429872-gallery-lwv7bHCy1l.png" height="24" width="24" alt="429872-gallery-lwv7bHCy1l.png"> <div class="editable" style="font-size: 14.4px;">Jum'at, 19 Desember 2025</div></div><div class="d-inline-flex animate__animated animate__fadeInRight animate__slow" style="gap: 8px; animation-delay: 1500ms;"><img src="https://assets.satumomen.com/images/galleries/429872-gallery-TOcbTwboVg.png" height="24" width="24" alt="429872-gallery-TOcbTwboVg.png"> <div class="editable" style="font-size: 14.4px;">16.00 WIB</div></div><div class="d-inline-flex animate__animated animate__fadeInRight animate__slow" style="gap: 8px; animation-delay: 2000ms;"><img src="https://assets.satumomen.com/images/galleries/429872-gallery-VHPSW6hJAe.png" height="24" width="24" alt="429872-gallery-VHPSW6hJAe.png"> <div class="editable" style="font-size: 14.4px;">Menara BTN Ballroom Lt. 6</div></div><div class="d-inline-flex animate__animated animate__fadeInRight animate__slow" style="gap: 8px; animation-delay: 2500ms;"><img src="https://assets.satumomen.com/images/galleries/429872-gallery-omx5M6sDUZ.png" height="24" width="24" alt="429872-gallery-omx5M6sDUZ.png"> <div class="editable" style="font-size: 14.4px;">Blue/Silver/Grey</div></div></div> <div data-datetime="2025-12-19T16:00" class="countdown-wrapper mx-auto d-flex flex-column animate__animated animate__fadeInUp animate__slower" style="max-width: 280px; min-width: 280px;"><div class="countdown text-center"><div class="countdown-item day" style="color: var(--btn-color);"><div class="number">00</div> <div class="text editable">Hari</div></div> <div class="countdown-item hour" style="color: var(--btn-color);"><div class="number">00</div> <div class="text editable">Jam</div></div> <div class="countdown-item minute" style="color: var(--btn-color);"><div class="number">00</div> <div class="text editable">Menit</div></div> <div class="countdown-item second" style="color: var(--btn-color);"><div class="number">00</div> <div class="text editable">Detik</div></div></div> <button class="btn-countdown btn btn-sm btn-pilled btn-accent mt-2">Atur Countdown</button></div></div></div></div></div></li> <li class="satumomen_slide" style="display: none;"><div class="container-mobile" style="background-image: url(&quot;http://app.kitaberdua.com/themes/light-begins/bg.webp&quot;);"><div class="frame"><img src="https://app.kitaberdua.com/themes/light-begins/bm-2.webp" alt="frame" class="frame-br w-100 animate__animated animate__fadeInUp animate__slower" style="animation-delay: 800ms;"> <img src="https://app.kitaberdua.com/themes/light-begins/bm-1.webp" alt="frame" class="frame-br w-100 animate__animated animate__fadeInUp animate__slower" style="bottom: -1px;"> <img src="https://app.kitaberdua.com/themes/light-begins/snow.webp" alt="frame" class="frame-tl w-100 animate__animated animate__flash animate__infinite" style="animation-duration: 7s;"></div> <div class="h-100 d-flex justify-content-center align-items-center"><div class="w-100"><div class="text-center mb-5"><div class="mb-4 mx-auto image-editable animate__animated animate__fadeInDown animate__slower" style="height: auto; width: 75%; animation-delay: 500ms;"><img src="https://assets.satumomen.com/images/galleries/748472-gallery-bgqnaVnP3f.webp" alt="25725-gallery-1670256481.jpg" style="width: 100%; height: 100%; object-fit: cover;"></div> <div class="mx-auto image-editable animate__animated animate__zoomIn animate__slower" style="height: auto; width: 75%; animation-delay: 400ms;"><img src="https://assets.satumomen.com/images/galleries/748472-gallery-iRNXmzrH74.webp" alt="25725-gallery-1670256481.jpg" style="width: 100%; height: 100%; object-fit: cover;"></div></div> <div class="text-center"><div class="text-center p-3 mb-4 animate__animated animate__fadeIn animate__slow" style="animation-delay: 500ms; background-color: var(--inv-bg); border: 4px solid var(--inv-border); border-radius: 1rem;"><div class="editable" style="font-size: 14.4px;">Klik tombol di bawah ini<br>untuk konfirmasi kehadiran</div></div> <button class="btn-rsvp btn btn-primary rounded-pill mx-auto animate__animated animate__fadeInUp animate__slow font-weight-bold" style="animation-delay: 500ms; font-size: 14.4px;">Konfirmasi Kehadiran</button></div></div></div></div></li> <li class="satumomen_slide" style="display: none;"><div class="container-mobile" style="background-image: url(&quot;http://app.kitaberdua.com/themes/light-begins/bg.webp&quot;);"><div class="frame"><img src="https://app.kitaberdua.com/themes/light-begins/bm-2.webp" alt="frame" class="frame-br w-100 animate__animated animate__fadeInUp animate__slower" style="animation-delay: 800ms;"> <img src="https://app.kitaberdua.com/themes/light-begins/bm-1.webp" alt="frame" class="frame-br w-100 animate__animated animate__fadeInUp animate__slower" style="bottom: -1px;"> <img src="https://app.kitaberdua.com/themes/light-begins/snow.webp" alt="frame" class="frame-tl w-100 animate__animated animate__flash animate__infinite" style="animation-duration: 7s;"></div> <div class="h-100 d-flex justify-content-center align-items-center"><div class="w-100"><div class="text-center mb-5"><div class="mb-4 mx-auto image-editable animate__animated animate__fadeInDown animate__slower" style="height: auto; width: 75%; animation-delay: 500ms;"><img src="https://assets.satumomen.com/images/galleries/748472-gallery-bgqnaVnP3f.webp" alt="25725-gallery-1670256481.jpg" style="width: 100%; height: 100%; object-fit: cover;"></div> <div class="mx-auto image-editable animate__animated animate__zoomIn animate__slower" style="height: auto; width: 75%; animation-delay: 400ms;"><img src="https://assets.satumomen.com/images/galleries/748472-gallery-iRNXmzrH74.webp" alt="25725-gallery-1670256481.jpg" style="width: 100%; height: 100%; object-fit: cover;"></div></div> <div class="text-center"><div class="text-center p-3 mb-4 animate__animated animate__fadeIn animate__slow" style="animation-delay: 500ms; background-color: var(--inv-bg); border: 4px solid var(--inv-border); border-radius: 1rem;"><div class="editable font-weight-bold" style="font-size: 14.4px;">Menara BTN Ballroom Lv. 6th</div><div class="editable" style="font-size: 14.4px;">Jl. Gajah Mada No.1, RT.2/RW.8,<br>Petojo Utara, Kecamatan Gambir,<br>Kota Jakarta Pusat, Daerah Khusus<br>Ibukota Jakarta 10130</div></div> <a target="_BLANK" href="https://maps.app.goo.gl/7cHebqg96mU2xaDEA" rel="noreferrer noopener" class="link btn btn-primary rounded-pill mx-auto animate__animated animate__fadeInUp animate__slow font-weight-bold" style="animation-delay: 500ms; font-size: 14.4px;">Petunjuk Ke Lokasi</a></div></div></div></div></li> <li class="satumomen_slide" style="display: none;"><div class="container-mobile" style="background-image: url(&quot;http://app.kitaberdua.com/themes/light-begins/bg.webp&quot;);"><div class="frame"><img src="https://app.kitaberdua.com/themes/light-begins/bm-2.webp" alt="frame" class="frame-br w-100 animate__animated animate__fadeInUp animate__slower" style="animation-delay: 800ms;"> <img src="https://app.kitaberdua.com/themes/light-begins/bm-1.webp" alt="frame" class="frame-br w-100 animate__animated animate__fadeInUp animate__slower" style="bottom: -1px;"> <img src="https://app.kitaberdua.com/themes/light-begins/snow.webp" alt="frame" class="frame-tl w-100 animate__animated animate__flash animate__infinite" style="animation-duration: 7s;"></div> <div class="position-relative h-100 d-flex justify-content-center align-items-center"><div class="w-100 h-100"><div class="text-center mb-5"><div class="mb-4 mx-auto image-editable animate__animated animate__fadeInDown animate__slower" style="height: auto; width: 75%; animation-delay: 500ms;"><img src="https://assets.satumomen.com/images/galleries/748472-gallery-bgqnaVnP3f.webp" alt="25725-gallery-1670256481.jpg" style="width: 100%; height: 100%; object-fit: cover;"></div> <div class="mx-auto image-editable animate__animated animate__zoomIn animate__slower" style="height: auto; width: 75%; animation-delay: 400ms;"><img src="https://assets.satumomen.com/images/galleries/748472-gallery-iRNXmzrH74.webp" alt="25725-gallery-1670256481.jpg" style="width: 100%; height: 100%; object-fit: cover;"></div></div> <div class="text-center" style="height: 150px;"></div></div> <div class="mx-auto image-editable animate__animated animate__fadeInUp animate__slower" style="height: auto; width: calc(100% + 60px); animation-delay: 400ms; position: absolute; left: -30px; right: -30px; bottom: -30px;"><img src="https://assets.satumomen.com/images/galleries/748472-gallery-nnG0yZgKMd.webp" alt="25725-gallery-1670256481.jpg" style="width: 100%; height: 100%; object-fit: cover;"></div></div></div></li> <li class="satumomen_slide" style="display: none;"><div class="container-mobile" style="background-image: url(&quot;http://app.kitaberdua.com/themes/light-begins/bg.webp&quot;);"><div class="frame"><img src="https://app.kitaberdua.com/themes/light-begins/bm-2.webp" alt="frame" class="frame-br w-100 animate__animated animate__fadeInUp animate__slower" style="animation-delay: 800ms;"> <img src="https://app.kitaberdua.com/themes/light-begins/bm-1.webp" alt="frame" class="frame-br w-100 animate__animated animate__fadeInUp animate__slower" style="bottom: -1px;"> <img src="https://app.kitaberdua.com/themes/light-begins/snow.webp" alt="frame" class="frame-tl w-100 animate__animated animate__flash animate__infinite" style="animation-duration: 7s;"></div> <div class="relative h-100 d-flex justify-content-center align-items-center"><div class="w-100 pb-4"><div class="text-center"><div class="mb-4 mx-auto image-editable animate__animated animate__fadeInDown animate__slower" style="height: auto; width: 75%; animation-delay: 500ms;"><img src="https://assets.satumomen.com/images/galleries/748472-gallery-bgqnaVnP3f.webp" alt="25725-gallery-1670256481.jpg" style="width: 100%; height: 100%; object-fit: cover;"></div> <div class="mx-auto image-editable animate__animated animate__zoomIn animate__slower" style="height: auto; width: 75%; animation-delay: 400ms;"><img src="https://assets.satumomen.com/images/galleries/748472-gallery-iRNXmzrH74.webp" alt="25725-gallery-1670256481.jpg" style="width: 100%; height: 100%; object-fit: cover;"></div></div> <div class="text-center p-3 mb-3 animate__animated animate__fadeIn animate__slow" style="animation-delay: 800ms;"><div class="editable mb-2" style="font-size: 12px;">Anda dapat mengirimkan dukungan dana Natal kepada rekening di bawah ini</div><div class="mx-auto image-editable bg-white rounded" style="width: 120px; height: 120px; overflow: hidden;"><img src="https://assets.satumomen.com/images/galleries/748472-gallery-N3gHAsnAGc.webp" alt="no-image.jpg" style="width: 100%; height: 100%; object-fit: contain;"></div></div><div class="mb-3"><div class="d-flex animate__animated animate__zoomIn animate__slow" style="animation-delay: 1500ms;"><div class="mx-auto"><div class="d-flex align-items-center"><div class="image-editable bg-white rounded" style="width: 80px; height: 50px; overflow: hidden;"><img src="https://assets.satumomen.com/assets/65e4402c20cbf-1732615009.jpg" alt="no-image.jpg" style="width: 100%; height: 100%; object-fit: contain;"></div> <div class="text-left pl-2"><div class="editable account-number font-weight-bold h5 mb-0" style="font-size: 18px;">12345678</div><button type="button" class="btn btn-sm btn-primary mt-2 mb-2 animate__animated animate__fadeInUp animate__slow delay-5" data-text="12345678" style="font-family: sans-serif; border-radius: 4px">Salin Rekening</button><div class="editable" style="font-size: 14.4px;">BCA : Atas Nama Rekening</div></div></div></div></div></div><div class="text-center animate__animated animate__fadeIn animate__slow" style="animation-delay: 2000ms;"><div class="editable" style="font-size: 12px;">Berilah kepada Tuhan kemuliaan nama-Nya, <br>bawalah persembahan dan masuklah <br>ke pelataran-Nya! </div><div class="editable font-weight-bold" style="font-size: 12px;">(Mazmur 96:8)</div></div></div></div></div></li> <li class="satumomen_slide" style="display: none;"><div class="container-mobile" style="background-image: url(&quot;http://app.kitaberdua.com/themes/light-begins/bg.webp&quot;);"><div class="frame"><img src="https://app.kitaberdua.com/themes/light-begins/bm-2.webp" alt="frame" class="frame-br w-100 animate__animated animate__fadeInUp animate__slower" style="animation-delay: 800ms;"> <img src="https://app.kitaberdua.com/themes/light-begins/bm-1.webp" alt="frame" class="frame-br w-100 animate__animated animate__fadeInUp animate__slower" style="bottom: -1px;"> <img src="https://app.kitaberdua.com/themes/light-begins/snow.webp" alt="frame" class="frame-tl w-100 animate__animated animate__flash animate__infinite" style="animation-duration: 7s;"></div> <div class="h-100 watermark d-flex justify-content-center align-items-center"><div class="text-center"><div class="text-center mb-3"><div class="mb-4 mx-auto image-editable animate__animated animate__fadeInDown animate__slower" style="height: auto; width: 75%; animation-delay: 500ms;"><img src="https://assets.satumomen.com/images/galleries/748472-gallery-bgqnaVnP3f.webp" alt="25725-gallery-1670256481.jpg" style="width: 100%; height: 100%; object-fit: cover;"></div> <div class="mx-auto image-editable animate__animated animate__zoomIn animate__slower" style="height: auto; width: 75%; animation-delay: 400ms;"><img src="https://assets.satumomen.com/images/galleries/748472-gallery-iRNXmzrH74.webp" alt="25725-gallery-1670256481.jpg" style="width: 100%; height: 100%; object-fit: cover;"></div></div><div class="text-center p-3 mb-4 animate__animated animate__fadeIn animate__slow" style="animation-delay: 800ms; background-color: var(--inv-bg); border: 4px solid var(--inv-border); border-radius: 1rem;"><div class="editable" style="font-size: 14.4px;">Demikian undangan ini kami sampaikan. Semoga Bapak/Ibu berkenan hadir dalam momen istimewa ini. Tuhan Memberkati.</div></div><div class="watermark-placeholder"><div id="waterMark" class="mt-5" style="display: inherit;"><div class="wm-music mt-3 text-center animate__animated animate__fadeInUp animate__slower animate__delay-1s" style="font-size: 60%;"><div style="opacity: 0.5;"><strong>Music:</strong></div> <div style="opacity: 0.5;">JINGLE BELLS - Christmas</div></div></div></div></div></div></div></li></ul></div></div> <div id="smMenu" class="satumomen_menu"><ul class="satumomen_menu_list"><li class="satumomen_menu_item active" style="max-width: 82.8px;"><i class="icon ph-fill ph-house" style="color: currentcolor;"></i> <span>Opening</span></li> <li class="satumomen_menu_item" style="max-width: 82.8px;"><i class="icon ph-fill ph-calendar-check" style="color: currentcolor;"></i> <span>Event</span></li> <li class="satumomen_menu_item" style="max-width: 82.8px;"><i class="icon ph-fill ph-envelope" style="color: currentcolor;"></i> <span>RSVP</span></li> <li class="satumomen_menu_item" style="max-width: 82.8px;"><i class="icon ph-fill ph-buildings" style="color: currentcolor;"></i> <span>Maps</span></li> <li class="satumomen_menu_item" style="max-width: 82.8px;"><i class="icon ph-fill ph-cake" style="color: currentcolor;"></i> <span>Pembicara</span></li> <li class="satumomen_menu_item" style="max-width: 82.8px;"><i class="icon ph-fill ph-gift" style="color: currentcolor;"></i> <span>Dukungan</span></li> <li class="satumomen_menu_item" style="max-width: 82.8px;"><i class="icon ph-fill ph-confetti" style="color: currentcolor;"></i> <span>Thanks</span></li></ul></div> <div class="floating-action d-flex align-items-end flex-column"><button id="btnQrModal" class="btn btn-float"><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 256 256"><rect x="40" y="40" width="80" height="80" rx="16"></rect><rect x="40" y="136" width="80" height="80" rx="16"></rect><rect x="136" y="40" width="80" height="80" rx="16"></rect><path d="M144,184a8,8,0,0,0,8-8V144a8,8,0,0,0-16,0v32A8,8,0,0,0,144,184Z"></path><path d="M208,152H184v-8a8,8,0,0,0-16,0v56H144a8,8,0,0,0,0,16h32a8,8,0,0,0,8-8V168h24a8,8,0,0,0,0-16Z"></path><path d="M208,184a8,8,0,0,0-8,8v16a8,8,0,0,0,16,0V192A8,8,0,0,0,208,184Z"></path></svg></button> <button id="btnMusic" class="btn btn-float playing"><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 256 256" class="play"><path d="M184,152V104a8,8,0,0,1,16,0v48a8,8,0,0,1-16,0Zm40-72a8,8,0,0,0-8,8v80a8,8,0,0,0,16,0V88A8,8,0,0,0,224,80ZM53.92,34.62A8,8,0,1,0,42.08,45.38L73.55,80H32A16,16,0,0,0,16,96v64a16,16,0,0,0,16,16H77.25l69.84,54.31A8,8,0,0,0,160,224V175.09l42.08,46.29a8,8,0,1,0,11.84-10.76Zm92.16,77.59A8,8,0,0,0,160,106.83V32a8,8,0,0,0-12.91-6.31l-39.85,31a8,8,0,0,0-1,11.7Z"></path></svg> <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 256 256" class="pause"><path d="M160,32V224a8,8,0,0,1-12.91,6.31L77.25,176H32a16,16,0,0,1-16-16V96A16,16,0,0,1,32,80H77.25l69.84-54.31A8,8,0,0,1,160,32Zm32,64a8,8,0,0,0-8,8v48a8,8,0,0,0,16,0V104A8,8,0,0,0,192,96Zm32-16a8,8,0,0,0-8,8v80a8,8,0,0,0,16,0V88A8,8,0,0,0,224,80Z"></path></svg></button> <button id="btnAutoplay" class="btn btn-float"><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 256 256" class="play"><path d="M128,24A104,104,0,1,0,232,128,104.13,104.13,0,0,0,128,24Zm36.44,110.66-48,32A8.05,8.05,0,0,1,112,168a8,8,0,0,1-8-8V96a8,8,0,0,1,12.44-6.66l48,32a8,8,0,0,1,0,13.32Z"></path></svg> <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 256 256" class="pause"><path d="M128,24A104,104,0,1,0,232,128,104.13,104.13,0,0,0,128,24ZM112,160a8,8,0,0,1-16,0V96a8,8,0,0,1,16,0Zm48,0a8,8,0,0,1-16,0V96a8,8,0,0,1,16,0Z"></path></svg></button></div></div></div></div></div> <div id="lightboxWrapper" class="lightbox-wrapper"><div class="lightbox-list"></div> <a href="https://app.kitaberdua.com/preview/light-begins#" id="lightboxCloseBtn" class="btn-lightbox"><svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 0 1 1.414 0L10 8.586l4.293-4.293a1 1 0 1 1 1.414 1.414L11.414 10l4.293 4.293a1 1 0 0 1-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 0 1-1.414-1.414L8.586 10 4.293 5.707a1 1 0 0 1 0-1.414z" clip-rule="evenodd"></path></svg></a> <div class="lightbox-navigation"><a href="https://app.kitaberdua.com/preview/light-begins#" id="lightboxPrevBtn" data-index="0" class="lightbox-arrow"><svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m15 19-7-7 7-7"></path></svg></a> <a href="https://app.kitaberdua.com/preview/light-begins#" id="lightboxNextBtn" data-index="0" class="lightbox-arrow"><svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m9 5 7 7-7 7"></path></svg></a></div></div> <div id="qrModal" tabindex="-1" role="dialog" aria-labelledby="qrModal" aria-hidden="true" class="modal fade"><div class="modal-dialog modal-dialog-centered"><div class="modal-content" style="height: 100%;"><div style="width: 100%; aspect-ratio: 16 / 9; background-size: cover; background-position: center center; background-image: url(&quot;/images/no-image.jpg&quot;);"></div> <div class="text-center py-4 px-4"><div><div class="mx-auto"><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="180" height="180" viewBox="0 0 180 180"><rect x="0" y="0" width="180" height="180" fill="#ffffff"></rect><g transform="scale(7.2)"><g transform="translate(0,0)"><path fill-rule="evenodd" d="M8 0L8 4L9 4L9 5L8 5L8 7L9 7L9 6L10 6L10 9L11 9L11 8L12 8L12 9L13 9L13 10L15 10L15 11L14 11L14 12L13 12L13 11L12 11L12 12L11 12L11 13L9 13L9 12L10 12L10 11L11 11L11 10L9 10L9 9L7 9L7 8L4 8L4 11L3 11L3 10L2 10L2 11L1 11L1 9L2 9L2 8L0 8L0 14L3 14L3 15L2 15L2 16L0 16L0 17L2 17L2 16L5 16L5 17L8 17L8 18L9 18L9 19L8 19L8 21L10 21L10 22L11 22L11 24L12 24L12 25L14 25L14 23L15 23L15 22L16 22L16 23L20 23L20 21L21 21L21 16L19 16L19 15L20 15L20 14L21 14L21 15L22 15L22 18L23 18L23 15L22 15L22 14L24 14L24 13L25 13L25 12L24 12L24 11L23 11L23 10L24 10L24 9L25 9L25 8L21 8L21 9L20 9L20 8L19 8L19 9L20 9L20 11L21 11L21 12L22 12L22 13L20 13L20 12L17 12L17 15L16 15L16 12L15 12L15 11L17 11L17 9L14 9L14 7L15 7L15 6L14 6L14 7L13 7L13 6L12 6L12 7L11 7L11 3L10 3L10 2L9 2L9 0ZM14 0L14 1L11 1L11 2L12 2L12 5L13 5L13 2L14 2L14 3L15 3L15 2L14 2L14 1L16 1L16 2L17 2L17 0ZM16 3L16 4L14 4L14 5L16 5L16 8L17 8L17 3ZM12 7L12 8L13 8L13 7ZM6 9L6 10L7 10L7 11L6 11L6 12L7 12L7 13L3 13L3 11L2 11L2 13L3 13L3 14L4 14L4 15L5 15L5 16L7 16L7 15L8 15L8 17L9 17L9 18L11 18L11 20L12 20L12 21L11 21L11 22L12 22L12 21L13 21L13 22L15 22L15 21L16 21L16 22L17 22L17 21L16 21L16 16L15 16L15 15L14 15L14 17L15 17L15 18L13 18L13 17L12 17L12 16L13 16L13 15L12 15L12 16L10 16L10 17L9 17L9 14L8 14L8 10L7 10L7 9ZM21 9L21 10L23 10L23 9ZM12 12L12 13L11 13L11 14L10 14L10 15L11 15L11 14L12 14L12 13L13 13L13 14L15 14L15 13L13 13L13 12ZM23 12L23 13L24 13L24 12ZM18 13L18 15L19 15L19 14L20 14L20 13ZM6 14L6 15L7 15L7 14ZM24 16L24 17L25 17L25 16ZM17 17L17 20L20 20L20 17ZM18 18L18 19L19 19L19 18ZM9 19L9 20L10 20L10 19ZM12 19L12 20L13 20L13 21L15 21L15 19L14 19L14 20L13 20L13 19ZM22 19L22 24L20 24L20 25L25 25L25 24L24 24L24 22L25 22L25 19ZM23 20L23 21L24 21L24 20ZM8 23L8 25L10 25L10 23ZM12 23L12 24L13 24L13 23ZM15 24L15 25L16 25L16 24ZM18 24L18 25L19 25L19 24ZM0 0L0 7L7 7L7 0ZM1 1L1 6L6 6L6 1ZM2 2L2 5L5 5L5 2ZM18 0L18 7L25 7L25 0ZM19 1L19 6L24 6L24 1ZM20 2L20 5L23 5L23 2ZM0 18L0 25L7 25L7 18ZM1 19L1 24L6 24L6 19ZM2 20L2 23L5 23L5 20Z" fill="#000000"></path></g></g></svg> <div style="margin-top: 10px; text-align: center;"></div></div></div> <hr style="margin-top: 1rem; margin-bottom: 1rem; border-width: 2px 0px 0px; border-style: dashed none none; border-color: rgba(0, 0, 0, 0.1) currentcolor currentcolor; border-image: none;"> <div style="text-align: center;"><strong>16 Dec 2025</strong><br> <p class="mb-0">06:20 </p> <p></p></div> <hr style="margin-top: 1rem; margin-bottom: 1rem; border-width: 2px 0px 0px; border-style: dashed none none; border-color: rgba(0, 0, 0, 0.1) currentcolor currentcolor; border-image: none;"> <div style="margin-bottom: 10px;"><div style="color: rgb(178, 178, 178);">Nama</div> <div>Nama Tamu</div></div> <div style="margin-bottom: 10px;"><div style="color: rgb(178, 178, 178);">Grup</div> <div>VIP</div></div></div> <button type="button" class="btn btn-close"><svg xmlns="http://www.w3.org/2000/svg" height="42px" width="42px" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18 18 6M6 6l12 12"></path></svg></button></div></div></div> <div id="rsvpModal" tabindex="-1" role="dialog" aria-labelledby="rsvpModal" class="modal fade"><div class="modal-dialog modal-dialog-centered"><div class="modal-content p-4" style="height: 100%;"><div class="rsvp-form show"><!----> <div class="mb-4"><div class="font-accent h4 text-center">RSVP</div></div> <form class="pt-2"><div><div class="form-group mb-2"><label for="inputname" class="small mb-1">Nama</label> <input aria-hidden="false" id="inputname" type="text" placeholder="Nama" required="required" class="form-control"> <!----></div> <!----> <!----> <!----> <!----></div><div><!----> <div class="form-group mb-2"><label for="inputgroup_name" class="small mb-1">Grup</label> <input aria-hidden="false" id="inputgroup_name" type="text" placeholder="Grup" class="form-control"> <!----></div> <!----> <!----> <!----></div><div><!----> <!----> <div class="form-group mb-2"><label for="inputphone" class="small mb-1">No WhatsApp</label> <div class="input-group"><div class="input-group-prepend"><button type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="btn bg-white border dropdown-toggle">+62</button> <div class="dropdown-menu shadow"><span class="dropdown-item"><input type="search" placeholder="Search Country..." class="form-control form-control-sm"></span> <button type="button" class="dropdown-item active">
                            Indonesia +62
                        ...
                        Tidak Hadir
                    </option></select> <!----></div> <!----></div><div><!----> <!----> <!----> <!----> <!----></div><div><!----> <!----> <!----> <!----> <!----></div> <!----> <!----><!----><!----><!----><!----><div class="form-group mb-2"><label for="inputcomment" class="small mb-1">Komentar atau Ucapan</label> <textarea id="inputcomment" rows="3" placeholder="Komentar atau Ucapan" required="required" class="form-control"></textarea> <!----></div> <button type="submit" class="btn btn-primary rounded-pill btn-block mt-4 mb-2"><span>Kirim</span></button></form> <div class="comment border-top mt-4 py-4"><div class="comment-item"><div class="d-flex"><img src="https://ui-avatars.com/api/?size=40&amp;background=random&amp;color=random&amp;name=Tobbi%20dan%20rossi" alt="Tobbi dan rossi" loading="lazy" class="avatar rounded-circle" style="height: 30px; width: 30px;"> <div class="ml-2 text-left"><p class="mb-0 font-weight-bold">
                        Tobbi dan rossi
                        <span class="badge alert-info">Hadir</span></p> <p class="mb-0">tolong</p> <small>7 April 2026 at 11.08</small></div></div></div><div class="comment-item"><div class="d-flex"><img src="https://ui-avatars.com/api/?size=40&amp;background=random&amp;color=random&amp;name=revi" alt="revi" loading="lazy" class="avatar rounded-circle" style="height: 30px; width: 30px;"> <div class="ml-2 text-left"><p class="mb-0 font-weight-bold">
                        revi
                        <span class="badge alert-info">Hadir</span></p> <p class="mb-0">tolong</p> <small>31 March 2026 at 21.44</small></div></div></div><div class="comment-item"><div class="d-flex"><img src="https://ui-avatars.com/api/?size=40&amp;background=random&amp;color=random&amp;name=rth" alt="rth" loading="lazy" class="avatar rounded-circle" style="height: 30px; width: 30px;"> <div class="ml-2 text-left"><p class="mb-0 font-weight-bold">
                        rth
                        <span class="badge alert-info">Hadir</span></p> <p class="mb-0">teyeyy</p> <small>3 February 2026 at 16.42</small></div></div></div><div class="comment-item"><div class="d-flex"><img src="https://ui-avatars.com/api/?size=40&amp;background=random&amp;color=random&amp;name=Nama%20Tamu" alt="Nama Tamu" loading="lazy" class="avatar rounded-circle" style="height: 30px; width: 30px;"> <div class="ml-2 text-left"><p class="mb-0 font-weight-bold">
                        Nama Tamu
                        <span class="badge alert-info">Hadir</span></p> <p class="mb-0">Ok3</p> <small>22 January 2026 at 15.14</small></div></div></div></div></div> <button type="button" class="btn btn-close"><svg xmlns="http://www.w3.org/2000/svg" height="42px" width="42px" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18 18 6M6 6l12 12"></path></svg></button></div></div></div> </main>
    <!-- illegal -->
