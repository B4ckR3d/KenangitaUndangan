...
<?php
/**
 * Theme Template: Bonvoyage V4
 * Category: School & Graduation
...
@import url("https://fonts.googleapis.com/css2?family=Agdasima:wght@400;700&family=Marck+Script&family=Roboto:ital,wght@0,100..900;1,100..900&display=swap");

:root { --inv-bg: #092177; --inv-base: #ffffff; --inv-accent: #ffffff; --inv-border: #ffffff; --menu-bg: #020839; --menu-active: #ffffff; --menu-inactive: #fff; --btn-color: #020839; --font-base: "Roboto", sans-serif; --font-accent: "Agdasima", sans-serif; --font-latin: "Marck Script", cursive; }

.btn-primary { border-radius: 0.4rem !important; }

.frame { display: none; }

.satumomen_list li:first-child .frame, .satumomen_list li:last-child .frame { display: block; }
...
.noty_theme__nest.noty_type__success { background-color: rgb(6, 214, 160); color: rgb(255, 255, 255); }
    ...
    <meta name="title" content="School &amp; Graduation - Bonvoyage V4">
    <meta name="description" content="undangan wisuda biru perwira pelayaran - Undangan digital elegan untuk sekolah: perpisahan, pentas seni, seminar, wisuda, dan acara penting lainnya hanya dalam hitungan menit! Mudah, hemat, dan siap pakai. Coba gratis sekarang!">
    <meta itemprop="image" content="http://app.kitaberdua.com/themes/bonvoyage-v4/bonvoyage-v4.webp">
        <link rel="icon" type="image/x-icon" href="https://assets.satumomen.com/images/media/6108-media-1682180901.png">
        <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="http://app.kitaberdua.com/preview/bonvoyage-v4">
    <meta property="og:title" content="School &amp; Graduation - Bonvoyage V4">
    <meta property="og:description" content="undangan wisuda biru perwira pelayaran - Undangan digital elegan untuk sekolah: perpisahan, pentas seni, seminar, wisuda, dan acara penting lainnya hanya dalam hitungan menit! Mudah, hemat, dan siap pakai. Coba gratis sekarang!">
    <meta property="og:image" content="http://app.kitaberdua.com/themes/bonvoyage-v4/bonvoyage-v4.webp">
...
<body>
      ...
      <source src="<?= !empty($musiknya) ? $musiknya : 'https://assets.satumomen.com/musics/mars-perhubungan.mp3' ?>">
    </audio> <div id="workspace-container" class="position-fixed h-100 w-100" style="overflow: hidden;"><div id="panZoom" class="position-fixed h-100 w-100" style="inset: 0px; transform-origin: 50% 50%; transform: scale(1.07473) translate(0px, 0px);"><div class="h-100 w-100 d-flex align-items-center justify-content-center"><div class="canvas not-open" style="height: 736px;"><div id="satuMomen" data-guest="<?= \esc($invite); ?>" data-group="VIP" style="height: 736px; display: block;"><div class="satumomen_track"><ul class="satumomen_list"><li class="satumomen_slide satumomen_cover" style=""><div class="container-mobile cover" style="background-image: url(&quot;http://app.kitaberdua.com/themes/bonvoyage-v4/bg.webp&quot;);"><div class="frame"><div class="text-center frame-br w-100 animate__animated animate__fadeInUp animate__slower"><img src="https://app.kitaberdua.com/themes/bonvoyage-v4/kapal.webp" alt="frame" draggable="false" class="mx-auto w-100"></div></div> <div class="h-100 d-flex flex-column justify-content-center align-items-center"><div style="width: 100%; z-index: 1;"><div class="mb-3 mx-auto animate__animated animate__fadeInDown animate__slower image-editable" style="height: 35px; width: 90%;"><img src="https://assets.satumomen.com/images/galleries/797098-gallery-YjpqkfX0yk.webp" alt="199472-gallery-1701959835.png" style="width: 100%; height: 100%; object-fit: contain;"></div></div> <div class="mb-3"><div class="text-center animate__animated animate__fadeInDown animate__slower"><div class="editable font-weight-bold font-accent" style="font-size: 40px; line-height: 1; color: rgb(255, 255, 255); font-family: serif;">UNDANGAN</div></div> <div class="mx-auto animate__animated animate__fadeInDown animate__slower image-editable" style="height: 40px;"><img src="https://assets.satumomen.com/images/galleries/797098-gallery-LnKtOXbKhj.webp" alt="199472-gallery-1701959835.png" style="width: 100%; height: 100%; object-fit: contain;"></div><div class="text-center animate__animated animate__zoomIn animate__slower"><div class="color-accent editable font-weight-bold" style="font-size: 13px; color: rgb(255, 255, 255);">WISUDA KE-102 DAN PELEPASAN <br>PERWIRA TRANSPORTASI LAUT <br>POLITEKNIK ILMU PELAYARAN SEMARANG</div></div><div class="mx-auto animate__animated animate__fadeInUp animate__slower image-editable" style="height: 40px;"><img src="https://assets.satumomen.com/images/galleries/797098-gallery-F0arvt8k67.webp" alt="199472-gallery-1701959835.png" style="width: 100%; height: 100%; object-fit: contain;"></div><div class="text-center mb-2 animate__animated animate__fadeInUp animate__slower"><div class="editable font-italic" style="font-size: 12px; color: rgb(255, 255, 255);">"Empowering Maritime Excellence : <br>Safety, Efficiency, and Sustainability"</div></div><div class="text-center mb-2 animate__animated animate__fadeInUp animate__slower"><div class="editable font-weight-bold" style="font-size: 13px; color: rgb(255, 255, 255);">Semarang, 9 April 2026</div></div><div class="text-center mb-2 animate__animated animate__fadeInDown animate__slower"><div class="editable font-italic font-weight-bold" style="font-size: 17px; color: rgb(244, 67, 54);"></div></div></div> <div class="w-100 text-center" style="z-index: 1;"><div class="mx-auto mb-4 animate__animated animate__fadeInUp" style="background-color: rgba(255, 255, 255, 0.15); padding: 8px 16px; border-radius: 8px; backdrop-filter: blur(4px); width: 65%; border: 2px solid rgba(255, 255, 255, 0.72); box-shadow: rgba(0, 0, 0, 0.15) 0px 0.5rem 1rem !important;"><div class="editable mb-2 animate__animated animate__fadeInUp animate__slower" style="font-size: 14.4px;">Kepada Yth.<br>Bapak/Ibu/Saudara/i</div>
  ...
  </div> <button class="btn-open-invitation btn btn-primary mb-4 animate__animated animate__fadeInUp animate__slower" style="font-size: 14.4px;">Buka Undangan</button></div></div></div></li> <li class="satumomen_slide" style="display: none;"><div class="container-mobile" style="background-image: url(&quot;http://app.kitaberdua.com/themes/bonvoyage-v4/bg.webp&quot;);"><div class="frame"><div class="text-center frame-br w-100 animate__animated animate__fadeInUp animate__slower"><img src="https://app.kitaberdua.com/themes/bonvoyage-v4/kapal.webp" alt="frame" draggable="false" class="mx-auto w-100"></div></div> <div class="d-flex justify-content-center align-items-center" style="height: 100%;"><div style="width: 100%;"><div class="text-center mb-4 animate__animated animate__fadeInDown animate__slower"><div class="color-accent h4 mb-2 editable font-latin" style="font-size: 30px;">Our Memories</div></div> <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 8px;"><div class="light image-editable animate__animated animate__zoomIn animate__slower" style="overflow: hidden; width: 100%;"><img src="https://assets.satumomen.com/images/galleries/199472-gallery-1701960931.jpg" alt="199472-gallery-1701960931.jpg" class="lightbox" style="width: 100%; height: 100%; object-fit: cover;"></div><div class="light image-editable animate__animated animate__zoomIn animate__slower" style="overflow: hidden; width: 100%;"><img src="https://assets.satumomen.com/images/galleries/199472-gallery-1701960922.jpg" alt="199472-gallery-1701960922.jpg" class="lightbox" style="width: 100%; height: 100%; object-fit: cover;"></div><div class="light image-editable animate__animated animate__zoomIn animate__slower" style="overflow: hidden; width: 100%;"><img src="https://assets.satumomen.com/images/galleries/199472-gallery-1701960962.jpg" alt="199472-gallery-1701960962.jpg" class="lightbox" style="width: 100%; height: 100%; object-fit: cover;"></div><div class="light image-editable animate__animated animate__zoomIn animate__slower" style="overflow: hidden; width: 100%;"><img src="https://assets.satumomen.com/images/galleries/199472-gallery-1701960950.jpg" alt="199472-gallery-1701960950.jpg" class="lightbox" style="width: 100%; height: 100%; object-fit: cover;"></div><div class="light image-editable animate__animated animate__zoomIn animate__slower" style="overflow: hidden; width: 100%;"><img src="https://assets.satumomen.com/images/galleries/199472-gallery-1701960942.jpg" alt="199472-gallery-1701960942.jpg" class="lightbox" style="width: 100%; height: 100%; object-fit: cover;"></div><div class="light image-editable animate__animated animate__zoomIn animate__slower" style="overflow: hidden; width: 100%;"><img src="https://assets.satumomen.com/images/galleries/199472-gallery-1701964752.jpg" alt="199472-gallery-1701964752.jpg" class="lightbox" style="width: 100%; height: 100%; object-fit: cover;"></div></div></div></div></div></li> <li class="satumomen_slide" style="display: none;"><div class="container-mobile" style="background-image: url(&quot;http://app.kitaberdua.com/themes/bonvoyage-v4/bg.webp&quot;);"><div class="frame"><div class="text-center frame-br w-100 animate__animated animate__fadeInUp animate__slower"><img src="https://app.kitaberdua.com/themes/bonvoyage-v4/kapal.webp" alt="frame" draggable="false" class="mx-auto w-100"></div></div> <div class="d-flex justify-content-center align-items-center" style="height: 100%;"><div style="width: 100%; z-index: 1;"><div class="text-center mb-3 animate__animated animate__fadeInDown animate__slower"><div class="editable color-accent h4 mb-2 font-latin" style="font-size: 30px;">Tema</div> <div class="editable" style="font-size: 16px;"></div><div class="editable font-italic" style="font-size: 12px;">"Optimizing Digital Transformation and Sustainability<br>for a Globally Competitive Maritime Future"</div></div> <div class="text-center mb-3 animate__animated animate__fadeInDown animate__slower"><div class="editable color-accent font-weight-bold" style="font-size: 20px;">Semarang, 24 Juni 2025<br></div> <div class="editable" style="font-size: 16px;">PUKUL 08:00 WIT s.d Selesai</div> <div class="editable" style="font-size: 16px;"></div></div><div class="animate__animated animate__fadeInDown animate__slow" style="width: 100%; margin: auto auto 20px; border-radius: 10px; overflow: hidden; padding-bottom: 40%; position: relative;"><iframe width="100%" height="100%" allowfullscreen="allowfullscreen" src="cid:frame-9DA3C08F32D347AC61B63BBAEF4E0154@mhtml.blink" class="maps-embed" style="border: 0px; position: absolute;"></iframe></div> <button class="btn-maps btn btn-sm btn-pilled btn-block btn-accent mt-1 mb-4">Edit Denah Lokasi</button> <div class="text-center animate__animated animate__fadeInDown animate__slow"><div class="editable font-weight-bold" style="font-size: 14.4px;">Lapangan 7 Samudra</div> <div class="editable mb-3" style="font-size: 14.4px;">Politeknik Pelayaran Sorong</div><a href="https://www.google.com/maps/place/?q=-0.8082567999999999,131.2889593" target="_blank" rel="noreferrer noopener" class="btn-maps-link btn btn-primary mb-4 animate__animated animate__fadeInUp animate__slow">Petunjuk Ke Lokasi</a></div></div></div></div></li> <li class="satumomen_slide" style="display: none;"><div class="container-mobile" style="background-image: url(&quot;http://app.kitaberdua.com/themes/bonvoyage-v4/bg.webp&quot;);"><div class="frame"><div class="text-center frame-br w-100 animate__animated animate__fadeInUp animate__slower"><img src="https://app.kitaberdua.com/themes/bonvoyage-v4/kapal.webp" alt="frame" draggable="false" class="mx-auto w-100"></div></div> <div class="d-flex justify-content-center align-items-center" style="height: 100%;"><div style="width: 100%;"><div class="text-center mb-4 animate__animated animate__fadeInDown animate__slower"><div class="color-accent h4 mb-2 editable font-latin" style="font-size: 30px;">Agenda Acara</div></div> <div class="image-editable d-flex flex-wrap" style="margin: -8px;"><div class="animate__animated animate__zoomIn animate__slower" style="height: auto; width: 100%; overflow: hidden; padding: 8px;"><div style="overflow: hidden; width: 100%; height: auto; border-radius: 0.5rem;"><img src="https://assets.satumomen.com/images/galleries/199472-gallery-1701964949.jpg" alt="199472-gallery-1701964949.jpg" class="lightbox" style="width: 100%; height: 100%; object-fit: cover; border-radius: 0.2rem;"></div></div> <div class="animate__animated animate__zoomIn animate__slower" style="width: 100%; overflow: hidden; padding: 8px;"></div></div></div></div></div></li> <li class="satumomen_slide" style="display: none;"><div class="container-mobile" style="background-image: url(&quot;http://app.kitaberdua.com/themes/bonvoyage-v4/bg.webp&quot;);"><div class="frame"><div class="text-center frame-br w-100 animate__animated animate__fadeInUp animate__slower"><img src="https://app.kitaberdua.com/themes/bonvoyage-v4/kapal.webp" alt="frame" draggable="false" class="mx-auto w-100"></div></div> <div class="d-flex justify-content-center align-items-center" style="height: 100%;"><div style="width: 100%;"><div class="text-center mb-4 animate__animated animate__fadeInDown animate__slower"><div class="color-accent h4 mb-2 editable font-latin" style="font-size: 30px;">Pakaian</div> <div class="editable mb-4" style="font-size: 14.4px;">Tamu Undangan Kemeja, Batik,<br>Celana Panjang (Bebas Rapi)</div></div> <div class="form-row" style="margin: -8px;"><div class="col-6"><div class="animate__animated animate__zoomIn animate__slower" style="width: 100%; overflow: hidden; padding: 8px;"><div class="mx-auto" style="overflow: hidden; width: 100%; height: 120px; border-radius: 13px;"><img src="https://assets.satumomen.com/images/galleries/199472-gallery-1701964446.jpg" alt="199472-gallery-1701964446.jpg" class="lightbox" style="width: 100%; height: 100%; object-fit: cover;"></div> <div class="mt-2 text-center editable font-weight-bold" style="font-size: 14.4px;">Kemeja</div></div></div> <div class="col-6"><div class="animate__animated animate__zoomIn animate__slower" style="width: 100%; overflow: hidden; padding: 8px;"><div class="mx-auto" style="overflow: hidden; width: 100%; height: 120px; border-radius: 13px;"><img src="https://assets.satumomen.com/images/galleries/199472-gallery-1701964470.jpg" alt="199472-gallery-1701964470.jpg" class="lightbox" style="width: 100%; height: 100%; object-fit: cover;"></div> <div class="mt-2 text-center editable font-weight-bold" style="font-size: 14.4px;">Batik</div></div></div><div class="animate__animated animate__zoomIn animate__slower" style="width: 100%; overflow: hidden; padding: 8px;"><div class="mx-auto" style="overflow: hidden; width: 200px; height: 120px; border-radius: 13px;"><img src="https://assets.satumomen.com/images/galleries/199472-gallery-1701964603.jpg" alt="199472-gallery-1701964603.jpg" class="lightbox" style="width: 100%; height: 100%; object-fit: cover;"></div> <div class="mt-2 text-center editable font-weight-bold" style="font-size: 14.4px;">Bebas Rapi</div></div></div></div></div></div></li> <li class="satumomen_slide" style="display: none;"><div class="container-mobile" style="background-image: url(&quot;http://app.kitaberdua.com/themes/bonvoyage-v4/bg.webp&quot;);"><div class="frame"><div class="text-center frame-br w-100 animate__animated animate__fadeInUp animate__slower"><img src="https://app.kitaberdua.com/themes/bonvoyage-v4/kapal.webp" alt="frame" draggable="false" class="mx-auto w-100"></div></div> <div class="d-flex justify-content-center align-items-center" style="height: 100%;"><div class="my-auto" style="width: 100%; z-index: 1;"><div data-datetime="2028-12-09T08:00" class="countdown-wrapper mb-3 d-flex flex-column animate__animated animate__fadeInUp animate__slower"><div class="countdown text-center"><div class="countdown-item day"><div class="number">845</div> <div class="text editable">Hari</div></div> <div class="countdown-item hour"><div class="number">5</div> <div class="text editable">Jam</div></div> <div class="countdown-item minute"><div class="number">36</div> <div class="text editable">Menit</div></div> <div class="countdown-item second"><div class="number">32</div> <div class="text editable">Detik</div></div></div> <button class="btn-countdown btn btn-sm btn-pilled btn-accent mt-2">Atur Countdown</button></div> <div class="text-center"><div class="editable mb-4 animate__animated animate__fadeInUp animate__slower" style="font-size: 14.4px;">Tekan tombol dibawah ini<br>untuk konfirmasi kehadiran</div> <button class="btn-rsvp btn btn-primary mx-auto rounded-pill mb-4 animate__animated animate__fadeInUp animate__slow" style="gap: 8px; font-size: 14px;">Konfirmasi Kehadiran</button></div></div></div></div></li> <li class="satumomen_slide" style="display: none;"><div class="container-mobile" style="background-image: url(&quot;http://app.kitaberdua.com/themes/bonvoyage-v4/bg.webp&quot;);"><div class="frame"><div class="text-center frame-br w-100 animate__animated animate__fadeInUp animate__slower"><img src="https://app.kitaberdua.com/themes/bonvoyage-v4/kapal.webp" alt="frame" draggable="false" class="mx-auto w-100"></div></div> <div class="d-flex justify-content-center align-items-center" style="height: 100%;"><div><div class="text-center color-accent h4 mb-2 editable animate__animated animate__fadeInDown animate__slower font-latin" style="font-size: 30px;">Contact Person</div> <div class="editable mb-4 text-center animate__animated animate__fadeInUp animate__slower" style="font-size: 14.4px;">Hubungi Contact Person kami jika ada hal<br>yang ingin ditanyakan.</div> <div class="text-center animate__animated animate__fadeInUp animate__slower mb-4"><div class="editable color-accent h4 mb-2 animate__animated animate__fadeInUp animate__slower font-accent" style="font-size: 20px;">Sdr. Alfian</div> <a href="https://wa.me/628xxxxx" target="_blank" rel="noreferrer noopener" class="link btn btn-primary rounded-pill animate__animated animate__fadeInUp animate__slower">WA 0821-9145-xxxx</a></div> <div class="text-center animate__animated animate__fadeInUp animate__slower mb-4"><div class="editable color-accent h4 mb-2 animate__animated animate__fadeInUp animate__slower font-accent" style="font-size: 20px;">Sdr. Ridwan</div> <a href="https://wa.me/628xxxx" target="_blank" rel="noreferrer noopener" class="link btn btn-primary rounded-pill animate__animated animate__fadeInUp animate__slower">WA 0813-6847-xxxx</a></div><div class="text-center animate__animated animate__fadeInUp animate__slower"><div class="editable color-accent h4 mb-2 animate__animated animate__fadeInUp animate__slower font-accent" style="font-size: 20px;">Sdri. Meike Tricilia</div> <a href="https://wa.me/68xxxxx" target="_blank" rel="noreferrer noopener" class="link btn btn-primary rounded-pill animate__animated animate__fadeInUp animate__slower">WA 0822-9671-xxxx</a></div></div></div></div></li> <li class="satumomen_slide" style="display: none;"><div class="container-mobile" style="background-image: url(&quot;http://app.kitaberdua.com/themes/bonvoyage-v4/bg.webp&quot;);"><div class="frame"><div class="text-center frame-br w-100 animate__animated animate__fadeInUp animate__slower"><img src="https://app.kitaberdua.com/themes/bonvoyage-v4/kapal.webp" alt="frame" draggable="false" class="mx-auto w-100"></div></div> <div class="watermark d-flex justify-content-center align-items-center" style="height: 100%;"><div><div class="text-center"><div class="editable quotes mb-3 animate__animated animate__fadeInDown animate__slower" style="font-size: 14.4px;">Suatu kebanggaan dan kehormatan bagi kami, jika bapak/ibu berkenan hadir.</div> <div class="editable font-italic animate__animated animate__fadeInDown animate__slow" style="font-size: 14.4px;">Sampai Jumpa</div> <div class="editable h4 color-accent animate__animated animate__fadeInDown animate__slow font-accent" style="font-size: 30px;">Semarang, 24 Juni 2025</div><div class="text-center"><a href="https://calendar.google.com/calendar/u/0/r/eventedit?text=INAUGURASI%20TARUNA%20MUDA%20BATCH%20XVII%20POLITEKNIK%20PELAYARAN%20SORONG&amp;dates=20231209T0800%2F20231209T1600&amp;details=&amp;location=Lapangan%20TUjuh%20Samudra%20Politeknik%20Pelayaran%20Sorong" target="_blank" rel="noreferrer noopener" class="btn-reminder btn btn-primary my-3 animate__animated animate__fadeInUp animate__slow">Add to Calendar</a></div> <div class="text-center pb-5"></div> <div class="watermark-placeholder mt-5"><div id="waterMark" class="mt-5" style="display: inherit;"><div class="wm-music mt-3 text-center animate__animated animate__fadeInUp animate__slower animate__delay-1s" style="font-size: 60%;"><div style="opacity: 0.5;"><strong>Music:</strong></div> <div style="opacity: 0.5;">MARS PERHUBUNGAN</div></div></div></div></div></div></div></div></li></ul></div></div> <div id="smMenu" class="satumomen_menu"><ul class="satumomen_menu_list"><li class="satumomen_menu_item active" style="max-width: 82.8px;"><i class="icon ph-fill ph-house" style="color: currentcolor;"></i> <span>Opening</span></li> <li class="satumomen_menu_item" style="max-width: 82.8px;"><i class="icon ph-fill ph-image" style="color: currentcolor;"></i> <span>Gallery</span></li> <li class="satumomen_menu_item" style="max-width: 82.8px;"><i class="icon ph-fill ph-calendar-check" style="color: currentcolor;"></i> <span>Acara</span></li> <li class="satumomen_menu_item" style="max-width: 82.8px;"><i class="icon ph-fill ph-article" style="color: currentcolor;"></i> <span>Rundown</span></li> <li class="satumomen_menu_item" style="max-width: 82.8px;"><i class="icon ph-fill ph-t-shirt" style="color: currentcolor;"></i> <span>Pakaian</span></li> <li class="satumomen_menu_item" style="max-width: 82.8px;"><i class="icon ph-fill ph-envelope" style="color: currentcolor;"></i> <span>RSVP</span></li> <li class="satumomen_menu_item" style="max-width: 82.8px;"><i class="icon ph-fill ph-phone" style="color: currentcolor;"></i> <span>Contact</span></li> <li class="satumomen_menu_item" style="max-width: 82.8px;"><i class="icon ph-fill ph-flag-banner" style="color: currentcolor;"></i> <span>Thanks</span></li></ul></div> <div class="floating-action d-flex align-items-end flex-column"><button id="btnQrModal" class="btn btn-float"><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 256 256"><rect x="40" y="40" width="80" height="80" rx="16"></rect><rect x="40" y="136" width="80" height="80" rx="16"></rect><rect x="136" y="40" width="80" height="80" rx="16"></rect><path d="M144,184a8,8,0,0,0,8-8V144a8,8,0,0,0-16,0v32A8,8,0,0,0,144,184Z"></path><path d="M208,152H184v-8a8,8,0,0,0-16,0v56H144a8,8,0,0,0,0,16h32a8,8,0,0,0,8-8V168h24a8,8,0,0,0,0-16Z"></path><path d="M208,184a8,8,0,0,0-8,8v16a8,8,0,0,0,16,0V192A8,8,0,0,0,208,184Z"></path></svg></button> <button id="btnMusic" class="btn btn-float playing"><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 256 256" class="play"><path d="M184,152V104a8,8,0,0,1,16,0v48a8,8,0,0,1-16,0Zm40-72a8,8,0,0,0-8,8v80a8,8,0,0,0,16,0V88A8,8,0,0,0,224,80ZM53.92,34.62A8,8,0,1,0,42.08,45.38L73.55,80H32A16,16,0,0,0,16,96v64a16,16,0,0,0,16,16H77.25l69.84,54.31A8,8,0,0,0,160,224V175.09l42.08,46.29a8,8,0,1,0,11.84-10.76Zm92.16,77.59A8,8,0,0,0,160,106.83V32a8,8,0,0,0-12.91-6.31l-39.85,31a8,8,0,0,0-1,11.7Z"></path></svg> <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 256 256" class="pause"><path d="M160,32V224a8,8,0,0,1-12.91,6.31L77.25,176H32a16,16,0,0,1-16-16V96A16,16,0,0,1,32,80H77.25l69.84-54.31A8,8,0,0,1,160,32Zm32,64a8,8,0,0,0-8,8v48a8,8,0,0,0,16,0V104A8,8,0,0,0,192,96Zm32-16a8,8,0,0,0-8,8v80a8,8,0,0,0,16,0V88A8,8,0,0,0,224,80Z"></path></svg></button> <button id="btnAutoplay" class="btn btn-float"><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 256 256" class="play"><path d="M128,24A104,104,0,1,0,232,128,104.13,104.13,0,0,0,128,24Zm36.44,110.66-48,32A8.05,8.05,0,0,1,112,168a8,8,0,0,1-8-8V96a8,8,0,0,1,12.44-6.66l48,32a8,8,0,0,1,0,13.32Z"></path></svg> <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 256 256" class="pause"><path d="M128,24A104,104,0,1,0,232,128,104.13,104.13,0,0,0,128,24ZM112,160a8,8,0,0,1-16,0V96a8,8,0,0,1,16,0Zm48,0a8,8,0,0,1-16,0V96a8,8,0,0,1,16,0Z"></path></svg></button></div></div></div></div></div> <div id="lightboxWrapper" class="lightbox-wrapper"><div class="lightbox-list"></div> <a href="https://app.kitaberdua.com/preview/bonvoyage-v4#" id="lightboxCloseBtn" class="btn-lightbox"><svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 0 1 1.414 0L10 8.586l4.293-4.293a1 1 0 1 1 1.414 1.414L11.414 10l4.293 4.293a1 1 0 0 1-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 0 1-1.414-1.414L8.586 10 4.293 5.707a1 1 0 0 1 0-1.414z" clip-rule="evenodd"></path></svg></a> <div class="lightbox-navigation"><a href="https://app.kitaberdua.com/preview/bonvoyage-v4#" id="lightboxPrevBtn" data-index="0" class="lightbox-arrow"><svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m15 19-7-7 7-7"></path></svg></a> <a href="https://app.kitaberdua.com/preview/bonvoyage-v4#" id="lightboxNextBtn" data-index="0" class="lightbox-arrow"><svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m9 5 7 7-7 7"></path></svg></a></div></div> <div id="qrModal" tabindex="-1" role="dialog" aria-labelledby="qrModal" aria-hidden="true" class="modal fade"><div class="modal-dialog modal-dialog-centered"><div class="modal-content" style="height: 100%;"><div style="width: 100%; aspect-ratio: 16 / 9; background-size: cover; background-position: center center; background-image: url(&quot;/images/no-image.jpg&quot;);"></div> <div class="text-center py-4 px-4"><div><div class="mx-auto"><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="180" height="180" viewBox="0 0 180 180"><rect x="0" y="0" width="180" height="180" fill="#ffffff"></rect><g transform="scale(7.2)"><g transform="translate(0,0)"><path fill-rule="evenodd" d="M8 0L8 4L9 4L9 5L8 5L8 7L9 7L9 6L10 6L10 9L11 9L11 8L12 8L12 9L13 9L13 10L15 10L15 11L14 11L14 12L13 12L13 11L12 11L12 12L11 12L11 13L9 13L9 12L10 12L10 11L11 11L11 10L9 10L9 9L7 9L7 8L4 8L4 11L3 11L3 10L2 10L2 11L1 11L1 9L2 9L2 8L0 8L0 14L3 14L3 15L2 15L2 16L0 16L0 17L2 17L2 16L5 16L5 17L8 17L8 18L9 18L9 19L8 19L8 21L10 21L10 22L11 22L11 24L12 24L12 25L14 25L14 23L15 23L15 22L16 22L16 23L20 23L20 21L21 21L21 16L19 16L19 15L20 15L20 14L21 14L21 15L22 15L22 18L23 18L23 15L22 15L22 14L24 14L24 13L25 13L25 12L24 12L24 11L23 11L23 10L24 10L24 9L25 9L25 8L21 8L21 9L20 9L20 8L19 8L19 9L20 9L20 11L21 11L21 12L22 12L22 13L20 13L20 12L17 12L17 15L16 15L16 12L15 12L15 11L17 11L17 9L14 9L14 7L15 7L15 6L14 6L14 7L13 7L13 6L12 6L12 7L11 7L11 3L10 3L10 2L9 2L9 0ZM14 0L14 1L11 1L11 2L12 2L12 5L13 5L13 2L14 2L14 3L15 3L15 2L14 2L14 1L16 1L16 2L17 2L17 0ZM16 3L16 4L14 4L14 5L16 5L16 8L17 8L17 3ZM12 7L12 8L13 8L13 7ZM6 9L6 10L7 10L7 11L6 11L6 12L7 12L7 13L3 13L3 11L2 11L2 13L3 13L3 14L4 14L4 15L5 15L5 16L7 16L7 15L8 15L8 17L9 17L9 18L11 18L11 20L12 20L12 21L11 21L11 22L12 22L12 21L13 21L13 22L15 22L15 21L16 21L16 22L17 22L17 21L16 21L16 16L15 16L15 15L14 15L14 17L15 17L15 18L13 18L13 17L12 17L12 16L13 16L13 15L12 15L12 16L10 16L10 17L9 17L9 14L8 14L8 10L7 10L7 9ZM21 9L21 10L23 10L23 9ZM12 12L12 13L11 13L11 14L10 14L10 15L11 15L11 14L12 14L12 13L13 13L13 14L15 14L15 13L13 13L13 12ZM23 12L23 13L24 13L24 12ZM18 13L18 15L19 15L19 14L20 14L20 13ZM6 14L6 15L7 15L7 14ZM24 16L24 17L25 17L25 16ZM17 17L17 20L20 20L20 17ZM18 18L18 19L19 19L19 18ZM9 19L9 20L10 20L10 19ZM12 19L12 20L13 20L13 21L15 21L15 19L14 19L14 20L13 20L13 19ZM22 19L22 24L20 24L20 25L25 25L25 24L24 24L24 22L25 22L25 19ZM23 20L23 21L24 21L24 20ZM8 23L8 25L10 25L10 23ZM12 23L12 24L13 24L13 23ZM15 24L15 25L16 25L16 24ZM18 24L18 25L19 25L19 24ZM0 0L0 7L7 7L7 0ZM1 1L1 6L6 6L6 1ZM2 2L2 5L5 5L5 2ZM18 0L18 7L25 7L25 0ZM19 1L19 6L24 6L24 1ZM20 2L20 5L23 5L23 2ZM0 18L0 25L7 25L7 18ZM1 19L1 24L6 24L6 19ZM2 20L2 23L5 23L5 20Z" fill="#000000"></path></g></g></svg> <div style="margin-top: 10px; text-align: center;"></div></div></div> <hr style="margin-top: 1rem; margin-bottom: 1rem; border-width: 2px 0px 0px; border-style: dashed none none; border-color: rgba(0, 0, 0, 0.1) currentcolor currentcolor; border-image: none;"> <div style="text-align: center;"><strong>09 Mar 2026</strong><br> <p class="mb-0">15:03 </p> <p></p></div> <hr style="margin-top: 1rem; margin-bottom: 1rem; border-width: 2px 0px 0px; border-style: dashed none none; border-color: rgba(0, 0, 0, 0.1) currentcolor currentcolor; border-image: none;"> <div style="margin-bottom: 10px;"><div style="color: rgb(178, 178, 178);">Nama</div> <div>Nama Tamu</div></div> <div style="margin-bottom: 10px;"><div style="color: rgb(178, 178, 178);">Grup</div> <div>VIP</div></div></div> <button type="button" class="btn btn-close"><svg xmlns="http://www.w3.org/2000/svg" height="42px" width="42px" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18 18 6M6 6l12 12"></path></svg></button></div></div></div> <div id="rsvpModal" tabindex="-1" role="dialog" aria-labelledby="rsvpModal" class="modal fade"><div class="modal-dialog modal-dialog-centered"><div class="modal-content p-4" style="height: 100%;"><div class="rsvp-form show"><!----> <div class="mb-4"><div class="font-accent h4 text-center">RSVP</div></div> <form class="pt-2"> <!---->  <button type="submit" class="btn btn-primary rounded-pill btn-block mt-4 mb-2"><span>Kirim</span></button></form> <!----></div> <button type="button" class="btn btn-close"><svg xmlns="http://www.w3.org/2000/svg" height="42px" width="42px" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18 18 6M6 6l12 12"></path></svg></button></div></div></div> </main>
    <!-- illegal -->
...
</style></head><body><div></div></div></body></html></template></merlin-floating-cta><div id="noty_layout__topCenter" class="noty_layout"><div id="noty_bar_d6af81b6-fcd2-4384-8bee-b14a7c0ed8f9" class="noty_bar noty_type__error noty_theme__relax noty_close_with_click noty_has_timeout"><div class="noty_body">Too Many Attempts.</div><div class="noty_progressbar" style="transition: width 4000ms linear; width: 0%;"></div></div></div></body></html>
