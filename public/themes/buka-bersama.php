...
@import url("https://fonts.googleapis.com/css2?family=Berkshire+Swash&family=Monsieur+La+Doulaise&family=Playfair+Display:ital,wght@0,400..900;1,400..900&display=swap");

:root { --inv-bg: #faf8f4; --inv-base: #442a08; --inv-accent: #B08B32; --inv-border: #ffffff; --font-base: "Playfair Display", serif; --font-accent: "Berkshire Swash", serif; --font-latin: "Monsieur La Doulaise", cursive; --menu-bg: #d1c3b1; --menu-inactive: #442a08; --menu-active: #B08B32; --btn-color: #ffffff; }

.editor-wrapper .frame-out { display: none; }
...
.noty_theme__nest.noty_type__success { background-color: rgb(6, 214, 160); color: rgb(255, 255, 255); }
    ...
    <meta name="title" content="Syukuran &amp; Islami - Buka Bersama">
    <meta name="description" content="undangan islami buka puasa">
    <meta itemprop="image" content="http://app.kitaberdua.com/themes/buka-bersama/buka-bersama.webp">
        <link rel="icon" type="image/x-icon" href="https://assets.satumomen.com/images/media/6108-media-1682180901.png">
        <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="http://app.kitaberdua.com/preview/buka-bersama">
    <meta property="og:title" content="Syukuran &amp; Islami - Buka Bersama">
    <meta property="og:description" content="undangan islami buka puasa">
    <meta property="og:image" content="http://app.kitaberdua.com/themes/buka-bersama/buka-bersama.webp">
...
<body>
      ...
      <source src="<?= !empty($musiknya) ? $musiknya : 'https://assets.satumomen.com/musics/MaherZainRamadanMalayVersion.mp3' ?>">
    </audio> <div id="workspace-container" class="position-fixed h-100 w-100" style="overflow: hidden;"><div id="panZoom" class="position-fixed h-100 w-100" style="inset: 0px; transform-origin: 50% 50%; transform: scale(1.07473) translate(0px, 0px);"><div class="h-100 w-100 d-flex align-items-center justify-content-center"><div class="canvas not-open" style="height: 736px;"><div id="satuMomen" data-guest="<?= \esc($invite); ?>" data-group="VIP" style="height: 736px; display: block;"><div class="satumomen_track"><ul class="satumomen_list"><li class="satumomen_slide satumomen_cover" style=""><div class="container-mobile cover" style="background-image: url(&quot;https://assets.satumomen.com/images/invitation/bg-section-87843771771803197.webp&quot;); background-size: cover;"><div class="frame"><img src="https://app.kitaberdua.com/themes/buka-bersama/tm.webp" alt="frame" class="frame-tl w-100 animate__animated animate__fadeInDown animate__slower"> <img src="https://app.kitaberdua.com/themes/buka-bersama/tl.webp" alt="frame" class="frame-tl animate__animated animate__fadeInLeft animate__slower"> <img src="https://app.kitaberdua.com/themes/buka-bersama/tr.webp" alt="frame" class="frame-tr animate__animated animate__fadeInRight animate__slower"> <img src="https://app.kitaberdua.com/themes/buka-bersama/mandala.webp" alt="frame" class="spin" style="position: absolute; left: 0px; right: 0px; bottom: -300px; width: 100%;"> <img src="https://app.kitaberdua.com/themes/islamic-wedding/pintu-left.webp" alt="frame" class="frame-out frame-bl h-100 animate__animated animate__slideOutLeft animate__slower" style="z-index: 9;"> <img src="https://app.kitaberdua.com/themes/islamic-wedding/pintu-right.webp" alt="frame" class="frame-out frame-br h-100 animate__animated animate__slideOutRight animate__slower" style="z-index: 9;"></div> <div class="h-100 d-flex justify-content-center align-items-end"><div class="w-100"><div class="mb-4 text-center animate__animated animate__fadeInDown animate__slower"><div class="editable mb-2" style="font-size: 16px;">Silaturahmi &amp; Buka Bersama</div><div class="editable color-accent h3 font-weight-bold font-brittany-signature" style="font-size: 40px;">Janur Kuning</div><div class="editable" style="font-size: 20px;">EVENT ORGANIZER</div></div><div class="text-center"><div class="editable mb-2 animate__animated animate__fadeInUp animate__slower" style="font-size: 14.4px;">Kepada Yth;<br>Bapak/Ibu/Saudara/i</div> 
   ...
   <button class="btn-open-invitation btn btn-primary rounded-pill mb-4 animate__animated animate__fadeInUp animate__slow">Buka Undangan</button></div></div></div></div></li> <li class="satumomen_slide" style="display: none;"><div class="container-mobile" style="background-image: url(&quot;http://app.kitaberdua.com/themes/buka-bersama/bg.webp&quot;);"><div class="frame"><img src="https://app.kitaberdua.com/themes/buka-bersama/tm.webp" alt="frame" class="frame-tl w-100 animate__animated animate__fadeInDown animate__slower"> <img src="https://app.kitaberdua.com/themes/buka-bersama/tl.webp" alt="frame" class="frame-tl animate__animated animate__fadeInLeft animate__slower"> <img src="https://app.kitaberdua.com/themes/buka-bersama/tr.webp" alt="frame" class="frame-tr animate__animated animate__fadeInRight animate__slower"> <img src="https://app.kitaberdua.com/themes/buka-bersama/mandala.webp" alt="frame" class="spin" style="position: absolute; left: 0px; right: 0px; bottom: -300px; width: 100%;"> <img src="https://app.kitaberdua.com/themes/islamic-wedding/pintu-left.webp" alt="frame" class="frame-out frame-bl h-100 animate__animated animate__slideOutLeft animate__slower" style="z-index: 9;"> <img src="https://app.kitaberdua.com/themes/islamic-wedding/pintu-right.webp" alt="frame" class="frame-out frame-br h-100 animate__animated animate__slideOutRight animate__slower" style="z-index: 9;"></div> <div class="d-flex justify-content-center align-items-center" style="height: 100%;"><div style="width: 100%;"><div class="image-editable animate__animated animate__fadeInDown animate__slower" style="height: 230px; width: 100%; margin: auto auto 20px; overflow: hidden; border: 4px solid var(--inv-border); border-radius: 4rem;"><img src="https://assets.satumomen.com/images/galleries/245121-gallery-u3rGNg4dyP.jpg" alt="245121-gallery-u3rGNg4dyP.jpg" class="mb-4" style="width: 100%; height: 100%; object-fit: cover;"></div> <div class="text-center animate__animated animate__fadeInUp animate__slower"><div class="color-accent editable font-italic mb-3 font-weight-bold" style="font-size: 14.4px;">Bismillahirrohmanirrohim<br>Assalamu'alaikum Wr Wb</div><div class="editable quotes" style="font-size: 14.4px;">Tanpa mengurangi rasa hormat, kami bermaksud mengundang Bapak/Ibu/Saudara/i pada acara Buka Puasa Bersama</div></div></div></div></div></li> <li class="satumomen_slide" style="display: none;"><div class="container-mobile" style="background-image: url(&quot;http://app.kitaberdua.com/themes/buka-bersama/bg.webp&quot;);"><div class="frame"><img src="https://app.kitaberdua.com/themes/buka-bersama/tm.webp" alt="frame" class="frame-tl w-100 animate__animated animate__fadeInDown animate__slower"> <img src="https://app.kitaberdua.com/themes/buka-bersama/tl.webp" alt="frame" class="frame-tl animate__animated animate__fadeInLeft animate__slower"> <img src="https://app.kitaberdua.com/themes/buka-bersama/tr.webp" alt="frame" class="frame-tr animate__animated animate__fadeInRight animate__slower"> <img src="https://app.kitaberdua.com/themes/buka-bersama/mandala.webp" alt="frame" class="spin" style="position: absolute; left: 0px; right: 0px; bottom: -300px; width: 100%;"> <img src="https://app.kitaberdua.com/themes/islamic-wedding/pintu-left.webp" alt="frame" class="frame-out frame-bl h-100 animate__animated animate__slideOutLeft animate__slower" style="z-index: 9;"> <img src="https://app.kitaberdua.com/themes/islamic-wedding/pintu-right.webp" alt="frame" class="frame-out frame-br h-100 animate__animated animate__slideOutRight animate__slower" style="z-index: 9;"></div> <div class="d-flex justify-content-center align-items-center" style="height: 100%;"><div style="width: 100%;"><div class="animate__animated animate__fadeInDown animate__slower"><div class="image-editable" style="width: 248px; margin: auto auto 20px; overflow: hidden; border: 4px solid var(--inv-border); border-radius: 4rem;"><img src="https://assets.satumomen.com/images/galleries/245121-gallery-EVjXJjVL3N.jpg" alt="245121-gallery-EVjXJjVL3N.jpg" style="width: 100%; height: 100%; object-fit: cover;"></div></div> <div class="text-center mb-4 animate__animated animate__fadeInUp animate__slower"><div class="editable color-accent h4 mb-2 font-accent" style="font-size: 28.8px;">Buka Puasa Bersama</div> <div class="editable font-weight-bold" style="font-size: 20px;">Ahad, 24 Maret 2024</div> <div class="editable" style="font-size: 14.4px;">Pukul 17.00(WIB) s.d Selesai</div> <div class="editable" style="font-size: 14.4px;">Aula Mess ibnu Rusyd Al-Ittifaqiah</div></div> <div data-datetime="2024-03-24T17:00" class="countdown-wrapper d-flex flex-column animate__animated animate__fadeInUp animate__slower"><div class="countdown text-center"><div class="countdown-item day"><div class="number">00</div> <div class="text editable">Hari</div></div> <div class="countdown-item hour"><div class="number">00</div> <div class="text editable">Jam</div></div> <div class="countdown-item minute"><div class="number">00</div> <div class="text editable">Menit</div></div> <div class="countdown-item second"><div class="number">00</div> <div class="text editable">Detik</div></div></div> <button class="btn-countdown btn btn-sm btn-pilled btn-accent mt-2">Atur Tanggal</button></div></div></div></div></li> <li class="satumomen_slide" style="display: none;"><div class="container-mobile" style="background-image: url(&quot;http://app.kitaberdua.com/themes/buka-bersama/bg.webp&quot;);"><div class="frame"><img src="https://app.kitaberdua.com/themes/buka-bersama/tm.webp" alt="frame" class="frame-tl w-100 animate__animated animate__fadeInDown animate__slower"> <img src="https://app.kitaberdua.com/themes/buka-bersama/tl.webp" alt="frame" class="frame-tl animate__animated animate__fadeInLeft animate__slower"> <img src="https://app.kitaberdua.com/themes/buka-bersama/tr.webp" alt="frame" class="frame-tr animate__animated animate__fadeInRight animate__slower"> <img src="https://app.kitaberdua.com/themes/buka-bersama/mandala.webp" alt="frame" class="spin" style="position: absolute; left: 0px; right: 0px; bottom: -300px; width: 100%;"> <img src="https://app.kitaberdua.com/themes/islamic-wedding/pintu-left.webp" alt="frame" class="frame-out frame-bl h-100 animate__animated animate__slideOutLeft animate__slower" style="z-index: 9;"> <img src="https://app.kitaberdua.com/themes/islamic-wedding/pintu-right.webp" alt="frame" class="frame-out frame-br h-100 animate__animated animate__slideOutRight animate__slower" style="z-index: 9;"></div> <div class="d-flex justify-content-center align-items-center" style="height: 100%;"><div style="width: 100%;"><div><div class="animate__animated animate__fadeInDown animate__slow" style="width: 100%; margin: auto auto 20px; border-radius: 10px; overflow: hidden; padding-bottom: 100%; position: relative;"><iframe width="100%" height="100%" allowfullscreen="allowfullscreen" src="cid:frame-3ECEEF6683EE43B728479DAB98909F58@mhtml.blink" class="maps-embed" style="border: 0px; position: absolute;"></iframe></div> <button class="btn-maps btn btn-sm btn-pilled btn-block btn-accent mt-1 mb-4">Edit Denah Lokasi</button> <div class="text-center animate__animated animate__fadeInUp animate__slow"><div class="editable font-weight-bold color-accent" style="font-size: 20px;">Aula Mess ibnu Rusyd Al-Ittifaqiah</div> <div class="editable mb-3" style="font-size: 14.4px;">Asian Highway No.25, RW.14, Indralaya Mulia, Indralaya, Ogan Ilir Regency, South Sumatra 30862</div><a href="https://www.google.com/maps/place/?q=-3.24929,104.6690222" target="_blank" rel="noreferrer noopener" class="btn-maps-link btn btn-primary rounded-pill mb-4 animate__animated animate__fadeInUp animate__slow">Petunjuk Ke Lokasi</a></div></div></div></div></div></li> <li class="satumomen_slide" style="display: none;"><div class="container-mobile" style="background-image: url(&quot;http://app.kitaberdua.com/themes/buka-bersama/bg.webp&quot;);"><div class="frame"><img src="https://app.kitaberdua.com/themes/buka-bersama/tm.webp" alt="frame" class="frame-tl w-100 animate__animated animate__fadeInDown animate__slower"> <img src="https://app.kitaberdua.com/themes/buka-bersama/tl.webp" alt="frame" class="frame-tl animate__animated animate__fadeInLeft animate__slower"> <img src="https://app.kitaberdua.com/themes/buka-bersama/tr.webp" alt="frame" class="frame-tr animate__animated animate__fadeInRight animate__slower"> <img src="https://app.kitaberdua.com/themes/buka-bersama/mandala.webp" alt="frame" class="spin" style="position: absolute; left: 0px; right: 0px; bottom: -300px; width: 100%;"> <img src="https://app.kitaberdua.com/themes/islamic-wedding/pintu-left.webp" alt="frame" class="frame-out frame-bl h-100 animate__animated animate__slideOutLeft animate__slower" style="z-index: 9;"> <img src="https://app.kitaberdua.com/themes/islamic-wedding/pintu-right.webp" alt="frame" class="frame-out frame-br h-100 animate__animated animate__slideOutRight animate__slower" style="z-index: 9;"></div> <div class="d-flex justify-content-center align-items-center" style="height: 100%;"><div class="text-center" style="width: 100%;"><div class="color-accent h4 mb-2 editable animate__animated animate__fadeInDown animate__slower font-latin" style="font-size: 28.8px;">Infaq</div> <div class="editable mb-4 animate__animated animate__fadeInDown animate__slower" style="font-size: 14.4px;">Anda dapat mengirimkan infaq melalui cash atau transfer ke rekening di bawah ini</div> <div style="display: flex; gap: 8px;"><button class="btn-gift btn btn-block btn-primary rounded-pill animate__animated animate__fadeInUp animate__slow" style="max-width: 150px; margin: auto; font-size: 14.4px;">Rekening</button></div><div class="gift-container mt-3 p-4 rounded" style="display: none;"><div class="d-flex animate__animated animate__zoomIn animate__slow"><div class="mx-auto"><div class="d-flex align-items-center mb-3"><div class="image-editable" style="width: 80px; overflow: hidden;"><img src="https://assets.satumomen.com/assets/logo-bsi-1687991484.png" alt="logo-bsi-1687991484.png" style="width: 100%; height: 100%; object-fit: contain;"></div> <div class="text-left pl-2"><div class="editable account-number font-weight-bold h5 mb-0">12345678</div><button type="button" class="btn btn-sm btn-primary mt-2 mb-2 animate__animated animate__fadeInUp animate__slow delay-5" data-text="12345678" style="font-family: sans-serif; border-radius: 4px">Salin Rekening</button> <div class="editable" style="font-size: 14.4px;">BCA : Atas Nama Rekening</div></div></div><div class="d-flex align-items-center"><div class="image-editable" style="width: 80px; overflow: hidden;"><img src="https://assets.satumomen.com/assets/logo-bsi-1687991484.png" alt="logo-bsi-1687991484.png" style="width: 100%; height: 100%; object-fit: contain;"></div> <div class="text-left pl-2"><div class="editable account-number font-weight-bold h5 mb-0">12345678</div><button type="button" class="btn btn-sm btn-primary mt-2 mb-2 animate__animated animate__fadeInUp animate__slow delay-5" data-text="12345678" style="font-family: sans-serif; border-radius: 4px">Salin Rekening</button> <div class="editable" style="font-size: 14.4px;">BCA : Atas Nama</div></div></div></div></div> <a href="https://wa.me/" rel="nofollow noreferrer noopener" target="_blank" class="mt-4 link btn btn-primary rounded-pill animate__animated animate__fadeInUp animate__slow" style="font-size: 14px;">Konfirmasi Transfer</a></div></div></div></div></li> <li class="satumomen_slide" style="display: none;"><div class="container-mobile" style="background-image: url(&quot;http://app.kitaberdua.com/themes/buka-bersama/bg.webp&quot;);"><div class="frame"><img src="https://app.kitaberdua.com/themes/buka-bersama/tm.webp" alt="frame" class="frame-tl w-100 animate__animated animate__fadeInDown animate__slower"> <img src="https://app.kitaberdua.com/themes/buka-bersama/tl.webp" alt="frame" class="frame-tl animate__animated animate__fadeInLeft animate__slower"> <img src="https://app.kitaberdua.com/themes/buka-bersama/tr.webp" alt="frame" class="frame-tr animate__animated animate__fadeInRight animate__slower"> <img src="https://app.kitaberdua.com/themes/buka-bersama/mandala.webp" alt="frame" class="spin" style="position: absolute; left: 0px; right: 0px; bottom: -300px; width: 100%;"> <img src="https://app.kitaberdua.com/themes/islamic-wedding/pintu-left.webp" alt="frame" class="frame-out frame-bl h-100 animate__animated animate__slideOutLeft animate__slower" style="z-index: 9;"> <img src="https://app.kitaberdua.com/themes/islamic-wedding/pintu-right.webp" alt="frame" class="frame-out frame-br h-100 animate__animated animate__slideOutRight animate__slower" style="z-index: 9;"></div> <div class="d-flex justify-content-center align-items-center" style="height: 100%;"><div style="width: 100%;"><div class="text-center"><div class="editable color-accent h4 mb-4 animate__animated animate__fadeInDown animate__slower font-latin" style="font-size: 28.8px;">Konfirmasi Kehadiran</div> <div class="editable mb-4 animate__animated animate__fadeInUp animate__slower" style="font-size: 14.4px;">Ya Allah, aku memohon kepada-Mu untuk mudah melakukan kebaikan dan meninggalkan kemungkaran serta aku memohon pada-Mu supaya bisa mencintai orang miskin, ampunilah (dosa-dosa)ku dan juga rahmatilah aku.</div> <div class="editable mb-4 animate__animated animate__fadeInUp animate__slower" style="font-size: 14.4px;">Tekan tombol dibawah ini untuk<br>konfirmasi kehadiran</div><button class="btn-rsvp btn btn-primary rounded-pill mb-4 animate__animated animate__fadeInUp animate__slow" style="font-size: 14px;">Konfirmasi Kehadiran</button></div></div></div></div></li> <li class="satumomen_slide" style="display: none;"><div class="container-mobile" style="background-image: url(&quot;http://app.kitaberdua.com/themes/buka-bersama/bg.webp&quot;);"><div class="frame"><img src="https://app.kitaberdua.com/themes/buka-bersama/tm.webp" alt="frame" class="frame-tl w-100 animate__animated animate__fadeInDown animate__slower"> <img src="https://app.kitaberdua.com/themes/buka-bersama/tl.webp" alt="frame" class="frame-tl animate__animated animate__fadeInLeft animate__slower"> <img src="https://app.kitaberdua.com/themes/buka-bersama/tr.webp" alt="frame" class="frame-tr animate__animated animate__fadeInRight animate__slower"> <img src="https://app.kitaberdua.com/themes/buka-bersama/mandala.webp" alt="frame" class="spin" style="position: absolute; left: 0px; right: 0px; bottom: -300px; width: 100%;"> <img src="https://app.kitaberdua.com/themes/islamic-wedding/pintu-left.webp" alt="frame" class="frame-out frame-bl h-100 animate__animated animate__slideOutLeft animate__slower" style="z-index: 9;"> <img src="https://app.kitaberdua.com/themes/islamic-wedding/pintu-right.webp" alt="frame" class="frame-out frame-br h-100 animate__animated animate__slideOutRight animate__slower" style="z-index: 9;"></div> <div class="d-flex justify-content-center align-items-center" style="height: 100%;"><div><div class="font-latin text-center color-accent h4 mb-2 editable animate__animated animate__fadeInDown animate__slower">Contact Person</div> <div class="editable mb-4 text-center animate__animated animate__fadeInUp animate__slower" style="font-size: 14.4px;">Hubungi Contact Person kami jika ada hal<br>yang ingin ditanyakan.</div> <div class="text-center animate__animated animate__fadeInLeft animate__slower mb-4"><div class="image-editable animate__animated animate__fadeInUp animate__slower" style="height: 100px; width: 100px; margin: auto auto 10px; border-radius: 100%; overflow: hidden;"><img src="https://assets.satumomen.com/images/galleries/4994-gallery-qifupOn63P.jpg" alt="4994-gallery-qifupOn63P.jpg" style="width: 100%; height: 100%; object-fit: cover;"></div> <div class="editable color-accent h4 mb-2 animate__animated animate__fadeInUp animate__slower font-accent" style="font-size: 28.8px;">Akhmad Renaldi</div> <a href="https://wa.me/6281250335095" target="_blank" rel="noreferrer noopener" class="link btn btn-primary rounded-pill animate__animated animate__fadeInUp animate__slower">WA 0812-2345-6789</a></div> <div class="text-center animate__animated animate__fadeInRight animate__slower"><div class="image-editable animate__animated animate__fadeInUp animate__slower" style="height: 100px; width: 100px; margin: auto auto 10px; border-radius: 100%; overflow: hidden;"><img src="https://assets.satumomen.com/images/galleries/4994-gallery-MQzAfmn650.jpg" alt="4994-gallery-MQzAfmn650.jpg" style="width: 100%; height: 100%; object-fit: cover;"></div> <div class="editable color-accent h4 mb-2 animate__animated animate__fadeInUp animate__slower font-accent" style="font-size: 28.8px;">Muhammad Rizani</div> <a href="https://wa.me/6281250335095" target="_blank" rel="noreferrer noopener" class="link btn btn-primary rounded-pill animate__animated animate__fadeInUp animate__slower">WA 0812-3456-7890</a></div></div></div></div></li> <li class="satumomen_slide" style="display: none;"><div class="container-mobile" style="background-image: url(&quot;http://app.kitaberdua.com/themes/buka-bersama/bg.webp&quot;);"><div class="frame"><img src="https://app.kitaberdua.com/themes/buka-bersama/tm.webp" alt="frame" class="frame-tl w-100 animate__animated animate__fadeInDown animate__slower"> <img src="https://app.kitaberdua.com/themes/buka-bersama/tl.webp" alt="frame" class="frame-tl animate__animated animate__fadeInLeft animate__slower"> <img src="https://app.kitaberdua.com/themes/buka-bersama/tr.webp" alt="frame" class="frame-tr animate__animated animate__fadeInRight animate__slower"> <img src="https://app.kitaberdua.com/themes/buka-bersama/mandala.webp" alt="frame" class="spin" style="position: absolute; left: 0px; right: 0px; bottom: -300px; width: 100%;"> <img src="https://app.kitaberdua.com/themes/islamic-wedding/pintu-left.webp" alt="frame" class="frame-out frame-bl h-100 animate__animated animate__slideOutLeft animate__slower" style="z-index: 9;"> <img src="https://app.kitaberdua.com/themes/islamic-wedding/pintu-right.webp" alt="frame" class="frame-out frame-br h-100 animate__animated animate__slideOutRight animate__slower" style="z-index: 9;"></div> <div class="watermark d-flex justify-content-center align-items-center" style="height: 100%;"><div><div class="text-center"><div class="editable quotes mb-3 animate__animated animate__fadeInDown animate__slower" style="font-size: 14.4px;">Merupakan suatu kebahagiaan dan kehormatan bagi kami, apabila Bapak/Ibu/Saudara/i, berkenan hadir.</div><div class="editable font-italic animate__animated animate__fadeInDown animate__slow">Hormat Kami Yang Mengundang</div> <div class="editable h4 color-accent animate__animated animate__fadeInDown animate__slow font-accent" style="font-size: 21.6px;">Panitia Pelaksana</div> <div class="watermark-placeholder mt-5"><div id="waterMark" class="mt-5" style="display: inherit;"><div class="wm-music mt-3 text-center animate__animated animate__fadeInUp animate__slower animate__delay-1s" style="font-size: 60%;"><div style="opacity: 0.5;"><strong>Music:</strong></div> <div style="opacity: 0.5;">MaherZain - Ramadan Malay Version</div></div></div></div></div></div></div></div></li></ul></div></div> <div id="smMenu" class="satumomen_menu"><ul class="satumomen_menu_list"><li class="satumomen_menu_item active" style="max-width: 82.8px;"><i class="icon ph-fill ph-star-and-crescent" style="color: currentcolor;"></i> <span>Opening</span></li> <li class="satumomen_menu_item" style="max-width: 82.8px;"><i class="icon ph-fill ph-envelope" style="color: currentcolor;"></i> <span>Salam</span></li> <li class="satumomen_menu_item" style="max-width: 82.8px;"><i class="icon ph-fill ph-calendar-check" style="color: currentcolor;"></i> <span>Acara</span></li> <li class="satumomen_menu_item" style="max-width: 82.8px;"><i class="icon ph-fill ph-house" style="color: currentcolor;"></i> <span>Maps</span></li> <li class="satumomen_menu_item" style="max-width: 82.8px;"><i class="icon ph-fill ph-wallet" style="color: currentcolor;"></i> <span>Infaq</span></li> <li class="satumomen_menu_item" style="max-width: 82.8px;"><i class="icon ph-fill ph-address-book" style="color: currentcolor;"></i> <span>RSVP</span></li> <li class="satumomen_menu_item" style="max-width: 82.8px;"><i class="icon ph-fill ph-phone" style="color: currentcolor;"></i> <span>Contact</span></li> <li class="satumomen_menu_item" style="max-width: 82.8px;"><i class="icon ph-fill ph-heart" style="color: currentcolor;"></i> <span>Thanks</span></li></ul></div> <div class="floating-action d-flex align-items-end flex-column"><button id="btnQrModal" class="btn btn-float"><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 256 256"><rect x="40" y="40" width="80" height="80" rx="16"></rect><rect x="40" y="136" width="80" height="80" rx="16"></rect><rect x="136" y="40" width="80" height="80" rx="16"></rect><path d="M144,184a8,8,0,0,0,8-8V144a8,8,0,0,0-16,0v32A8,8,0,0,0,144,184Z"></path><path d="M208,152H184v-8a8,8,0,0,0-16,0v56H144a8,8,0,0,0,0,16h32a8,8,0,0,0,8-8V168h24a8,8,0,0,0,0-16Z"></path><path d="M208,184a8,8,0,0,0-8,8v16a8,8,0,0,0,16,0V192A8,8,0,0,0,208,184Z"></path></svg></button> <button id="btnMusic" class="btn btn-float playing"><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 256 256" class="play"><path d="M184,152V104a8,8,0,0,1,16,0v48a8,8,0,0,1-16,0Zm40-72a8,8,0,0,0-8,8v80a8,8,0,0,0,16,0V88A8,8,0,0,0,224,80ZM53.92,34.62A8,8,0,1,0,42.08,45.38L73.55,80H32A16,16,0,0,0,16,96v64a16,16,0,0,0,16,16H77.25l69.84,54.31A8,8,0,0,0,160,224V175.09l42.08,46.29a8,8,0,1,0,11.84-10.76Zm92.16,77.59A8,8,0,0,0,160,106.83V32a8,8,0,0,0-12.91-6.31l-39.85,31a8,8,0,0,0-1,11.7Z"></path></svg> <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 256 256" class="pause"><path d="M160,32V224a8,8,0,0,1-12.91,6.31L77.25,176H32a16,16,0,0,1-16-16V96A16,16,0,0,1,32,80H77.25l69.84-54.31A8,8,0,0,1,160,32Zm32,64a8,8,0,0,0-8,8v48a8,8,0,0,0,16,0V104A8,8,0,0,0,192,96Zm32-16a8,8,0,0,0-8,8v80a8,8,0,0,0,16,0V88A8,8,0,0,0,224,80Z"></path></svg></button> <button id="btnAutoplay" class="btn btn-float"><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 256 256" class="play"><path d="M128,24A104,104,0,1,0,232,128,104.13,104.13,0,0,0,128,24Zm36.44,110.66-48,32A8.05,8.05,0,0,1,112,168a8,8,0,0,1-8-8V96a8,8,0,0,1,12.44-6.66l48,32a8,8,0,0,1,0,13.32Z"></path></svg> <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 256 256" class="pause"><path d="M128,24A104,104,0,1,0,232,128,104.13,104.13,0,0,0,128,24ZM112,160a8,8,0,0,1-16,0V96a8,8,0,0,1,16,0Zm48,0a8,8,0,0,1-16,0V96a8,8,0,0,1,16,0Z"></path></svg></button></div></div></div></div></div> <div id="lightboxWrapper" class="lightbox-wrapper"><div class="lightbox-list"></div> <a href="https://app.kitaberdua.com/preview/buka-bersama#" id="lightboxCloseBtn" class="btn-lightbox"><svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 0 1 1.414 0L10 8.586l4.293-4.293a1 1 0 1 1 1.414 1.414L11.414 10l4.293 4.293a1 1 0 0 1-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 0 1-1.414-1.414L8.586 10 4.293 5.707a1 1 0 0 1 0-1.414z" clip-rule="evenodd"></path></svg></a> <div class="lightbox-navigation"><a href="https://app.kitaberdua.com/preview/buka-bersama#" id="lightboxPrevBtn" data-index="0" class="lightbox-arrow"><svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m15 19-7-7 7-7"></path></svg></a> <a href="https://app.kitaberdua.com/preview/buka-bersama#" id="lightboxNextBtn" data-index="0" class="lightbox-arrow"><svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m9 5 7 7-7 7"></path></svg></a></div></div> <div id="qrModal" tabindex="-1" role="dialog" aria-labelledby="qrModal" aria-hidden="true" class="modal fade"><div class="modal-dialog modal-dialog-centered"><div class="modal-content" style="height: 100%;"><div style="width: 100%; aspect-ratio: 16 / 9; background-size: cover; background-position: center center; background-image: url(&quot;/images/no-image.jpg&quot;);"></div> <div class="text-center py-4 px-4"><div><div class="mx-auto"><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="180" height="180" viewBox="0 0 180 180"><rect x="0" y="0" width="180" height="180" fill="#ffffff"></rect><g transform="scale(7.2)"><g transform="translate(0,0)"><path fill-rule="evenodd" d="M8 0L8 4L9 4L9 5L8 5L8 7L9 7L9 6L10 6L10 9L11 9L11 8L12 8L12 9L13 9L13 10L15 10L15 11L14 11L14 12L13 12L13 11L12 11L12 12L11 12L11 13L9 13L9 12L10 12L10 11L11 11L11 10L9 10L9 9L7 9L7 8L4 8L4 11L3 11L3 10L2 10L2 11L1 11L1 9L2 9L2 8L0 8L0 14L3 14L3 15L2 15L2 16L0 16L0 17L2 17L2 16L5 16L5 17L8 17L8 18L9 18L9 19L8 19L8 21L10 21L10 22L11 22L11 24L12 24L12 25L14 25L14 23L15 23L15 22L16 22L16 23L20 23L20 21L21 21L21 16L19 16L19 15L20 15L20 14L21 14L21 15L22 15L22 18L23 18L23 15L22 15L22 14L24 14L24 13L25 13L25 12L24 12L24 11L23 11L23 10L24 10L24 9L25 9L25 8L21 8L21 9L20 9L20 8L19 8L19 9L20 9L20 11L21 11L21 12L22 12L22 13L20 13L20 12L17 12L17 15L16 15L16 12L15 12L15 11L17 11L17 9L14 9L14 7L15 7L15 6L14 6L14 7L13 7L13 6L12 6L12 7L11 7L11 3L10 3L10 2L9 2L9 0ZM14 0L14 1L11 1L11 2L12 2L12 5L13 5L13 2L14 2L14 3L15 3L15 2L14 2L14 1L16 1L16 2L17 2L17 0ZM16 3L16 4L14 4L14 5L16 5L16 8L17 8L17 3ZM12 7L12 8L13 8L13 7ZM6 9L6 10L7 10L7 11L6 11L6 12L7 12L7 13L3 13L3 11L2 11L2 13L3 13L3 14L4 14L4 15L5 15L5 16L7 16L7 15L8 15L8 17L9 17L9 18L11 18L11 20L12 20L12 21L11 21L11 22L12 22L12 21L13 21L13 22L15 22L15 21L16 21L16 22L17 22L17 21L16 21L16 16L15 16L15 15L14 15L14 17L15 17L15 18L13 18L13 17L12 17L12 16L13 16L13 15L12 15L12 16L10 16L10 17L9 17L9 14L8 14L8 10L7 10L7 9ZM21 9L21 10L23 10L23 9ZM12 12L12 13L11 13L11 14L10 14L10 15L11 15L11 14L12 14L12 13L13 13L13 14L15 14L15 13L13 13L13 12ZM23 12L23 13L24 13L24 12ZM18 13L18 15L19 15L19 14L20 14L20 13ZM6 14L6 15L7 15L7 14ZM24 16L24 17L25 17L25 16ZM17 17L17 20L20 20L20 17ZM18 18L18 19L19 19L19 18ZM9 19L9 20L10 20L10 19ZM12 19L12 20L13 20L13 21L15 21L15 19L14 19L14 20L13 20L13 19ZM22 19L22 24L20 24L20 25L25 25L25 24L24 24L24 22L25 22L25 19ZM23 20L23 21L24 21L24 20ZM8 23L8 25L10 25L10 23ZM12 23L12 24L13 24L13 23ZM15 24L15 25L16 25L16 24ZM18 24L18 25L19 25L19 24ZM0 0L0 7L7 7L7 0ZM1 1L1 6L6 6L6 1ZM2 2L2 5L5 5L5 2ZM18 0L18 7L25 7L25 0ZM19 1L19 6L24 6L24 1ZM20 2L20 5L23 5L23 2ZM0 18L0 25L7 25L7 18ZM1 19L1 24L6 24L6 19ZM2 20L2 23L5 23L5 20Z" fill="#000000"></path></g></g></svg> <div style="margin-top: 10px; text-align: center;"></div></div></div> <hr style="margin-top: 1rem; margin-bottom: 1rem; border-width: 2px 0px 0px; border-style: dashed none none; border-color: rgba(0, 0, 0, 0.1) currentcolor currentcolor; border-image: none;"> <div style="text-align: center;"><strong>23 Feb 2026</strong><br> <p class="mb-0">06:23 </p> <p></p></div> <hr style="margin-top: 1rem; margin-bottom: 1rem; border-width: 2px 0px 0px; border-style: dashed none none; border-color: rgba(0, 0, 0, 0.1) currentcolor currentcolor; border-image: none;"> <div style="margin-bottom: 10px;"><div style="color: rgb(178, 178, 178);">Nama</div> <div>Nama Tamu</div></div> <div style="margin-bottom: 10px;"><div style="color: rgb(178, 178, 178);">Grup</div> <div>VIP</div></div></div> <button type="button" class="btn btn-close"><svg xmlns="http://www.w3.org/2000/svg" height="42px" width="42px" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18 18 6M6 6l12 12"></path></svg></button></div></div></div> <div id="rsvpModal" tabindex="-1" role="dialog" aria-labelledby="rsvpModal" class="modal fade"><div class="modal-dialog modal-dialog-centered"><div class="modal-content p-4" style="height: 100%;"><div class="rsvp-form show"><!----> <div class="mb-4"><div class="font-accent h4 text-center">RSVP</div></div> <form class="pt-2"><div><div class="form-group mb-2"><label for="inputname" class="small mb-1">Nama</label> <input aria-hidden="false" id="inputname" type="text" placeholder="Nama" required="required" class="form-control"> <!----></div> <!----> <!----> <!----> <!----></div><div><!----> <div class="form-group mb-2"><label for="inputgroup_name" class="small mb-1">Grup</label> <input aria-hidden="false" id="inputgroup_name" type="text" placeholder="Grup" class="form-control"> <!----></div> <!----> <!----> <!----></div><div><!----> <!----> <div class="form-group mb-2"><label for="inputphone" class="small mb-1">No WhatsApp</label> <div class="input-group"><div class="input-group-prepend"><button type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="btn bg-white border dropdown-toggle">+62</button> <div class="dropdown-menu shadow"><span class="dropdown-item"><input type="search" placeholder="Search Country..." class="form-control form-control-sm"></span> <button type="button" class="dropdown-item active">
                            Indonesia +62
