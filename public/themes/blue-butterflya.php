...
<?php
/**
 * Theme Template: Blue Butterflya
 * Category: Wedding
...
:root { --inv-bg: #E3F1F7; --inv-base: #2E2E2E; --inv-accent: #406E89; --inv-border: #406E89; --menu-bg: #ccd3ea; --menu-inactive: #406e89; --menu-active: #406E89; --btn-color: #ffffff; --font-base: "Nunito", sans-serif; --font-accent: "Noto Serif", serif; --font-latin: "Mea Culpa", cursive; }

.frame-top, .theme .frame .frame-top { top: -100px; }

.frame-bottom, .frame-bm, .theme .frame .frame-bottom, .theme .frame .frame-bm { bottom: -20px; }

.satumomen_cover .frame-top, .theme.cover .frame-top { top: -20px; }

.satumomen_cover .frame-bottom, .theme.cover .frame-bottom { bottom: -20px; }

.satumomen_cover .frame-bm, .theme.cover .frame-bm { bottom: -100px; }

.satumomen_cover .frame-bm img, .theme.cover .frame-bm img { display: inline; }

.blow-left { animation: 10s linear 0s infinite normal none running blowLeft; }

.blow-right { animation: 10s linear 0s infinite normal none running blowRight; }

@keyframes blowLeft { 
  0% { transform: skew(0deg) rotate(0deg); }
  25% { transform: skew(0deg, 5deg) rotate(5deg); }
  50% { transform: skew(0deg) rotate(0deg); }
  75% { transform: skew(0deg, -5deg) rotate(-5deg); }
  100% { transform: skew(0deg) rotate(0deg); }
}
...
.frame::before { content: ""; position: absolute; inset: 24px; background-color: rgba(255, 255, 255, 0.9); border-radius: 20rem; backdrop-filter: blur(2px); }
...
.noty_theme__nest.noty_type__success { background-color: rgb(6, 214, 160); color: rgb(255, 255, 255); }
    ...
    <meta name="title" content="Wedding  - Blue Butterflya">
    <meta name="description" content="undangan minimalist simple flat hand drawn biru muda - Undangan Online: Undangan digital modern untuk pernikahan dan acara spesial lainnya. Gratis coba dulu, bayar belakangan!">
    <meta itemprop="image" content="http://app.kitaberdua.com/themes/blue-butterfly/blue-butterfly.webp">
        <link rel="icon" type="image/x-icon" href="https://assets.satumomen.com/images/media/6108-media-1682180901.png">
        <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="http://app.kitaberdua.com/preview/blue-butterfly">
    <meta property="og:title" content="Wedding  - Blue Butterflya">
    <meta property="og:description" content="undangan minimalist simple flat hand drawn biru muda - Undangan Online: Undangan digital modern untuk pernikahan dan acara spesial lainnya. Gratis coba dulu, bayar belakangan!">
    <meta property="og:image" content="http://app.kitaberdua.com/themes/blue-butterfly/blue-butterfly.webp">
...
<body>
      ...
      <source src="<?= !empty($musiknya) ? $musiknya : 'https://assets.satumomen.com/musics/love-story-taylor-swift-sax-cover-by-leon-chen-rdlfx2fnhok.mp3' ?>">
    </audio> <div id="workspace-container" class="position-fixed h-100 w-100" style="overflow: hidden;"><div id="panZoom" class="position-fixed h-100 w-100" style="inset: 0px; transform-origin: 50% 50%; transform: scale(1.07473) translate(0px, 0px);"><div class="h-100 w-100 d-flex align-items-center justify-content-center"><div class="canvas not-open" style="height: 736px;"><div id="satuMomen" data-guest="<?= \esc($invite); ?>" data-group="VIP" style="height: 736px; display: block;"><div class="satumomen_track"><ul class="satumomen_list"><li class="satumomen_slide satumomen_cover" style=""><div class="container-mobile cover" style="background-image: url(&quot;http://app.kitaberdua.com/themes/blue-butterfly/bg.webp&quot;);"><div class="frame"><div class="frame-bl w-100 text-center frame-bm animate__animated animate__fadeInUp animate__slow"><img src="https://app.kitaberdua.com/themes/blue-butterfly/bm.webp" alt="frame" class="blow-left" style="width: 100%; animation-delay: 500ms; transform-origin: center bottom;"></div> <div class="frame-tl frame-top animate__animated animate__fadeInTopLeft animate__slow" style="left: -15px;"><img src="https://app.kitaberdua.com/themes/blue-butterfly/tl.webp" alt="frame" class="w-100 blow-left" style="transform-origin: left top;"></div> <div class="frame-tr frame-top animate__animated animate__fadeInTopRight animate__slow" style="right: -15px;"><img src="https://app.kitaberdua.com/themes/blue-butterfly/tr.webp" alt="frame" class="w-100 blow-right" style="transform-origin: right top;"></div> <div class="frame-bl frame-bottom animate__animated animate__fadeInBottomLeft animate__slow"><img src="https://app.kitaberdua.com/themes/blue-butterfly/bl.webp" alt="frame" class="w-100 blow-left" style="transform-origin: left bottom;"></div> <div class="frame-br frame-bottom animate__animated animate__fadeInBottomRight animate__slow"><img src="https://app.kitaberdua.com/themes/blue-butterfly/br.webp" alt="frame" class="w-100 blow-right" style="transform-origin: right bottom;"></div></div> <div class="p-4 h-100 w-100 d-flex align-items-center justify-content-center"><div class="py-5 w-100 d-flex flex-column justify-content-center align-items-center"><div><div class="text-center mb-4 animate__animated animate__fadeInDown animate__slower"><div class="editable color-accent mb-4" style="color: rgb(51, 51, 51); font-size: 14.4px;">The Wedding Of</div><div class="mx-auto animate__animated animate__fadeInDown animate__slower image-editable" style="width: 160px;"><img src="https://assets.satumomen.com/images/galleries/820007-gallery-cej0v8U8g7.webp" alt="233328-gallery-oPePgJXNih.png" style="width: 100%; height: 100%; object-fit: cover;"></div> <div class="editable color-accent font-weight-bold font-accent" style="font-size: 20px; letter-spacing: 0.2rem;">Groom &amp; Bride</div><div class="editable color-accent font-accent" style="color: rgb(51, 51, 51); font-size: 12px;">We invite you to celebrate our wedding</div></div> <div class="text-center"><div class="editable mb-2 animate__animated animate__fadeInUp animate__slower" style="font-size: 14.4px;">Kepada Yth:<br>Bapak/Ibu/Saudara/i</div> 
   ...
   <button class="btn-open-invitation btn btn-primary rounded-pill mb-4 animate__animated animate__fadeInUp animate__slow">Buka
            Undangan</button></div></div></div></div></div></li> <li class="satumomen_slide" style="display: none;"><div class="container-mobile" style="background-image: url(&quot;http://app.kitaberdua.com/themes/blue-butterfly/bg.webp&quot;);"><div class="frame"><div class="frame-bl w-100 text-center frame-bm animate__animated animate__fadeInUp animate__slow"><img src="https://app.kitaberdua.com/themes/blue-butterfly/bm.webp" alt="frame" class="blow-left" style="width: 100%; animation-delay: 500ms; transform-origin: center bottom;"></div> <div class="frame-tl frame-top animate__animated animate__fadeInTopLeft animate__slow" style="left: -15px;"><img src="https://app.kitaberdua.com/themes/blue-butterfly/tl.webp" alt="frame" class="w-100 blow-left" style="transform-origin: left top;"></div> <div class="frame-tr frame-top animate__animated animate__fadeInTopRight animate__slow" style="right: -15px;"><img src="https://app.kitaberdua.com/themes/blue-butterfly/tr.webp" alt="frame" class="w-100 blow-right" style="transform-origin: right top;"></div> <div class="frame-bl frame-bottom animate__animated animate__fadeInBottomLeft animate__slow"><img src="https://app.kitaberdua.com/themes/blue-butterfly/bl.webp" alt="frame" class="w-100 blow-left" style="transform-origin: left bottom;"></div> <div class="frame-br frame-bottom animate__animated animate__fadeInBottomRight animate__slow"><img src="https://app.kitaberdua.com/themes/blue-butterfly/br.webp" alt="frame" class="w-100 blow-right" style="transform-origin: right bottom;"></div></div> <div class="d-flex flex-column justify-content-center align-items-center" style="height: 100%;"><div class="mx-auto animate__animated animate__fadeInDown animate__slower image-editable" style="height: 254px; width: 100%; overflow: hidden; margin-bottom: 20px; border-radius: 10px;"><img src="https://assets.satumomen.com/images/galleries/820007-gallery-cej0v8U8g7.webp" alt="233328-gallery-oPePgJXNih.png" class="mb-4" style="width: 100%; height: 100%; object-fit: contain;"></div><div class="text-center animate__animated animate__fadeInUp animate__slower"><div class="editable quotes" style="font-size: 14.4px;">"Di antara tanda-tanda (kebesaran)-Nya ialah Dia menciptakan pasangan-pasangan untukmu dari jenismu sendiri agar kamu cenderung dan merasa tenteram kepadanya, dan Dia menjadikan di antaramu rasa kasih dan sayang. Sesungguhnya pada yang demikian itu benar-benar terdapat tanda-tanda (kebesaran Allah) bagi kaum yang berpikir." </div><div class="editable mb-3 font-weight-bold font-accent" style="font-size: 14.4px;">QS. Ar-Rum 21</div></div></div></div></li> <li class="satumomen_slide" style="display: none;"><div class="container-mobile" style="background-image: url(&quot;http://app.kitaberdua.com/themes/blue-butterfly/bg.webp&quot;);"><div class="frame"><div class="frame-bl w-100 text-center frame-bm animate__animated animate__fadeInUp animate__slow"><img src="https://app.kitaberdua.com/themes/blue-butterfly/bm.webp" alt="frame" class="blow-left" style="width: 100%; animation-delay: 500ms; transform-origin: center bottom;"></div> <div class="frame-tl frame-top animate__animated animate__fadeInTopLeft animate__slow" style="left: -15px;"><img src="https://app.kitaberdua.com/themes/blue-butterfly/tl.webp" alt="frame" class="w-100 blow-left" style="transform-origin: left top;"></div> <div class="frame-tr frame-top animate__animated animate__fadeInTopRight animate__slow" style="right: -15px;"><img src="https://app.kitaberdua.com/themes/blue-butterfly/tr.webp" alt="frame" class="w-100 blow-right" style="transform-origin: right top;"></div> <div class="frame-bl frame-bottom animate__animated animate__fadeInBottomLeft animate__slow"><img src="https://app.kitaberdua.com/themes/blue-butterfly/bl.webp" alt="frame" class="w-100 blow-left" style="transform-origin: left bottom;"></div> <div class="frame-br frame-bottom animate__animated animate__fadeInBottomRight animate__slow"><img src="https://app.kitaberdua.com/themes/blue-butterfly/br.webp" alt="frame" class="w-100 blow-right" style="transform-origin: right bottom;"></div></div> <div class="w-100 h-100 d-flex flex-column justify-content-center align-items-center"><div class="text-center animate__animated animate__fadeInLeft animate__slower"><div class="editable mb-4" style="font-size: 14.4px;">Dengan rahmat Allah SWT <br>kami bermaksud mengundang <br>Bapak/Ibu/Saudara/i dalam <br>Acara Pernikahan Putra-Putri kami</div></div><div class="mb-4"><div class="image-editable animate__animated animate__fadeInLeft animate__slower" style="height: 100px; width: 100px; margin: auto auto 10px; border-radius: 100%; overflow: hidden; background-color: rgb(231, 231, 212);"><img src="https://assets.satumomen.com/images/galleries/820007-gallery-wdTq0sG55p.webp" alt="297870-gallery-NF8weaHRj2.png" style="width: 100%; height: 100%; object-fit: cover; object-position: center top;"></div> <div class="text-center animate__animated animate__fadeInLeft animate__slower"><div class="editable color-accent h4 mb-2 font-accent" style="font-size: 28.8px;">Renaldi</div> <div class="editable mb-2" style="font-size: 14.4px;">Anak dari<br>Bapak Wildan &amp; Ibu Sari</div></div></div> <div><div class="image-editable animate__animated animate__fadeInRight animate__slower" style="height: 100px; width: 100px; margin: auto auto 10px; border-radius: 100%; overflow: hidden; background-color: rgb(209, 226, 233);"><img src="https://assets.satumomen.com/images/galleries/820007-gallery-46xYK1jWsL.webp" alt="297870-gallery-2CYlMEld5Q.png" style="width: 100%; height: 100%; object-fit: cover; object-position: center top;"></div> <div class="text-center animate__animated animate__fadeInRight animate__slower"><div class="editable color-accent h4 mb-2 font-accent" style="font-size: 28.8px;">Akmalina</div> <div class="editable mb-2">Anak Dari<br>Bapak Bapak dan Ibu Ibu</div></div></div></div></div></li> <li class="satumomen_slide" style="display: none;"><div class="container-mobile" style="background-image: url(&quot;http://app.kitaberdua.com/themes/blue-butterfly/bg.webp&quot;);"><div class="frame"><div class="frame-bl w-100 text-center frame-bm animate__animated animate__fadeInUp animate__slow"><img src="https://app.kitaberdua.com/themes/blue-butterfly/bm.webp" alt="frame" class="blow-left" style="width: 100%; animation-delay: 500ms; transform-origin: center bottom;"></div> <div class="frame-tl frame-top animate__animated animate__fadeInTopLeft animate__slow" style="left: -15px;"><img src="https://app.kitaberdua.com/themes/blue-butterfly/tl.webp" alt="frame" class="w-100 blow-left" style="transform-origin: left top;"></div> <div class="frame-tr frame-top animate__animated animate__fadeInTopRight animate__slow" style="right: -15px;"><img src="https://app.kitaberdua.com/themes/blue-butterfly/tr.webp" alt="frame" class="w-100 blow-right" style="transform-origin: right top;"></div> <div class="frame-bl frame-bottom animate__animated animate__fadeInBottomLeft animate__slow"><img src="https://app.kitaberdua.com/themes/blue-butterfly/bl.webp" alt="frame" class="w-100 blow-left" style="transform-origin: left bottom;"></div> <div class="frame-br frame-bottom animate__animated animate__fadeInBottomRight animate__slow"><img src="https://app.kitaberdua.com/themes/blue-butterfly/br.webp" alt="frame" class="w-100 blow-right" style="transform-origin: right bottom;"></div></div> <div class="h-100 d-flex justify-content-center align-items-center"><div class="w-100"><div class="text-center mb-3"><div class="editable color-accent h4 mb-2 animate__animated animate__fadeInDown animate__slower font-accent" style="font-size: 30px;">Akad Nikah<br>&amp; Resepsi</div> <div class="my-3 d-flex flex-row justify-content-center align-items-center animate__animated animate__zoomIn animate__slower"><div class="editable" style="font-size: 14.4px; width: 100px;">Minggu</div> <div class="px-3" style="border-left: 2px solid var(--inv-accent); border-right: 2px solid var(--inv-accent);"><div class="editable" style="font-size: 38px; line-height: 1;">13</div> <div class="editable" style="font-size: 14.4px;">2022</div></div> <div class="editable" style="font-size: 14.4px; width: 100px;">November</div></div> <div class="editable animate__animated animate__fadeInDown animate__slower" style="font-size: 14.4px;">Pukul 08.00 WITA</div></div> <div class="text-center"><div class="editable font-accent color-accent animate__animated animate__fadeInUp animate__slower" style="font-size: 18px;">Lokasi Acara</div><div class="editable font-weight-bold animate__animated animate__fadeInUp animate__slower" style="font-size: 14.4px;">Batakan Beach Club Village (Batakan Village) </div> <div class="editable mb-4 animate__animated animate__fadeInUp animate__slower" style="font-size: 14.4px;">Jl. Mulawarman, Manggar</div></div> <div class="mx-auto animate__animated animate__fadeInUp animate__slower text-center" style="width: 270px; max-width: 100%; border-radius: 1rem;"><div class="animate__animated animate__fadeInDown animate__slower editable font-weight-bold font-accent" style="font-size: 14.4px; line-height: 1.2;">Dresscode</div> <div class="my-3 mx-auto mw-100 form-row align-items-center justify-content-center" style="width: 220px;"><div class="col d-flex justify-content-center"><div class="animate__animated animate__zoomIn animate__slower rounded-circle" style="overflow: hidden; width: 60px; height: 60px;"><img src="https://app.kitaberdua.com/images/no-image.jpg" height="60" width="60" alt="no-image.jpg" class="h-100 w-100" style="object-fit: cover;"></div></div><div class="col d-flex justify-content-center"><div class="animate__animated animate__zoomIn animate__slower rounded-circle" style="overflow: hidden; width: 60px; height: 60px;"><img src="https://app.kitaberdua.com/images/no-image.jpg" height="60" width="60" alt="no-image.jpg" class="h-100 w-100" style="object-fit: cover;"></div></div></div><div class="animate__animated animate__fadeInDown animate__slower editable" style="font-size: 14.4px; line-height: 1.2;">Putih &amp; Creram</div></div></div></div></div></li> <li class="satumomen_slide" style="display: none;"><div class="container-mobile" style="background-image: url(&quot;http://app.kitaberdua.com/themes/blue-butterfly/bg.webp&quot;);"><div class="frame"><div class="frame-bl w-100 text-center frame-bm animate__animated animate__fadeInUp animate__slow"><img src="https://app.kitaberdua.com/themes/blue-butterfly/bm.webp" alt="frame" class="blow-left" style="width: 100%; animation-delay: 500ms; transform-origin: center bottom;"></div> <div class="frame-tl frame-top animate__animated animate__fadeInTopLeft animate__slow" style="left: -15px;"><img src="https://app.kitaberdua.com/themes/blue-butterfly/tl.webp" alt="frame" class="w-100 blow-left" style="transform-origin: left top;"></div> <div class="frame-tr frame-top animate__animated animate__fadeInTopRight animate__slow" style="right: -15px;"><img src="https://app.kitaberdua.com/themes/blue-butterfly/tr.webp" alt="frame" class="w-100 blow-right" style="transform-origin: right top;"></div> <div class="frame-bl frame-bottom animate__animated animate__fadeInBottomLeft animate__slow"><img src="https://app.kitaberdua.com/themes/blue-butterfly/bl.webp" alt="frame" class="w-100 blow-left" style="transform-origin: left bottom;"></div> <div class="frame-br frame-bottom animate__animated animate__fadeInBottomRight animate__slow"><img src="https://app.kitaberdua.com/themes/blue-butterfly/br.webp" alt="frame" class="w-100 blow-right" style="transform-origin: right bottom;"></div></div> <div class="d-flex justify-content-center align-items-center" style="height: 100%;"><div style="width: 100%;"><div class="editable text-center mb-3 animate__animated animate__fadeInDown animate__slow font-italic font-accent" style="font-size: 42px;">Maps</div> <div><div class="p-1 mb-3 animate__animated animate__flipInX animate__slower" style="border-radius: 2.5rem; overflow: hidden; position: relative; border: 4px solid var(--inv-border);"><div class="image-editable animate__animated animate__fadeInDown animate__slow" style="width: 100%; margin: auto; border-radius: 2rem; overflow: hidden; padding-bottom: 70%; position: relative; border: 2px solid var(--inv-border);"><img src="https://assets.satumomen.com/assets/whatsapp-image-2025-10-08-at-160058-1759910539.jpg" alt="no-image.jpg" class="w-100 h-100" style="position: absolute; object-fit: cover;"></div></div> <div class="text-center animate__animated animate__fadeInUp animate__slow"><div class="editable font-weight-bold" style="font-size: 18px;">Galaxy hotel </div> <div class="editable mb-3" style="font-size: 14px;">Jalan A. Yani KM 2,5 No.138, Sungai Baru, Kec. Banjarmasin Tengah, Kota Banjarmasin, Kalimantan Selatan 70233</div><a href="https://maps.app.goo.gl/zLXHzrqESQN7KDYF9" target="_blank" rel="nofollow noreferrer noopener" class="link btn btn-primary rounded-pill animate__animated animate__fadeInUp animate__slow">Petunjuk Ke Lokasi</a></div></div></div></div></div></li> <li class="satumomen_slide" style="display: none;"><div class="container-mobile" style="background-image: url(&quot;http://app.kitaberdua.com/themes/blue-butterfly/bg.webp&quot;);"><div class="frame"><div class="frame-bl w-100 text-center frame-bm animate__animated animate__fadeInUp animate__slow"><img src="https://app.kitaberdua.com/themes/blue-butterfly/bm.webp" alt="frame" class="blow-left" style="width: 100%; animation-delay: 500ms; transform-origin: center bottom;"></div> <div class="frame-tl frame-top animate__animated animate__fadeInTopLeft animate__slow" style="left: -15px;"><img src="https://app.kitaberdua.com/themes/blue-butterfly/tl.webp" alt="frame" class="w-100 blow-left" style="transform-origin: left top;"></div> <div class="frame-tr frame-top animate__animated animate__fadeInTopRight animate__slow" style="right: -15px;"><img src="https://app.kitaberdua.com/themes/blue-butterfly/tr.webp" alt="frame" class="w-100 blow-right" style="transform-origin: right top;"></div> <div class="frame-bl frame-bottom animate__animated animate__fadeInBottomLeft animate__slow"><img src="https://app.kitaberdua.com/themes/blue-butterfly/bl.webp" alt="frame" class="w-100 blow-left" style="transform-origin: left bottom;"></div> <div class="frame-br frame-bottom animate__animated animate__fadeInBottomRight animate__slow"><img src="https://app.kitaberdua.com/themes/blue-butterfly/br.webp" alt="frame" class="w-100 blow-right" style="transform-origin: right bottom;"></div></div> <div class="d-flex justify-content-center align-items-center" style="height: 100%;"><div style="width: 100%;"><div class="text-center h4 mb-4 editable animate__animated animate__fadeInDown animate__slow font-accent" style="font-size: 21.6px;">Menghitung Hari</div> <div data-datetime="2024-11-13T07:30" class="countdown-wrapper mx-auto mb-5 d-flex flex-column animate__animated animate__fadeInUp animate__slower" style="max-width: 280px; min-width: 280px;"><div class="countdown text-center"><div class="countdown-item day bg-white" style="color: var(--inv-base); border: 1px solid var(--inv-accent);"><div class="number">00</div> <div class="text editable">Hari</div></div> <div class="countdown-item hour bg-white" style="color: var(--inv-base); border: 1px solid var(--inv-accent);"><div class="number">00</div> <div class="text editable">Jam</div></div> <div class="countdown-item minute bg-white" style="color: var(--inv-base); border: 1px solid var(--inv-accent);"><div class="number">00</div> <div class="text editable">Menit</div></div> <div class="countdown-item second bg-white" style="color: var(--inv-base); border: 1px solid var(--inv-accent);"><div class="number">00</div> <div class="text editable">Detik</div></div></div> <button class="btn-countdown btn btn-sm btn-pilled btn-accent mt-2">Atur Countdown</button></div><div><div class="text-center"><div class="editable mb-4 animate__animated animate__fadeInUp animate__slower" style="font-size: 12px;">Kirim ucapan untuk mempelai<br>dan konfirmasi kehadiran</div> <button class="btn-rsvp btn btn-primary mx-auto rounded-pill mb-4 animate__animated animate__fadeInUp animate__slow" style="gap: 8px;">
            
    Kirim Ucapan RSVP
          </button></div></div></div></div></div></li> <li class="satumomen_slide" style="display: none;"><div class="container-mobile" style="background-image: url(&quot;http://app.kitaberdua.com/themes/blue-butterfly/bg.webp&quot;);"><div class="frame"><div class="frame-bl w-100 text-center frame-bm animate__animated animate__fadeInUp animate__slow"><img src="https://app.kitaberdua.com/themes/blue-butterfly/bm.webp" alt="frame" class="blow-left" style="width: 100%; animation-delay: 500ms; transform-origin: center bottom;"></div> <div class="frame-tl frame-top animate__animated animate__fadeInTopLeft animate__slow" style="left: -15px;"><img src="https://app.kitaberdua.com/themes/blue-butterfly/tl.webp" alt="frame" class="w-100 blow-left" style="transform-origin: left top;"></div> <div class="frame-tr frame-top animate__animated animate__fadeInTopRight animate__slow" style="right: -15px;"><img src="https://app.kitaberdua.com/themes/blue-butterfly/tr.webp" alt="frame" class="w-100 blow-right" style="transform-origin: right top;"></div> <div class="frame-bl frame-bottom animate__animated animate__fadeInBottomLeft animate__slow"><img src="https://app.kitaberdua.com/themes/blue-butterfly/bl.webp" alt="frame" class="w-100 blow-left" style="transform-origin: left bottom;"></div> <div class="frame-br frame-bottom animate__animated animate__fadeInBottomRight animate__slow"><img src="https://app.kitaberdua.com/themes/blue-butterfly/br.webp" alt="frame" class="w-100 blow-right" style="transform-origin: right bottom;"></div></div> <div class="d-flex justify-content-center align-items-center" style="height: 100%;"><div style="width: 100%;"><div class="mx-auto animate__animated animate__fadeInDown animate__slower image-editable" style="height: 80px; width: 100%; overflow: hidden; margin-bottom: 20px; border-radius: 10px;"><img src="https://assets.satumomen.com/images/galleries/820007-gallery-gfdlzgIhDs.webp" alt="233328-gallery-oPePgJXNih.png" class="mb-4" style="width: 100%; height: 100%; object-fit: contain;"></div> <div class="text-center"><div class="editable color-accent h4 mb-4 animate__animated animate__fadeInDown animate__slower font-latin" style="font-size: 28.8px;">Do'a Untuk Pengantin</div> <div class="editable mb-4 animate__animated animate__fadeInUp animate__slower">"Semoga Allah memberkahimu di waktu bahagia dan memberkahimu di waktu susah, dan mengumpulkan kalian berdua dalam kebaikan"<br><br>[HR. Abu Daud]</div> <div class="editable mb-4 animate__animated animate__fadeInUp animate__slower" style="font-size: 14.4px;">Tekan tombol dibawah ini untuk mengirim ucapan dan konfirmasi kehadiran</div><button class="btn-rsvp btn btn-primary rounded-pill mb-4 animate__animated animate__fadeInUp animate__slow">Konfirmasi &amp; Kirim Ucapan</button></div></div></div></div></li> <li class="satumomen_slide" style="display: none;"><div class="container-mobile" style="background-image: url(&quot;http://app.kitaberdua.com/themes/blue-butterfly/bg.webp&quot;);"><div class="frame"><div class="frame-bl w-100 text-center frame-bm animate__animated animate__fadeInUp animate__slow"><img src="https://app.kitaberdua.com/themes/blue-butterfly/bm.webp" alt="frame" class="blow-left" style="width: 100%; animation-delay: 500ms; transform-origin: center bottom;"></div> <div class="frame-tl frame-top animate__animated animate__fadeInTopLeft animate__slow" style="left: -15px;"><img src="https://app.kitaberdua.com/themes/blue-butterfly/tl.webp" alt="frame" class="w-100 blow-left" style="transform-origin: left top;"></div> <div class="frame-tr frame-top animate__animated animate__fadeInTopRight animate__slow" style="right: -15px;"><img src="https://app.kitaberdua.com/themes/blue-butterfly/tr.webp" alt="frame" class="w-100 blow-right" style="transform-origin: right top;"></div> <div class="frame-bl frame-bottom animate__animated animate__fadeInBottomLeft animate__slow"><img src="https://app.kitaberdua.com/themes/blue-butterfly/bl.webp" alt="frame" class="w-100 blow-left" style="transform-origin: left bottom;"></div> <div class="frame-br frame-bottom animate__animated animate__fadeInBottomRight animate__slow"><img src="https://app.kitaberdua.com/themes/blue-butterfly/br.webp" alt="frame" class="w-100 blow-right" style="transform-origin: right bottom;"></div></div> <div class="d-flex justify-content-center align-items-center" style="height: 100%;"><div class="text-center" style="width: 100%;"><div class="mb-2 editable animate__animated animate__fadeInDown animate__slower font-italic font-accent" style="font-size: 28.8px;">Tanda Kasih</div> <div class="editable mb-4 animate__animated animate__fadeInDown animate__slower" style="font-size: 14.4px;">Terima kasih telah menambah semangat kegembiraan pernikahan kami dengan kehadiran dan hadiah indah Anda.</div> <div style="display: flex; gap: 8px;"><button class="btn-gift btn btn-block btn-primary rounded-pill animate__animated animate__fadeInUp animate__slow" style="max-width: 150px; margin: auto; font-size: 14.4px;">? Cashless</button> <button class="btn-gift btn btn-block btn-primary rounded-pill animate__animated animate__fadeInUp animate__slow" style="max-width: 150px; margin: auto; font-size: 14.4px;">? Kirim Kado</button></div><div class="gift-container mt-3 p-4 rounded" style="display: none;"><div class="d-flex animate__animated animate__zoomIn animate__slow"><div class="mx-auto"><div class="d-flex align-items-center mb-3"><div class="image-editable" style="width: 80px; overflow: hidden;"><img src="https://assets.satumomen.com/images/no-image.jpg" alt="no-image.jpg" style="width: 100%; height: 100%; object-fit: contain;"></div> <div class="text-left pl-2"><div class="editable account-number font-weight-bold h5 mb-0">12345678</div><button type="button" class="btn btn-sm btn-primary mt-2 mb-2 animate__animated animate__fadeInUp animate__slow delay-5" data-text="12345678" style="font-family: sans-serif; border-radius: 4px">Salin Rekening</button> <div class="editable" style="font-size: 14.4px;">BCA : Atas Nama Rekening</div></div></div><div class="d-flex align-items-center"><div class="image-editable" style="width: 80px; overflow: hidden;"><img src="https://assets.satumomen.com/images/no-image.jpg" alt="no-image.jpg" style="width: 100%; height: 100%; object-fit: contain;"></div> <div class="text-left pl-2"><div class="editable account-number font-weight-bold h5 mb-0">12345678</div><button type="button" class="btn btn-sm btn-primary mt-2 mb-2 animate__animated animate__fadeInUp animate__slow delay-5" data-text="12345678" style="font-family: sans-serif; border-radius: 4px">Salin Rekening</button> <div class="editable" style="font-size: 14.4px;">BCA : Atas Nama</div></div></div></div></div></div><div class="gift-container mt-3 p-4 rounded" style="display: none;"><div class="text-center mb-2 animate__animated animate__zoomIn animate__slow"><div class="editable font-weight-bold h5 mb-2">Kirim Kado</div> <div class="editable mb-0" style="font-size: 14.4px;">Anda dapat mengirim kado ke:<br>Jl. Wildan Sari 1 No 11 Banjarmasin Barat 70119</div></div></div></div></div></div></li> <li class="satumomen_slide" style="display: none;"><div class="container-mobile" style="background-image: url(&quot;http://app.kitaberdua.com/themes/blue-butterfly/bg.webp&quot;);"><div class="frame"><div class="frame-bl w-100 text-center frame-bm animate__animated animate__fadeInUp animate__slow"><img src="https://app.kitaberdua.com/themes/blue-butterfly/bm.webp" alt="frame" class="blow-left" style="width: 100%; animation-delay: 500ms; transform-origin: center bottom;"></div> <div class="frame-tl frame-top animate__animated animate__fadeInTopLeft animate__slow" style="left: -15px;"><img src="https://app.kitaberdua.com/themes/blue-butterfly/tl.webp" alt="frame" class="w-100 blow-left" style="transform-origin: left top;"></div> <div class="frame-tr frame-top animate__animated animate__fadeInTopRight animate__slow" style="right: -15px;"><img src="https://app.kitaberdua.com/themes/blue-butterfly/tr.webp" alt="frame" class="w-100 blow-right" style="transform-origin: right top;"></div> <div class="frame-bl frame-bottom animate__animated animate__fadeInBottomLeft animate__slow"><img src="https://app.kitaberdua.com/themes/blue-butterfly/bl.webp" alt="frame" class="w-100 blow-left" style="transform-origin: left bottom;"></div> <div class="frame-br frame-bottom animate__animated animate__fadeInBottomRight animate__slow"><img src="https://app.kitaberdua.com/themes/blue-butterfly/br.webp" alt="frame" class="w-100 blow-right" style="transform-origin: right bottom;"></div></div> <div class="watermark d-flex justify-content-center align-items-center" style="height: 100%;"><div><div class="text-center"><div class="text-center animate__animated animate__fadeInUp animate__slower"><div class="editable mb-3 font-weight-bold font-accent" style="font-size: 14.4px;">Wassalamu'alaikum<br>Warahmatullahi Wabarakatuh</div><div class="editable quotes" style="font-size: 14.4px;">Merupakan suatu kebahagiaan dan kehormatan bagi kami, apabila Bapak/Ibu/Saudara/i, berkenan hadir dan memberikan do'a restu kepada kedua mempelai.</div></div> <div class="text-center animate__animated animate__fadeInUp animate__slower"><div class="editable mt-3 font-accent" style="font-size: 13px;">Hormat Kami yang Mengundang</div><div class="editable quotes font-weight-bold font-accent" style="font-size: 18px; letter-spacing: 0.2rem;">LUCAS &amp; SARAH</div></div><div class="watermark-placeholder mt-5"><div id="waterMark" class="mt-5" style="display: inherit;"><div class="wm-music mt-3 text-center animate__animated animate__fadeInUp animate__slower animate__delay-1s" style="font-size: 60%;"><div style="opacity: 0.5;"><strong>Music:</strong></div> <div style="opacity: 0.5;">Love Story - Taylor Swift (sax cover by Leon Chen)</div></div></div></div></div></div></div></div></li></ul></div></div> <div id="smMenu" class="satumomen_menu"><ul class="satumomen_menu_list"><li class="satumomen_menu_item active" style="max-width: 82.8px;"><svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9.144 20.782v-3.067c0-.777.632-1.408 1.414-1.413h2.875c.786 0 1.423.633 1.423 1.413v3.058c0 .674.548 1.222 1.227 1.227h1.96a3.46 3.46 0 0 0 2.444-1 3.41 3.41 0 0 0 1.013-2.422V9.866c0-.735-.328-1.431-.895-1.902l-6.662-5.29a3.115 3.115 0 0 0-3.958.071L3.467 7.963A2.474 2.474 0 0 0 2.5 9.867v8.703C2.5 20.464 4.047 22 5.956 22h1.916c.327.002.641-.125.873-.354.232-.228.363-.54.363-.864h.036Z" fill="currentColor"></path></svg> <span>Opening</span></li> <li class="satumomen_menu_item" style="max-width: 82.8px;"><svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg"><path opacity=".4" d="M16.191 2H7.81C4.77 2 3 3.78 3 6.83v10.33C3 20.26 4.77 22 7.81 22h8.381C19.28 22 21 20.26 21 17.16V6.83C21 3.78 19.28 2 16.191 2" fill="currentColor"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M8.08 6.65v.01a.78.78 0 0 0 0 1.56h2.989c.431 0 .781-.35.781-.791a.781.781 0 0 0-.781-.779H8.08Zm7.84 6.09H8.08a.78.78 0 0 1 0-1.561h7.84a.781.781 0 0 1 0 1.561Zm0 4.57H8.08c-.3.04-.59-.11-.75-.36a.795.795 0 0 1 .75-1.21h7.84c.399.04.7.38.7.79 0 .399-.301.74-.7.78Z" fill="currentColor"></path></svg> <span>Quotes</span></li> <li class="satumomen_menu_item" style="max-width: 82.8px;"><svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg"><path opacity=".4" d="M11.776 21.837a36.258 36.258 0 0 1-6.328-4.957 12.668 12.668 0 0 1-3.03-4.805C1.278 8.535 2.603 4.49 6.3 3.288A6.282 6.282 0 0 1 12.007 4.3a6.291 6.291 0 0 1 5.706-1.012c3.697 1.201 5.03 5.247 3.893 8.787a12.67 12.67 0 0 1-3.013 4.805 36.58 36.58 0 0 1-6.328 4.957l-.25.163-.24-.163Z" fill="currentColor"></path><path d="m12.01 22-.234-.163a36.316 36.316 0 0 1-6.337-4.957 12.667 12.667 0 0 1-3.048-4.805c-1.13-3.54.195-7.586 3.892-8.787a6.296 6.296 0 0 1 5.728 1.023V22ZM18.23 10a.719.719 0 0 1-.517-.278.818.818 0 0 1-.167-.592c.022-.702-.378-1.341-.994-1.59-.391-.107-.628-.53-.53-.948.093-.41.477-.666.864-.573a.384.384 0 0 1 .138.052c1.236.476 2.036 1.755 1.973 3.155a.808.808 0 0 1-.23.56.708.708 0 0 1-.537.213Z" fill="currentColor"></path></svg> <span>Mempelai</span></li> <li class="satumomen_menu_item" style="max-width: 82.8px;"><svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M3 16.87V9.257h18v7.674C21 20.07 19.024 22 15.863 22H8.127C4.996 22 3 20.03 3 16.87Zm4.96-2.46a.822.822 0 0 1-.85-.799c0-.46.355-.84.81-.861.444 0 .81.351.82.8a.822.822 0 0 1-.78.86Zm4.06 0a.822.822 0 0 1-.85-.799c0-.46.356-.84.81-.861.445 0 .81.351.82.8a.822.822 0 0 1-.78.86Zm4.03 3.68a.847.847 0 0 1-.82-.85.831.831 0 0 1 .81-.849h.01c.465 0 .84.38.84.849 0 .47-.375.85-.84.85Zm-4.88-.85c.02.46.395.821.85.8a.821.821 0 0 0 .78-.859.817.817 0 0 0-.82-.801.855.855 0 0 0-.81.86Zm-4.07 0c.02.46.395.821.85.8a.821.821 0 0 0 .78-.859.817.817 0 0 0-.82-.801.855.855 0 0 0-.81.86Zm8.14-3.639c0-.46.356-.83.81-.84.445 0 .8.359.82.8a.82.82 0 0 1-.79.849.814.814 0 0 1-.84-.799v-.01Z" fill="currentColor"></path><path opacity=".4" d="M3.003 9.257c.013-.587.063-1.752.156-2.127.474-2.11 2.084-3.45 4.386-3.64h8.911c2.282.2 3.912 1.55 4.386 3.64.092.365.142 1.539.155 2.127H3.003Z" fill="currentColor"></path><path d="M8.305 6.59c.435 0 .76-.329.76-.77V2.771A.748.748 0 0 0 8.306 2c-.435 0-.76.33-.76.771V5.82c0 .441.325.77.76.77ZM15.695 6.59c.425 0 .76-.329.76-.77V2.771a.754.754 0 0 0-.76-.771c-.435 0-.76.33-.76.771V5.82c0 .441.325.77.76.77Z" fill="currentColor"></path></svg> <span>Acara</span></li> <li class="satumomen_menu_item" style="max-width: 82.8px;"><svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M8.532 2.937a6.89 6.89 0 0 1 7.034.058C17.71 4.327 19.012 6.705 19 9.26c-.05 2.54-1.447 4.929-3.193 6.775a18.727 18.727 0 0 1-3.358 2.82 1.173 1.173 0 0 1-.408.144.82.82 0 0 1-.39-.119 18.515 18.515 0 0 1-4.839-4.547A9.28 9.28 0 0 1 5 9.134c-.001-2.562 1.347-4.928 3.532-6.197Zm1.262 7.258a2.378 2.378 0 0 0 2.198 1.497 2.339 2.339 0 0 0 1.683-.701c.446-.454.696-1.07.694-1.713a2.423 2.423 0 0 0-1.462-2.243 2.346 2.346 0 0 0-2.594.52 2.455 2.455 0 0 0-.519 2.64Z" fill="currentColor"></path></svg> <span>Maps</span></li> <li class="satumomen_menu_item" style="max-width: 82.8px;"><svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg"><path opacity=".4" d="M12.02 2C6.21 2 2 6.74 2 12c0 1.68.49 3.41 1.35 4.99.16.26.18.59.07.9l-.67 2.24c-.15.54.31.94.82.78l2.02-.6c.55-.18.98.05 1.491.36 1.46.86 3.279 1.3 4.919 1.3 4.96 0 10-3.83 10-10C22 6.65 17.7 2 12.02 2Z" fill="currentColor"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M11.98 13.29c-.71-.01-1.28-.58-1.28-1.29 0-.7.58-1.28 1.28-1.27.71 0 1.28.57 1.28 1.28 0 .7-.57 1.28-1.28 1.28Zm-4.61 0c-.7 0-1.28-.58-1.28-1.28 0-.71.57-1.28 1.28-1.28.71 0 1.28.57 1.28 1.28 0 .7-.57 1.27-1.28 1.28Zm7.94-1.28c0 .7.57 1.28 1.28 1.28.71 0 1.28-.58 1.28-1.28 0-.71-.57-1.28-1.28-1.28-.71 0-1.28.57-1.28 1.28Z" fill="currentColor"></path></svg> <span>RSVP</span></li> <li class="satumomen_menu_item" style="max-width: 82.8px;"><svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg"><path opacity=".4" d="M12.02 2C6.21 2 2 6.74 2 12c0 1.68.49 3.41 1.35 4.99.16.26.18.59.07.9l-.67 2.24c-.15.54.31.94.82.78l2.02-.6c.55-.18.98.05 1.491.36 1.46.86 3.279 1.3 4.919 1.3 4.96 0 10-3.83 10-10C22 6.65 17.7 2 12.02 2Z" fill="currentColor"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M11.98 13.29c-.71-.01-1.28-.58-1.28-1.29 0-.7.58-1.28 1.28-1.27.71 0 1.28.57 1.28 1.28 0 .7-.57 1.28-1.28 1.28Zm-4.61 0c-.7 0-1.28-.58-1.28-1.28 0-.71.57-1.28 1.28-1.28.71 0 1.28.57 1.28 1.28 0 .7-.57 1.27-1.28 1.28Zm7.94-1.28c0 .7.57 1.28 1.28 1.28.71 0 1.28-.58 1.28-1.28 0-.71-.57-1.28-1.28-1.28-.71 0-1.28.57-1.28 1.28Z" fill="currentColor"></path></svg> <span>RSVP</span></li> <li class="satumomen_menu_item" style="max-width: 82.8px;"><svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg"><path opacity=".4" d="M16.191 2H7.81C4.77 2 3 3.78 3 6.83v10.33C3 20.26 4.77 22 7.81 22h8.381C19.28 22 21 20.26 21 17.16V6.83C21 3.78 19.28 2 16.191 2" fill="currentColor"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M8.08 6.65v.01a.78.78 0 0 0 0 1.56h2.989c.431 0 .781-.35.781-.791a.781.781 0 0 0-.781-.779H8.08Zm7.84 6.09H8.08a.78.78 0 0 1 0-1.561h7.84a.781.781 0 0 1 0 1.561Zm0 4.57H8.08c-.3.04-.59-.11-.75-.36a.795.795 0 0 1 .75-1.21h7.84c.399.04.7.38.7.79 0 .399-.301.74-.7.78Z" fill="currentColor"></path></svg> <span>Gift</span></li> <li class="satumomen_menu_item" style="max-width: 82.8px;"><svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg"><path opacity=".4" d="M16.34 2H7.67C4.28 2 2 4.38 2 7.92v8.17C2 19.62 4.28 22 7.67 22h8.67c3.39 0 5.66-2.38 5.66-5.91V7.92C22 4.38 19.73 2 16.34 2Z" fill="currentColor"></path><path d="M10.813 15.248a.872.872 0 0 1-.619-.256l-2.373-2.373a.874.874 0 1 1 1.237-1.238l1.755 1.755 4.128-4.128a.874.874 0 1 1 1.237 1.238l-4.746 4.746a.872.872 0 0 1-.619.256Z" fill="currentColor"></path></svg> <span>Thanks</span></li></ul></div> <div class="floating-action d-flex align-items-end flex-column"><button id="btnQrModal" class="btn btn-float"><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 256 256"><rect x="40" y="40" width="80" height="80" rx="16"></rect><rect x="40" y="136" width="80" height="80" rx="16"></rect><rect x="136" y="40" width="80" height="80" rx="16"></rect><path d="M144,184a8,8,0,0,0,8-8V144a8,8,0,0,0-16,0v32A8,8,0,0,0,144,184Z"></path><path d="M208,152H184v-8a8,8,0,0,0-16,0v56H144a8,8,0,0,0,0,16h32a8,8,0,0,0,8-8V168h24a8,8,0,0,0,0-16Z"></path><path d="M208,184a8,8,0,0,0-8,8v16a8,8,0,0,0,16,0V192A8,8,0,0,0,208,184Z"></path></svg></button> <button id="btnMusic" class="btn btn-float playing"><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 256 256" class="play"><path d="M184,152V104a8,8,0,0,1,16,0v48a8,8,0,0,1-16,0Zm40-72a8,8,0,0,0-8,8v80a8,8,0,0,0,16,0V88A8,8,0,0,0,224,80ZM53.92,34.62A8,8,0,1,0,42.08,45.38L73.55,80H32A16,16,0,0,0,16,96v64a16,16,0,0,0,16,16H77.25l69.84,54.31A8,8,0,0,0,160,224V175.09l42.08,46.29a8,8,0,1,0,11.84-10.76Zm92.16,77.59A8,8,0,0,0,160,106.83V32a8,8,0,0,0-12.91-6.31l-39.85,31a8,8,0,0,0-1,11.7Z"></path></svg> <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 256 256" class="pause"><path d="M160,32V224a8,8,0,0,1-12.91,6.31L77.25,176H32a16,16,0,0,1-16-16V96A16,16,0,0,1,32,80H77.25l69.84-54.31A8,8,0,0,1,160,32Zm32,64a8,8,0,0,0-8,8v48a8,8,0,0,0,16,0V104A8,8,0,0,0,192,96Zm32-16a8,8,0,0,0-8,8v80a8,8,0,0,0,16,0V88A8,8,0,0,0,224,80Z"></path></svg></button> <button id="btnAutoplay" class="btn btn-float"><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 256 256" class="play"><path d="M128,24A104,104,0,1,0,232,128,104.13,104.13,0,0,0,128,24Zm36.44,110.66-48,32A8.05,8.05,0,0,1,112,168a8,8,0,0,1-8-8V96a8,8,0,0,1,12.44-6.66l48,32a8,8,0,0,1,0,13.32Z"></path></svg> <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 256 256" class="pause"><path d="M128,24A104,104,0,1,0,232,128,104.13,104.13,0,0,0,128,24ZM112,160a8,8,0,0,1-16,0V96a8,8,0,0,1,16,0Zm48,0a8,8,0,0,1-16,0V96a8,8,0,0,1,16,0Z"></path></svg></button></div></div></div></div></div> <div id="lightboxWrapper" class="lightbox-wrapper"><div class="lightbox-list"></div> <a href="https://app.kitaberdua.com/preview/blue-butterfly#" id="lightboxCloseBtn" class="btn-lightbox"><svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 0 1 1.414 0L10 8.586l4.293-4.293a1 1 0 1 1 1.414 1.414L11.414 10l4.293 4.293a1 1 0 0 1-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 0 1-1.414-1.414L8.586 10 4.293 5.707a1 1 0 0 1 0-1.414z" clip-rule="evenodd"></path></svg></a> <div class="lightbox-navigation"><a href="https://app.kitaberdua.com/preview/blue-butterfly#" id="lightboxPrevBtn" data-index="0" class="lightbox-arrow"><svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m15 19-7-7 7-7"></path></svg></a> <a href="https://app.kitaberdua.com/preview/blue-butterfly#" id="lightboxNextBtn" data-index="0" class="lightbox-arrow"><svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m9 5 7 7-7 7"></path></svg></a></div></div> <div id="qrModal" tabindex="-1" role="dialog" aria-labelledby="qrModal" aria-hidden="true" class="modal fade"><div class="modal-dialog modal-dialog-centered"><div class="modal-content" style="height: 100%;"><div style="width: 100%; aspect-ratio: 16 / 9; background-size: cover; background-position: center center; background-image: url(&quot;/images/no-image.jpg&quot;);"></div> <div class="text-center py-4 px-4"><div><div class="mx-auto"><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="180" height="180" viewBox="0 0 180 180"><rect x="0" y="0" width="180" height="180" fill="#ffffff"></rect><g transform="scale(7.2)"><g transform="translate(0,0)"><path fill-rule="evenodd" d="M8 0L8 4L9 4L9 5L8 5L8 7L9 7L9 6L10 6L10 9L11 9L11 8L12 8L12 9L13 9L13 10L15 10L15 11L14 11L14 12L13 12L13 11L12 11L12 12L11 12L11 13L9 13L9 12L10 12L10 11L11 11L11 10L9 10L9 9L7 9L7 8L4 8L4 11L3 11L3 10L2 10L2 11L1 11L1 9L2 9L2 8L0 8L0 14L3 14L3 15L2 15L2 16L0 16L0 17L2 17L2 16L5 16L5 17L8 17L8 18L9 18L9 19L8 19L8 21L10 21L10 22L11 22L11 24L12 24L12 25L14 25L14 23L15 23L15 22L16 22L16 23L20 23L20 21L21 21L21 16L19 16L19 15L20 15L20 14L21 14L21 15L22 15L22 18L23 18L23 15L22 15L22 14L24 14L24 13L25 13L25 12L24 12L24 11L23 11L23 10L24 10L24 9L25 9L25 8L21 8L21 9L20 9L20 8L19 8L19 9L20 9L20 11L21 11L21 12L22 12L22 13L20 13L20 12L17 12L17 15L16 15L16 12L15 12L15 11L17 11L17 9L14 9L14 7L15 7L15 6L14 6L14 7L13 7L13 6L12 6L12 7L11 7L11 3L10 3L10 2L9 2L9 0ZM14 0L14 1L11 1L11 2L12 2L12 5L13 5L13 2L14 2L14 3L15 3L15 2L14 2L14 1L16 1L16 2L17 2L17 0ZM16 3L16 4L14 4L14 5L16 5L16 8L17 8L17 3ZM12 7L12 8L13 8L13 7ZM6 9L6 10L7 10L7 11L6 11L6 12L7 12L7 13L3 13L3 11L2 11L2 13L3 13L3 14L4 14L4 15L5 15L5 16L7 16L7 15L8 15L8 17L9 17L9 18L11 18L11 20L12 20L12 21L11 21L11 22L12 22L12 21L13 21L13 22L15 22L15 21L16 21L16 22L17 22L17 21L16 21L16 16L15 16L15 15L14 15L14 17L15 17L15 18L13 18L13 17L12 17L12 16L13 16L13 15L12 15L12 16L10 16L10 17L9 17L9 14L8 14L8 10L7 10L7 9ZM21 9L21 10L23 10L23 9ZM12 12L12 13L11 13L11 14L10 14L10 15L11 15L11 14L12 14L12 13L13 13L13 14L15 14L15 13L13 13L13 12ZM23 12L23 13L24 13L24 12ZM18 13L18 15L19 15L19 14L20 14L20 13ZM6 14L6 15L7 15L7 14ZM24 16L24 17L25 17L25 16ZM17 17L17 20L20 20L20 17ZM18 18L18 19L19 19L19 18ZM9 19L9 20L10 20L10 19ZM12 19L12 20L13 20L13 21L15 21L15 19L14 19L14 20L13 20L13 19ZM22 19L22 24L20 24L20 25L25 25L25 24L24 24L24 22L25 22L25 19ZM23 20L23 21L24 21L24 20ZM8 23L8 25L10 25L10 23ZM12 23L12 24L13 24L13 23ZM15 24L15 25L16 25L16 24ZM18 24L18 25L19 25L19 24ZM0 0L0 7L7 7L7 0ZM1 1L1 6L6 6L6 1ZM2 2L2 5L5 5L5 2ZM18 0L18 7L25 7L25 0ZM19 1L19 6L24 6L24 1ZM20 2L20 5L23 5L23 2ZM0 18L0 25L7 25L7 18ZM1 19L1 24L6 24L6 19ZM2 20L2 23L5 23L5 20Z" fill="#000000"></path></g></g></svg> <div style="margin-top: 10px; text-align: center;"></div></div></div> <hr style="margin-top: 1rem; margin-bottom: 1rem; border-width: 2px 0px 0px; border-style: dashed none none; border-color: rgba(0, 0, 0, 0.1) currentcolor currentcolor; border-image: none;"> <div style="text-align: center;"><strong>15 Apr 2026</strong><br> <p class="mb-0">18:41 </p> <p></p></div> <hr style="margin-top: 1rem; margin-bottom: 1rem; border-width: 2px 0px 0px; border-style: dashed none none; border-color: rgba(0, 0, 0, 0.1) currentcolor currentcolor; border-image: none;"> <div style="margin-bottom: 10px;"><div style="color: rgb(178, 178, 178);">Nama</div> <div>Nama Tamu</div></div> <div style="margin-bottom: 10px;"><div style="color: rgb(178, 178, 178);">Grup</div> <div>VIP</div></div></div> <button type="button" class="btn btn-close"><svg xmlns="http://www.w3.org/2000/svg" height="42px" width="42px" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18 18 6M6 6l12 12"></path></svg></button></div></div></div> <div id="rsvpModal" tabindex="-1" role="dialog" aria-labelledby="rsvpModal" class="modal fade"><div class="modal-dialog modal-dialog-centered"><div class="modal-content p-4" style="height: 100%;"><div class="rsvp-form show"><!----> <div class="mb-4"><div class="font-accent h4 text-center">RSVP</div></div> <form class="pt-2"><div><div class="form-group mb-2"><label for="inputname" class="small mb-1">Nama</label> <input aria-hidden="false" id="inputname" type="text" placeholder="Nama" required="required" class="form-control"> <!----></div> <!----> <!----> <!----> <!----></div><div><!----> <div class="form-group mb-2"><label for="inputgroup_name" class="small mb-1">Grup</label> <input aria-hidden="false" id="inputgroup_name" type="text" placeholder="Grup" class="form-control"> <!----></div> <!----> <!----> <!----></div><div><!----> <!----> <div class="form-group mb-2"><label for="inputphone" class="small mb-1">No WhatsApp</label> <div class="input-group"><div class="input-group-prepend"><button type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="btn bg-white border dropdown-toggle">+62</button> <div class="dropdown-menu shadow"><span class="dropdown-item"><input type="search" placeholder="Search Country..." class="form-control form-control-sm"></span> <button type="button" class="dropdown-item active">
                            Indonesia +62
                        ...
                        Tidak Hadir
                    </option></select> <!----></div> <!----></div><div><!----> <!----> <!----> <!----> <!----></div><div><!----> <!----> <!----> <!----> <!----></div> <!----> <!----><!----><!----><!----><!----><div class="form-group mb-2"><label for="inputcomment" class="small mb-1">Komentar atau Ucapan</label> <textarea id="inputcomment" rows="3" placeholder="Komentar atau Ucapan" required="required" class="form-control"></textarea> <!----></div> <button type="submit" class="btn btn-primary rounded-pill btn-block mt-4 mb-2"><span>Kirim</span></button></form> <div class="comment border-top mt-4 py-4"><div class="comment-item"><div class="d-flex"><img src="https://ui-avatars.com/api/?size=40&amp;background=random&amp;color=random&amp;name=Nama%20Tamuah" alt="Nama Tamuah" loading="lazy" class="avatar rounded-circle" style="height: 30px; width: 30px;"> <div class="ml-2 text-left"><p class="mb-0 font-weight-bold">
                        Nama Tamuah
                        <span class="badge alert-info">Hadir</span></p> <p class="mb-0">Happy</p> <small>12 August 2026 at 06.51</small></div></div></div><div class="comment-item"><div class="d-flex"><img src="https://ui-avatars.com/api/?size=40&amp;background=random&amp;color=random&amp;name=Nama%20Tamu" alt="Nama Tamu" loading="lazy" class="avatar rounded-circle" style="height: 30px; width: 30px;"> <div class="ml-2 text-left"><p class="mb-0 font-weight-bold">
                        Nama Tamu
                        <span class="badge alert-info">Hadir</span></p> <p class="mb-0">1231</p> <small>18 July 2026 at 22.49</small></div></div></div><div class="comment-item"><div class="d-flex"><img src="https://ui-avatars.com/api/?size=40&amp;background=random&amp;color=random&amp;name=Nama%20Tamusdsd" alt="Nama Tamusdsd" loading="lazy" class="avatar rounded-circle" style="height: 30px; width: 30px;"> <div class="ml-2 text-left"><p class="mb-0 font-weight-bold">
                        Nama Tamusdsd
                        <span class="badge alert-info">Hadir</span></p> <p class="mb-0">sdsdsd</p> <small>18 July 2026 at 12.07</small></div></div></div><div class="comment-item"><div class="d-flex"><img src="https://ui-avatars.com/api/?size=40&amp;background=random&amp;color=random&amp;name=Nama%20Tamu" alt="Nama Tamu" loading="lazy" class="avatar rounded-circle" style="height: 30px; width: 30px;"> <div class="ml-2 text-left"><p class="mb-0 font-weight-bold">
                        Nama Tamu
                        <span class="badge alert-info">Hadir</span></p> <p class="mb-0">ewr</p> <small>8 July 2026 at 20.58</small></div></div></div><div class="comment-item"><div class="d-flex"><img src="https://ui-avatars.com/api/?size=40&amp;background=random&amp;color=random&amp;name=Maskur" alt="Maskur" loading="lazy" class="avatar rounded-circle" style="height: 30px; width: 30px;"> <div class="ml-2 text-left"><p class="mb-0 font-weight-bold">
                        Maskur
                        <span class="badge alert-info">Hadir</span></p> <p class="mb-0">Selamat menempuh hidup baru</p> <small>27 May 2026 at 18.14</small></div></div></div><div class="comment-item"><div class="d-flex"><img src="https://ui-avatars.com/api/?size=40&amp;background=random&amp;color=random&amp;name=Bahlil" alt="Bahlil" loading="lazy" class="avatar rounded-circle" style="height: 30px; width: 30px;"> <div class="ml-2 text-left"><p class="mb-0 font-weight-bold">
                        Bahlil
                        <span class="badge alert-info">Tidak Hadir</span></p> <p class="mb-0">Semangat</p> <small>26 May 2026 at 12.18</small></div></div></div><div class="comment-item"><div class="d-flex"><img src="https://ui-avatars.com/api/?size=40&amp;background=random&amp;color=random&amp;name=Eceu" alt="Eceu" loading="lazy" class="avatar rounded-circle" style="height: 30px; width: 30px;"> <div class="ml-2 text-left"><p class="mb-0 font-weight-bold">
                        Eceu
                        <span class="badge alert-info">Tidak Hadir</span></p> <p class="mb-0">Maaf dan selamat menikah</p> <small>15 May 2026 at 15.20</small></div></div></div></div></div> <button type="button" class="btn btn-close"><svg xmlns="http://www.w3.org/2000/svg" height="42px" width="42px" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18 18 6M6 6l12 12"></path></svg></button></div></div></div> </main>
    <!-- illegal -->
